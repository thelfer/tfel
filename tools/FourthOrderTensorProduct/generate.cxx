...
void writeFileHeader(std::ostream& out, const FourthOrderTensorProduct& p) {
  ...
  out << " */" << endl;
  out << "" << endl;
  out << "#ifndef _LIB_TFEL_MATH_" << toupper(getName(p)) << "PRODUCTEXPR_H_"
      << endl;
  out << "#define _LIB_TFEL_MATH_" << toupper(getName(p)) << "PRODUCTEXPR_H_ "
      << endl;
  out << "" << endl;
...
void writeFileTrailer(std::ostream& out, const FourthOrderTensorProduct& p) {
  ...
  out << endl;
  out << "#endif /* _LIB_TFEL_MATH_" << toupper(getName(p))
      << "PRODUCTEXPR_H */" << endl;
