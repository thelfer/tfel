...
namespace mfront
{
  ...
  static void from_euler(tfel::math::tmatrix<3,3,real>& r,
  ...
  MTestParser::handleRotationMatrix(MTest& t,TokensContainer::const_iterator& p)
  {
    ...
    if(choice==MILLER){
      const real cste = 180. / M_PI;
      this->readSpecifiedToken("MTestParser::handleRotationMatrix","{",
			       p,this->fileTokens.end());
      const int h = this->readInt(p,this->fileTokens.end());
      this->readSpecifiedToken("MTestParser::handleRotationMatrix",",",
			       p,this->fileTokens.end());
      const int k = this->readInt(p,this->fileTokens.end());
      this->readSpecifiedToken("MTestParser::handleRotationMatrix",",",
			       p,this->fileTokens.end());
