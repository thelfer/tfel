/*! 
 * \file  mfront/mtest/UmatCohesiveZoneModel.cxx
 * \brief
...
namespace mfront
{
    ...
    : UmatBehaviourBase(h,l,b)
  {
    ...
    if(this->type!=3u){
      string msg("UmatCohesiveZoneModel::UmatCohesiveZoneModel : ");
  ...
  void
  UmatCohesiveZoneModel::getDrivingVariablesDefaultInitialValues(tfel::math::vector<real>& v) const
  {
    using namespace std;
  ...
  bool
  UmatCohesiveZoneModel::computePredictionOperator(tfel::math::matrix<real>& Kt,
  ...
  bool
  UmatCohesiveZoneModel::integrate(tfel::math::matrix<real>& Kt,
						 ...
						 const MTestStiffnessMatrixType::mtype ktype) const
  {
    ...
    return true;
  } // end of UmatCohesiveZoneModel::integrate

  void
  UmatCohesiveZoneModel::computeElasticStiffness(tfel::math::matrix<real>& Kt,
							       const tfel::math::vector<real>& mp,
  ...
  void
  UmatCohesiveZoneModel::setOptionalMaterialPropertiesDefaultValues(EvolutionManager& mp,
  ...
  } // end of UmatCohesiveZoneModel::setOptionalMaterialPropertiesDefaultValues
