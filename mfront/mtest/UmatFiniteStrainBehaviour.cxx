/*!
 * \file   mfront/mtest/UmatFiniteStrainBehaviour.cxx
 * \brief
...
namespace mfront
{
  ...
  UmatFiniteStrainBehaviour::UmatFiniteStrainBehaviour(const tfel::material::ModellingHypothesis::Hypothesis h,
								 const std::string& l,
								 const std::string& b)
  ...
  } // end of UmatFiniteStrainBehaviour::UmatFiniteStrainBehaviour

  void
  UmatFiniteStrainBehaviour::getDrivingVariablesDefaultInitialValues(tfel::math::vector<real>& v) const
  {
    using namespace std;
    ...
    v[1] = real(1);
    v[2] = real(1);
  } // end of UmatFiniteStrainBehaviour::setDrivingVariablesDefaultInitialValue  

  bool
  UmatFiniteStrainBehaviour::computePredictionOperator(tfel::math::matrix<real>& Kt,
  ...
  bool
  UmatFiniteStrainBehaviour::integrate(tfel::math::matrix<real>& Kt,
					    ...
					    const MTestStiffnessMatrixType::mtype ktype) const
  {
    ...
    return true;
  } // end of UmatFiniteStrainBehaviour::integrate

  void
  UmatFiniteStrainBehaviour::computeElasticStiffness(tfel::math::matrix<real>& Kt,
							  const tfel::math::vector<real>& mp,
							  ...
							  const tfel::material::ModellingHypothesis::Hypothesis h) const
  {
	...
	string msg("UmatFiniteStrainBehaviour::computeElasticMatrix : ");
	msg += "unsupported hypothesis";
	throw(runtime_error(msg));
      }
...
#warning "to be implemented : m.rotateStiffnessMatrixBackward(&De(0,0));"
  ...
  void
  UmatFiniteStrainBehaviour::setOptionalMaterialPropertiesDefaultValues(EvolutionManager& mp,
