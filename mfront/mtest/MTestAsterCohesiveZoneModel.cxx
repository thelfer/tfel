/*! 
 * \file  mfront/mtest/MTestAsterCohesiveZoneModel.cxx
 * \brief
...
namespace mfront
{
  ...
  MTestAsterCohesiveZoneModel::MTestAsterCohesiveZoneModel(const tfel::material::ModellingHypothesis::Hypothesis h,
									   const std::string& l,
									   const std::string& b)
    : MTestUmatBehaviourBase(h,l,b)
  {
    ...
    if(this->type!=3u){
      string msg("MTestAsterCohesiveZoneModel::MTestAsterCohesiveZoneModel : ");
  ...
  } // end of MTestAsterCohesiveZoneModel::setDrivingVariablesDefaultInitialValue  

  MTestStiffnessMatrixType::mtype
  MTestAsterCohesiveZoneModel::getDefaultStiffnessMatrixType(void) const
  {
    return MTestStiffnessMatrixType::CONSISTENTTANGENTOPERATOR;
  }
  
  bool
  MTestAsterCohesiveZoneModel::computePredictionOperator(tfel::math::matrix<real>& Kt,
  ...
  } // end of MTestAsterCohesiveZoneModel::computePredictionOperator

  bool
  MTestAsterCohesiveZoneModel::integrate(tfel::math::matrix<real>& Kt,
						 ...
						 const MTestStiffnessMatrixType::mtype ktype) const
  {
    return this->call_behaviour(Kt,s1,iv1,r,e0,e1,s0,
				mp,iv0,ev0,dev,h,dt,
				ktype,true);
  } // end of MTestAsterCohesiveZoneModel::integrate

  bool
  MTestAsterCohesiveZoneModel::call_behaviour(tfel::math::matrix<real>& Kt,
					      tfel::math::vector<real>& s1,
					      tfel::math::vector<real>& iv1,
					      const tfel::math::tmatrix<3u,3u,real>& r,
					      const tfel::math::vector<real>& e0,
					      ...
					      const bool b) const
  {
	...
	string msg("MTestAsterCohesiveZoneModel::call_behaviour : "
  ...
  void
  MTestAsterCohesiveZoneModel::setOptionalMaterialPropertiesDefaultValues(MTestEvolutionManager&,
										  const MTestEvolutionManager& ) const
  {} // end of MTestAsterCohesiveZoneModel::setOptionalMaterialPropertiesDefaultValues
      
  MTestAsterCohesiveZoneModel::~MTestAsterCohesiveZoneModel()
  {}
