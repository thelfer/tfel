/*! 
 * \file  mfront/include/MTest/UmatCohesiveZoneModel.hxx
 * \brief
...
#ifndef LIB_MFRONT_MTESTUMATCOHESIVEZONEMODEL_H_
#define LIB_MFRONT_MTESTUMATCOHESIVEZONEMODEL_H_ 
...
namespace mfront
{
   ...
   * interface
   */
  struct TFEL_VISIBILITY_LOCAL UmatCohesiveZoneModel
    : public UmatBehaviourBase
  {
     ...
     */
    UmatCohesiveZoneModel(const tfel::material::ModellingHypothesis::Hypothesis,
					const std::string&,
					const std::string&);
    /*!
...
#endif /* LIB_MFRONT_MTESTUMATCOHESIVEZONEMODEL_H_ */
