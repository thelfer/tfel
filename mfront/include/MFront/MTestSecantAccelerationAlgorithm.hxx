...
namespace mfront
{
   ...
   */
  struct MFRONT_MTEST_VISIBILITY_EXPORT MTestSecantAccelerationAlgorithm
    : public MTestAccelerationAlgorithm
  {
    //! default constructor
    MTestSecantAccelerationAlgorithm();
    /*!
    ...
    //! destructor
    virtual ~MTestSecantAccelerationAlgorithm();
  protected:
    ...
    //! trigger
    int sat;
  }; // end of struct MTestSecantAccelerationAlgorithm
