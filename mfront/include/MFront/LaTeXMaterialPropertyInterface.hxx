/*!
 * \file   mfront/include/MFront/LaTeXMaterialPropertyInterface.hxx
 * \brief  This file declares the LaTeXMaterialPropertyInterface class
...
#ifndef LIB_MFRONTLATEXLAWINTERFACE_H_
#define LIB_MFRONTLATEXLAWINTERFACE_H_ 
...
namespace mfront{
  ...
  struct LaTeXMaterialPropertyInterface
    : public AbstractMaterialPropertyInterface
  {
    static std::string 
    getName(void);
    
    LaTeXMaterialPropertyInterface();
  ...
  }; // end of MfrontLaTeXMaterialPropertyInterface

} // end of namespace mfront

#endif /* LIB_MFRONTLATEXLAWINTERFACE_H_ */
