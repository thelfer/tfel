...
namespace ansys
{
  ...
  private:
	...
	using  TangentOperatorType     = typename AnsysTangentOperatorType<AnsysTraits<Behaviour>::btype,real,N>::type;
	using  TangentOperatorViewType = typename AnsysTangentOperatorType<AnsysTraits<Behaviour>::btype,real,N>::view_type;
