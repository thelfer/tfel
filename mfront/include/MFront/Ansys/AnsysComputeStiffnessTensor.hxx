...
namespace ansys
{
  ...
  AnsysComputeIsotropicStiffnessTensor2D(tfel::config::Types<2u,float,false>::StiffnessTensor&,
					  const float* const);
  /*!
   * \brief compute the stiffness tensor for plane strain, generalised
   * plane strain and axisymmetrical hypotheses.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeIsotropicStiffnessTensor2D(tfel::config::Types<2u,double,false>::StiffnessTensor&,
					const double* const);
  /*!
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeIsotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,float,false>::StiffnessTensor&,
							  const float* const);
  /*!
   * \brief compute the stiffness tensor for plane stress modelling
   * hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeIsotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,double,false>::StiffnessTensor&,
							  const double* const);
  /*!
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeIsotropicStiffnessTensor3D(tfel::config::Types<3u,float,false>::StiffnessTensor&,
					  const float* const);
  /*!
   * \brief compute the stiffness tensor for the tridimensionnal
   * modelling hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeIsotropicStiffnessTensor3D(tfel::config::Types<3u,double,false>::StiffnessTensor&,
					const double* const);
  /*!
   * \brief compute the stiffness tensor for plane strain, generalised
   * plane strain and axisymmetrical hypotheses.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicStiffnessTensor2D(tfel::config::Types<2u,float,false>::StiffnessTensor&,
					  const float* const);
  /*!
   * \brief compute the stiffness tensor for plane strain, generalised
   * plane strain and axisymmetrical hypotheses.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicStiffnessTensor2D(tfel::config::Types<2u,double,false>::StiffnessTensor&,
					    const double* const);
  /*!
   * \brief compute the stiffness tensor for plane stress modelling
   * hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,float,false>::StiffnessTensor&,
							    const float* const);
  /*!
   * \brief compute the stiffness tensor for plane stress modelling
   * hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,double,false>::StiffnessTensor&,
							    const double* const);
  /*!
   * \brief compute the stiffness tensor for the tridimensionnal
   * modelling hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicStiffnessTensor3D(tfel::config::Types<3u,float,false>::StiffnessTensor&,
					    const float* const);
  /*!
   * \brief compute the stiffness tensor for the tridimensionnal
   * modelling hypothesis.
   ...
   */
  MFRONT_ANSYS_VISIBILITY_EXPORT void
  AnsysComputeOrthotropicStiffnessTensor3D(tfel::config::Types<3u,double,false>::StiffnessTensor&,
					    const double* const);
  ...
  template<AnsysBehaviourType,
	   ...
	   AnsysSymmetryType,bool>
  struct AnsysComputeStiffnessTensor;

  template<bool b>
  struct TFEL_VISIBILITY_LOCAL
  AnsysComputeStiffnessTensor<ansys::SMALLSTRAINSTANDARDBEHAVIOUR,
  ...
  template<tfel::material::ModellingHypothesis::Hypothesis H,
	   AnsysSymmetryType stype,bool b>
  struct TFEL_VISIBILITY_LOCAL
  AnsysComputeStiffnessTensor<ansys::FINITESTRAINSTANDARDBEHAVIOUR,H,stype,b>
  {
	...
	const real* const props)
    {
      AnsysComputeStiffnessTensor<ansys::SMALLSTRAINSTANDARDBEHAVIOUR,H,stype,b>::exe(D,props);
    }
  }; // end of struct AnsysComputeStiffnessTensor
