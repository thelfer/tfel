...
#ifndef LIB_MFRONT_ANSYS_ANSYSROTATION_IXX_
#define LIB_MFRONT_ANSYS_ANSYSROTATION_IXX_
...
namespace ansys
{
  ...
  void AnsysRotation2D<real>::rotateStrainsForward(const real *const eg,
    ...
    em[2]=eg[2];
    em[3]=(a[0]*a[3]+a[1]*a[2])*eg[3]+a[1]*a[3]*eg[1]+a[0]*a[2]*eg[0];
						     ...
						     real *const eg)
  {
    ...
    eg[2]=em[2];
    eg[3]=(a[0]*a[3]+a[1]*a[2])*em[3]+a[2]*a[3]*em[1]+a[0]*a[1]*em[0];
...
#endif /* LIB_MFRONT_ANSYS_ANSYSROTATION_IXX_ */
