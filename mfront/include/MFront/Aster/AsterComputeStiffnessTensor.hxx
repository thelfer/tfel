...
#ifndef LIB_MFRONT_ASTERCOMPUTESTIFFNESSTENSOR_H_
#define LIB_MFRONT_ASTERCOMPUTESTIFFNESSTENSOR_H_ 
...
namespace aster
{
  ...
  AsterComputeIsotropicStiffnessTensor2D(tfel::config::Types<2u,AsterReal,false>::StiffnessTensor&,
   ...
   */
  MFRONT_ASTER_VISIBILITY_EXPORT void
  AsterComputeIsotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,AsterReal,false>::StiffnessTensor&,
							const AsterReal* const);
   ...
   */
  MFRONT_ASTER_VISIBILITY_EXPORT void
  AsterComputeIsotropicStiffnessTensor3D(tfel::config::Types<3u,AsterReal,false>::StiffnessTensor&,
					const AsterReal* const);
   ...
   */
  MFRONT_ASTER_VISIBILITY_EXPORT void
  AsterComputeOrthotropicStiffnessTensor2D(tfel::config::Types<2u,AsterReal,false>::StiffnessTensor&,
					  const AsterReal* const);
   ...
   */
  MFRONT_ASTER_VISIBILITY_EXPORT void
  AsterComputeOrthotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,AsterReal,false>::StiffnessTensor&,
							  const AsterReal* const);
   ...
   */
  MFRONT_ASTER_VISIBILITY_EXPORT void
  AsterComputeOrthotropicStiffnessTensor3D(tfel::config::Types<3u,AsterReal,false>::StiffnessTensor&,
					  const AsterReal* const);
			     ...
			     ISOTROPIC,b>
  {
     ...
     */
    static void
    exe(tfel::config::Types<2u,AsterReal,false>::StiffnessTensor& C,
			     ...
			     ISOTROPIC,b>
  {
     ...
     */
    static void
    exe(tfel::config::Types<3u,AsterReal,false>::StiffnessTensor& C,
	const AsterReal* const props)
    {
...
#endif /* LIB_MFRONT_ASTERCOMPUTESTIFFNESSTENSOR_H_ */
