  ...
  struct MFRONT_VISIBILITY_EXPORT UMATInterfaceBase
   ...
   protected:
    ...
    virtual void completeMaterialPropertiesList(
        ...
        const Hypothesis) const;
    /*!
     * \return the basis for the function(s)' names implementing the behaviour
     * generated by the interface. This can be different from the name of the
     * behaviour to comply with the targeted code restrictions. For example, the
     * `Abaqus` interfaces require the function name to be upper-cased.
     * \note Some interfaces generate one function per behaviour. The name of
     ...
     * called the appends a suffix associated with the modelling hypothesis to
