...
namespace mfront {
  ...
  struct UMATInterfaceBase : public AbstractBehaviourInterface,
   ...
   protected:
    ...
    /*!
     * \return the name of the function generated by the interface. This can be
     * different from the name of the behaviour to comply with the targeted code
     * restrictions. For example, the `Abaqus` interfaces require the function
     * name to be upper-cased.
