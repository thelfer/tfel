...
#ifndef _LIB_MFRONT_MATERIALPROPERTYPARAMETERSHANDLER_HXX_
#define _LIB_MFRONT_MATERIALPROPERTYPARAMETERSHANDLER_HXX_
...
namespace mfront{
  ...
  writeMaterialPropertyParametersHandler(std::ostream&,
   ...
   */
  MFRONT_VISIBILITY_EXPORT void
  writeAssignMaterialPropertyParameters(std::ostream&,
					const MaterialPropertyDescription&,
					const std::string&,
					const std::string&,
					const std::string&);
...
#endif /* _LIB_MFRONT_MATERIALPROPERTYPARAMETERSHANDLER_HXX_ */
