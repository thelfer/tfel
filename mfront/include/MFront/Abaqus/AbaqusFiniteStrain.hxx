...
namespace abaqus
{
  ...
  struct MFRONT_ABAQUS_VISIBILITY_EXPORT AbaqusFiniteStrain
  {
     ...
     */    
    static void
    computeGreenLagrangeStrain(AbaqusReal* const,
     ...
     */    
    static void
    computeCauchyStressFromSecondPiolaKirchhoffStress(AbaqusReal* const,
						      const AbaqusReal* const,
						      const AbaqusInt,
						      const bool,
						      const AbaqusReal);
     ...
     */    
    static void
    computeSecondPiolaKirchhoffStressFromCauchyStress(AbaqusReal* const,
						      const AbaqusReal* const,
						      const AbaqusReal* const,
						      const AbaqusInt,
						      const bool,
     ...
     */
    static void
    computeAbaqusTangentOperatorFromCSE(AbaqusReal* const,
					const AbaqusReal* const,
					const AbaqusReal* const,
					const AbaqusReal* const,
					const AbaqusInt,
