/*! 
 * \file  CyranoGenericPlaneStressHandler.hxx
 * \brief
 * \author Helfer Thomas
 * \date   21 fév 2014
 */

#ifndef _LIB_MFRONT_CYRANO_CYRANOGENERICPLANESTRESSHANDLER_H_
#define _LIB_MFRONT_CYRANO_CYRANOGENERICPLANESTRESSHANDLER_H_ 
...
namespace cyrano
{
  ...
  private:
    ...
    template<typename GeneralisedPlaneStrainBehaviour>
    TFEL_CYRANO_INLINE2 static
    void iter(const CyranoReal *const DTIME,
	...
	CyranoGenericPlaneStressHandler::template exe<BehaviourHandler>(c1,c2,S22,
									DTIME,DROT,DDSOE,
									STRAN,DSTRAN,TEMP,
									DTEMP,nPROPS,NPROPS,
									PREDEF,DPRED,STATEV,
...
#endif /* _LIB_MFRONT_CYRANO_CYRANOGENERICPLANESTRESSHANDLER_H */
