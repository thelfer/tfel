/*! 
 * \file  mfront/include/MFront/Cyrano/CyranoInterfaceBase.hxx
 * \brief
 * \author Helfer Thomas
 * \date   21 fév 2014
 */

#ifndef _LIB_MFRONT_CYRANO_CYRANOINTERFACEBASE_H_
#define _LIB_MFRONT_CYRANO_CYRANOINTERFACEBASE_H_ 
...
namespace cyrano{
  ...
  /*!
   * \class  CyranoInterfaceBase
   * \brief  Base class for cyrano interfaces
   * \author Helfer Thomas
   * \date   12/12/2011
   */
  struct MFRONT_CYRANO_VISIBILITY_EXPORT CyranoInterfaceBase
  {
    /*!
  ...
  }; // end of struct CyranoInterfaceBase
  
} // end of namespace cyrano

#endif /* _LIB_MFRONT_CYRANO_CYRANOINTERFACEBASE_H */
