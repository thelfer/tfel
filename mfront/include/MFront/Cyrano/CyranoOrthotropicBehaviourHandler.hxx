...
#ifndef LIB_MFRONT_CYRANO_CYRANOORTHOTROPICBEHAVIOURHANDLER_HXX
#define LIB_MFRONT_CYRANO_CYRANOORTHOTROPICBEHAVIOURHANDLER_HXX 
...
namespace cyrano
{
  ...
  {
    TFEL_CYRANO_INLINE2 static void exe(const CyranoReal *const DTIME,
...
#endif /* LIB_MFRONT_CYRANO_CYRANOORTHOTROPICBEHAVIOURHANDLER_HXX */
