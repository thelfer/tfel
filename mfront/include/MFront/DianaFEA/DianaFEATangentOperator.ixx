...
namespace dianafea
{
  ...
  void
  DianaFEATangentOperator<real>::normalize(tfel::math::ST2toST2View<1u,real>&)
  {} // end of DianaFEATangentOperator<real>::normalize

  template<typename real>
  void
  DianaFEATangentOperator<real>::normalize(tfel::math::ST2toST2View<2u,real>& Dt)
  {
  ...
  template<typename real>
  void
  DianaFEATangentOperator<real>::normalize(tfel::math::ST2toST2View<3u,real>& Dt)
  {
  ...
  template<typename real>
  void
  DianaFEATangentOperator<real>::transpose(tfel::math::ST2toST2View<1u,real>& Dt)
  {
  ...
  template<typename real>
  void
  DianaFEATangentOperator<real>::transpose(tfel::math::ST2toST2View<2u,real>& Dt)
  {
    std::swap(Dt(0,1),Dt(1,0));
    std::swap(Dt(0,2),Dt(2,0));
  ...
  template<typename real>
  void
  DianaFEATangentOperator<real>::transpose(tfel::math::ST2toST2View<3u,real>& Dt)
  {
    std::swap(Dt(0,1),Dt(1,0));
    std::swap(Dt(0,2),Dt(2,0));
    std::swap(Dt(0,3),Dt(3,0));
  ...
  DianaFEATangentOperator<real>::convert2D(const real* const D)
  {
  ...
  DianaFEATangentOperator<real>::convert3D(const real* const D)
  {
