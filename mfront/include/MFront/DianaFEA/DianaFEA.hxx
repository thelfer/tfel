/*!
 * \file  mfront/include/MFront/DianaFEA/DianaFEA.hxx
 * \brief
...
#ifndef LIB_MFRONT_DIANAFEA_HXX
#define LIB_MFRONT_DIANAFEA_HXX

#ifndef TFEL_DIANAFEA_INLINE
#define TFEL_DIANAFEA_INLINE inline
#endif /* LIB_MFRONT_DIANAFEA_HXX */

#ifndef TFEL_DIANAFEA_INLINE2
#define TFEL_DIANAFEA_INLINE2 inline
#endif /* LIB_MFRONT_DIANAFEA_HXX */
...
namespace dianafea {
  ...
  //! integer type used by the dianafea interface
  using DianaFEAInt = int;
  //! floatting-point type used by the dianafea interface
  using DianaFEAReal = double;
