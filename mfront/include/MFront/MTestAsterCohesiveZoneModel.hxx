...
#ifndef _LIB_MFRONT_MTESTASTERCOHESIVEZONEMODELBEHAVIOUR_H_
#define _LIB_MFRONT_MTESTASTERCOHESIVEZONEMODELBEHAVIOUR_H_ 
...
namespace mfront
{
   ...
   * interface
   */
  struct TFEL_VISIBILITY_LOCAL MTestAsterCohesiveZoneModel
    : public MTestUmatBehaviourBase
  {
     ...
     */
    MTestAsterCohesiveZoneModel(const tfel::material::ModellingHypothesis::Hypothesis,
					const std::string&,
					const std::string&);
    /*!
    ...
    //! destructor
    virtual ~MTestAsterCohesiveZoneModel();
  protected:
    /*!
  ...
  }; // end of struct MTestAsterCohesiveZoneModel
  
} // end of namespace mfront

#endif /* _LIB_MFRONT_MTESTASTERCOHESIVEZONEMODELBEHAVIOUR_H */
