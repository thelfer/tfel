...
#ifndef LIB_MFRONT_BEHAVIOURBRICK_REQUIREMENTMANAGER_HXX
#define LIB_MFRONT_BEHAVIOURBRICK_REQUIREMENTMANAGER_HXX
...
namespace mfront {
  ...
  namespace bbrick {
    ...
    struct MFRONT_VISIBILITY_EXPORT RequirementManager {
       ...
       */
      std::vector<std::string> getUnresolvedRequirements() const;
      /*!
...
#endif /* LIB_MFRONT_BEHAVIOURBRICK_REQUIREMENTMANAGER_HXX */
