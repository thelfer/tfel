/*!
 * \file   HarmonicSumOfNortonHoffViscoplasticFlows.hxx
 * \brief
...
#ifndef LIB_MFRONT_BEHAVIOURBRICK_HARMONICSUMOFNORTONHOFFVISCOPLASTICFLOWS_HXX
#define LIB_MFRONT_BEHAVIOURBRICK_HARMONICSUMOFNORTONHOFFVISCOPLASTICFLOWS_HXX
...
namespace mfront {
  ...
  namespace bbrick {
     ...
     */
    struct HarmonicSumOfNortonHoffViscoplasticFlows : ViscoplasticFlowBase {
     ...
     protected:
      ...
      std::vector<BehaviourDescription::MaterialProperty> K;
      //! \brief Norton exponents
      std::vector<BehaviourDescription::MaterialProperty> n;
      /*!
    ...
    };  // end of struct HarmonicSumOfNortonHoffViscoplasticFlows

  }  // end of namespace bbrick

}  // end of namespace mfront

#endif /* LIB_MFRONT_BEHAVIOURBRICK_HARMONICSUMOFNORTONHOFFVISCOPLASTICFLOWS_HXX \
        */
