...
#ifndef LIB_MFRONT_CASTEM_CASTEMGETMODELLINGHYPOTHESIS_H_
#define LIB_MFRONT_CASTEM_CASTEMGETMODELLINGHYPOTHESIS_H_ 
...
namespace castem
{
  ...
  getModellingHypothesis(const CastemInt);
  
} // end of namespace castem

#endif /* LIB_MFRONT_CASTEM_CASTEMGETMODELLINGHYPOTHESIS_H_ */
