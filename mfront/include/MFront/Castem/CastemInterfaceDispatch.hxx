...
namespace castem{
    ...
    : public CastemInterfaceExceptions
  {
    ...
    void exe(const CastemInt  *const, const CastemReal *const,
	     const CastemReal *const, const CastemReal *const,
	     const CastemReal *const, const CastemReal *const,
	     const CastemReal *const, const CastemReal *const,
	     const CastemReal *const, const CastemInt  *const,
	     const CastemReal *const, const CastemReal *const,
	     ...
	     const StressFreeExpansionHandler&)
    {
      ...
      CastemInterfaceExceptions::throwInvalidBehaviourTypeAndModellingHypothesis(type,MH::toString(H));
    } // end of exe
  ...
  template<template<tfel::material::ModellingHypothesis::Hypothesis,
		    typename,bool> class Behaviour>
  struct CastemInterfaceDispatch<COHESIVEZONEMODEL,tfel::material::ModellingHypothesis::PLANESTRAIN,Behaviour>
    : public CastemInterfaceExceptions
  {
    TFEL_CASTEM_INLINE2 static
    void exe(const CastemInt  *const NTENS, const CastemReal *const DTIME,
	     ...
	     const StressFreeExpansionHandler& sfeh)
    {
      ...
      typedef CastemTraits<BV> Traits;
      typedef typename std::conditional<Traits::stype==castem::ISOTROPIC,
			  CastemIsotropicBehaviourHandler<COHESIVEZONEMODEL,
							MH::PLANESTRAIN,Behaviour>,
			  CastemOrthotropicBehaviourHandler<COHESIVEZONEMODEL,
  ...
  template<template<tfel::material::ModellingHypothesis::Hypothesis,
		    typename,bool> class Behaviour>
  struct CastemInterfaceDispatch<COHESIVEZONEMODEL,tfel::material::ModellingHypothesis::TRIDIMENSIONAL,Behaviour>
    : public CastemInterfaceExceptions
  {
    TFEL_CASTEM_INLINE2 static
    void exe(const CastemInt  *const NTENS, const CastemReal *const DTIME,
