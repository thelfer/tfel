...
namespace castem
{
  ...
  CastemComputeIsotropicStiffnessTensor1D(tfel::config::Types<1u,CastemReal,false>::StiffnessTensor&,
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeIsotropicStiffnessTensor2D(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor&,
					const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeIsotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor&,
							const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeIsotropicStiffnessTensor3D(tfel::config::Types<3u,CastemReal,false>::StiffnessTensor&,
					const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeOrthotropicStiffnessTensor1D(tfel::config::Types<1u,CastemReal,false>::StiffnessTensor&,
					  const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeOrthotropicStiffnessTensor2D(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor&,
					  const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeOrthotropicPlaneStressAlteredStiffnessTensor(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor&,
							  const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeOrthotropicPlaneStressUnAlteredStiffnessTensor(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor&,
							    const CastemReal* const);
   ...
   */
  MFRONT_CASTEM_VISIBILITY_EXPORT void
  CastemComputeOrthotropicStiffnessTensor3D(tfel::config::Types<3u,CastemReal,false>::StiffnessTensor&,
					  const CastemReal* const);
			     ...
			     ISOTROPIC,b>
  {
     ...
     */
    static void
    exe(tfel::config::Types<1u,CastemReal,false>::StiffnessTensor& C,
			     ...
			     ISOTROPIC,b>
  {
     ...
     */
    static void
    exe(tfel::config::Types<2u,CastemReal,false>::StiffnessTensor& C,
	const CastemReal* const props)
    {
			     ...
			     ISOTROPIC,b>
  {
     ...
     */
    static void
    exe(tfel::config::Types<3u,CastemReal,false>::StiffnessTensor& C,
	const CastemReal* const props)
    {
