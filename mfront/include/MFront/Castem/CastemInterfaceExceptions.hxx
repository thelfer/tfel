...
#ifndef LIB_MFRONT_CASTEM_CASTEMINTERFACEEXCEPTIONS_H_
#define LIB_MFRONT_CASTEM_CASTEMINTERFACEEXCEPTIONS_H_
...
namespace castem {
  ...
  struct MFRONT_CASTEM_VISIBILITY_EXPORT CastemInterfaceExceptions {
     ...
     * \param[in] b : behaviour name
     */
    TFEL_NORETURN static void throwMaximumNumberOfSubSteppingReachedException(
        const std::string &);
     ...
     */
    TFEL_NORETURN static void throwInvalidDDSDDEException(const std::string &,
                                                          const CastemReal);
    /*!
     ...
     * hypothesis
     */
    TFEL_NORETURN static void throwInvalidBehaviourTypeAndModellingHypothesis(
     ...
     * \param[in] b : behaviour name
     */
    TFEL_NORETURN static void throwThermalExpansionCoefficientShallBeNull(
        const std::string &);
    /*!
     * \brief display an error message if the value of the NDI
     * parameter is not valid
     */
    static void displayInvalidModellingHypothesisErrorMessage(void);

  };  // end of struct CastemInterfaceExceptions

}  // end of namespace castem

#endif /* LIB_MFRONT_CASTEM_CASTEMINTERFACEEXCEPTIONS_H_ */
