...
namespace calculix
{
    ...
    : protected CalculiXInterfaceExceptions
  {
	...
	CalculiXInterfaceExceptions::treatCalculiXException(MTraits::getName(),e);
	return -2;
      }
      catch(const tfel::material::OutOfBoundsException& e){
	CalculiXInterfaceExceptions::treatMaterialException(MTraits::getName(),e);
	return -3;
      }
	...
	CalculiXInterfaceExceptions::treatStandardException(MTraits::getName(),e);
	return -7;
      }
      catch(...){
