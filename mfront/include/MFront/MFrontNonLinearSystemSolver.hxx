/*! 
 * \file  mfront/include/MFront/MFrontNonLinearSystemSolver.hxx
 * \brief
 * \author Helfer Thomas
 * \brief 22 août 2014
 */

#ifndef _LIB_MFRONT_MFRONTNONLINEARSYSTEMSOLVER_H_
#define _LIB_MFRONT_MFRONTNONLINEARSYSTEMSOLVER_H_ 
...
namespace mfront
{
  ...
  struct MFrontNonLinearSystemSolver
  {
     ...
     */
    virtual void
    endsInputFileProcessing(MechanicalBehaviourDescription&) const = 0;
    /*!
     ...
     * destructor
     */
    virtual ~MFrontNonLinearSystemSolver();

  }; // end of struct MFrontNonLinearSystemSolver

} // end of namespace mfront

#endif /* _LIB_MFRONT_MFRONTNONLINEARSYSTEMSOLVER_H */
