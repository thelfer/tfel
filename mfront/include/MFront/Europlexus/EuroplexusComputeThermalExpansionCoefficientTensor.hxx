/*!
 * \file   mfront/include/MFront/Europlexus/EuroplexusComputeThermalExpansionCoefficientTensor.hxx
 * \brief  
 * 
...
namespace epx
{
					       ...
					       tfel::material::ModellingHypothesis::AXISYMMETRICALGENERALISEDPLANESTRAIN,ISOTROPIC>
  {
    static void
	  ...
	  tfel::config::Types<1u,EuroplexusReal,false>::ThermalExpansionCoefficientTensor&);
					       ...
					       tfel::material::ModellingHypothesis::AXISYMMETRICAL,ISOTROPIC>
  {
    static void
      exe(const EuroplexusReal* const,
	  tfel::config::Types<2u,EuroplexusReal,false>::ThermalExpansionCoefficientTensor&);
  }; // end of struct EuroplexusComputeThermalExpansionCoefficientTensor
					       ...
					       tfel::material::ModellingHypothesis::TRIDIMENSIONAL,ISOTROPIC>
  {
    static void
      exe(const EuroplexusReal* const,
	  tfel::config::Types<3u,EuroplexusReal,false>::ThermalExpansionCoefficientTensor&);
  }; // end of struct EuroplexusComputeThermalExpansionCoefficientTensor
