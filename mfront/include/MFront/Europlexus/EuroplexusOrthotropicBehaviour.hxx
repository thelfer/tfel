...
namespace epx
{
  ...
  template<>
  struct MFRONT_EPX_VISIBILITY_EXPORT EuroplexusOrthotropicElasticPropertiesOffset<1u>
  {
    static constexpr unsigned short value = 6u;
  }; // end of struct EuroplexusOrthotropicElasticPropertiesOffset<1u>

  template<>
  struct MFRONT_EPX_VISIBILITY_EXPORT EuroplexusOrthotropicElasticPropertiesOffset<2u>
  {
    static constexpr unsigned short value = 7u;
  }; // end of struct EuroplexusOrthotropicElasticPropertiesOffset<2u>

  template<>
  struct MFRONT_EPX_VISIBILITY_EXPORT EuroplexusOrthotropicElasticPropertiesOffset<3u>
  {
