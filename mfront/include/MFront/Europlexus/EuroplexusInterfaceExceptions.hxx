...
namespace epx {
  ...
  struct MFRONT_EPX_VISIBILITY_EXPORT EuroplexusUnSupportedCaseHandler {
     ...
     */
    [[noreturn]] static void exe(const EuroplexusReal *const,
  ...
  struct MFRONT_EPX_VISIBILITY_EXPORT EuroplexusInterfaceExceptions {
     ...
     * the interface
     */
    [[noreturn]] static void throwUnMatchedNumberOfExternalStateVariables(
        const std::string &, const unsigned short n1, const EuroplexusInt n2);
    /*!
     ...
     */
    [[noreturn]] static void throwInvalidDDSDDEValueException(
     ...
     */
    [[noreturn]] static void throwInvalidTimeStepScalingFactorOnFailure(
        const std::string &, const EuroplexusReal);
    /*!
