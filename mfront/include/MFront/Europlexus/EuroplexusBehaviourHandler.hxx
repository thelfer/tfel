...
namespace epx
{
    ...
    : public EuroplexusInterfaceExceptions
  {
    ...
    private:
      ...
      TFEL_EPX_INLINE2 typename BV::IntegrationResult
      computePredictionOperator(const EuroplexusReal DDSDDE)
      {
	using Traits = tfel::material::MechanicalBehaviourTraits<BV>;
	...
	const auto smflag = EuroplexusTangentOperatorFlag<EuroplexusTraits<BV>::btype>::value;
	...
	return r;
      ...
      TFEL_EPX_INLINE2 typename BV::IntegrationResult
      integrate(EuroplexusReal *const PNEWDT,
	...
	*PNEWDT = tsf.second;
	...
	using  TangentOperatorType     = typename EuroplexusTangentOperatorType<EuroplexusTraits<BV>::btype,N>::type;
