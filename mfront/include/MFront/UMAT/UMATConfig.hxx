...
#ifndef LIB_MFRONT_UMAT_UMATCONFIG_H_
#define LIB_MFRONT_UMAT_UMATCONFIG_H_ 

#include"MFront/MFrontConfig.hxx"

#if defined _WIN32 || defined _WIN64 ||defined __CYGWIN__
#  if defined UMATTimer_EXPORTS
#    define MFRONT_UMATTIMER_VISIBILITY_EXPORT MFRONT_VISIBILITY_EXPORT
#  else
...
#else
#  define MFRONT_UMATTIMER_VISIBILITY_EXPORT MFRONT_VISIBILITY_EXPORT
#endif /* LIB_MFRONT_UMAT_UMATCONFIG_H_ */

#if defined _WIN32 || defined _WIN64 ||defined __CYGWIN__
#  if defined UMATInterface_EXPORTS
#    define MFRONT_UMAT_VISIBILITY_EXPORT MFRONT_VISIBILITY_EXPORT
#  else
#  if not defined TFEL_STATIC_BUILD
