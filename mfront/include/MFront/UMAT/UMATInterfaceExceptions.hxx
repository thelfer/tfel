/*! 
 * \file  mfront/include/MFront/UMAT/UMATInterfaceExceptions.hxx
 * \brief
...
#ifndef _LIB_MFRONT_UMAT_UMATINTERFACEEXCEPTIONS_H_
#define _LIB_MFRONT_UMAT_UMATINTERFACEEXCEPTIONS_H_ 
...
namespace umat{
  ...
  /*!
   * \class  UMATInterfaceExceptions
   * \brief  Base class for umat interfaces
   * \author Helfer Thomas
   * \date   12/12/2011
   */
  struct MFRONT_UMAT_VISIBILITY_EXPORT UMATInterfaceExceptions
  {
    /*!
  ...
  }; // end of struct UMATInterfaceExceptions
  
} // end of namespace umat

#endif /* _LIB_MFRONT_UMAT_UMATINTERFACEEXCEPTIONS_H */
