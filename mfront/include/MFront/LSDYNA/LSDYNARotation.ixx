...
namespace lsdyna
{
  ...
  void LSDYNARotation2D<real>::rotateStrainsForward(const real *const eg,
    ...
    em[2]=eg[2];
    em[3]=(a[0]*a[3]+a[1]*a[2])*eg[3]+2*a[1]*a[3]*eg[1]+2*a[0]*a[2]*eg[0];
						     ...
						     real *const eg)
  {
    ...
    eg[2]=em[2];
    eg[3]=(a[0]*a[3]+a[1]*a[2])*em[3]+2*a[2]*a[3]*em[1]+2*a[0]*a[1]*em[0];
  ...
  void LSDYNARotation2D<real>::rotateStressesForward(const real *const sg,
    ...
    sm[2]=sg[2];
    sm[3]=(a[0]*a[3]+a[1]*a[2])*sg[3]+a[1]*a[3]*sg[1]+a[0]*a[2]*sg[0];
  ...
  void LSDYNARotation2D<real>::rotateStressesBackward(const real *const sm,
    ...
    sg[2]=sm[2];
    sg[3]=(a[0]*a[3]+a[1]*a[2])*sm[3]+a[2]*a[3]*sm[1]+a[0]*a[1]*sm[0];
  } // end of LSDYNARotation2D<real>::rotateStressesBackward

  template<typename real>
  void LSDYNARotation2D<real>::rotateDeformationGradientForward(const real *const F,
								real *const Fm)
  {
  ...
  // D^g=tN:D^m:N
  template<typename real>
  void LSDYNARotation2D<real>::rotateTangentOperatorBackward(real *const D) const
  {
    real MN[4][4];
    // Première ligne
    MN[0][0]=a[0]*a[0];
  ...
  template<typename real>
  void LSDYNARotation3D<real>::rotateDeformationGradientForward(const real *const F,
								real *const Fm)
  {
  ...
  template<typename real>
  void LSDYNARotation3D<real>::rotateTangentOperatorBackward(real *const D) const
  {
    real MN[6][6];
  ...
  template<typename InputIterator>
  tfel::math::tmatrix<3u,3u,typename std::iterator_traits<InputIterator>::value_type>
