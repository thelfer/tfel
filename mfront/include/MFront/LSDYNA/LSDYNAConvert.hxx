...
namespace lsdyna{
  ...
  struct UMATImportGradients
  {
    ...
    template<typename T>
    static inline void
    exe(tfel::math::stensor<N,T>& e,const LSDYNAReal* const v){
      e.importVoigt(v);
    } // end of exe
    /*!
     * \tparam T: type of the thermodynamique forces
  ...
  struct UMATImportThermodynamicForces
  {
    ...
    template<typename T>
    static inline void
    exe(tfel::math::stensor<N,T>& s,const LSDYNAReal* const v){
      s.importTab(v);
    } // end of exe
  ...
  struct UMATExportThermodynamicForces
  {
    ...
    template<typename T>
    static inline void
    exe(LSDYNAReal* const v,const tfel::math::stensor<N,T>& s){
      s.exportTab(v);
    } // end of exe
