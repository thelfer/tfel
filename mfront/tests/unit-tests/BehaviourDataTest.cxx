...
private:
  ...
  void test2(){
    ...
    TFEL_TESTS_CHECK_THROW(bd.getPersistentVariableDescription("unknown"),runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.getIntegrationVariableDescription("unknown"),runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.getStateVariableDescription("unknown"),runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.getMaterialProperties().getVariable("unknown"),runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.getLocalVariables().getVariable("unknown"),runtime_error);
    TFEL_TESTS_ASSERT(bd.getMaterialProperties().getVariable("young").name=="young");
