/*! 
 * \file   mfront/tests/unit-tests/BehaviourDescriptionBoundsHandlingTest_bounds.cxx
 * \brief
  ...
  : public tfel::tests::TestCase
{
  BehaviourDescriptionBoundsHandlingTest()
    : tfel::tests::TestCase("MFront","BehaviourDescriptionBoundsHandlingTest")
...
private:
  ...
  void test1(){
    ...
    // trying to override already declared bounds
    TFEL_TESTS_CHECK_THROW(bd.setBounds(h,"B",3,b2),
			   std::exception);
  ...
  void test2(){
    ...
    b2.lowerBound = -2;
    // setting bounds to an undeclared variable
    TFEL_TESTS_CHECK_THROW(bd.setPhysicalBounds(h,"D",b1),
			   std::exception);
    // setting bounds on a
    ...
    // trying to override already declared bounds
    TFEL_TESTS_CHECK_THROW(bd.setPhysicalBounds(h,"A",b2),
			   std::exception);
    // setting bounds on all components of b
    ...
    // trying to override already declared bounds
    TFEL_TESTS_CHECK_THROW(bd.setPhysicalBounds(h,"B",3,b2),
			   std::exception);
    // setting bounds on some components of c
