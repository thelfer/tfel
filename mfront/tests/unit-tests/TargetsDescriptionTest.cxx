...
struct TargetsDescriptionTest final
  : public tfel::tests::TestCase
{
  ...
  execute() override
  {
    const char* const td =
      ...
      "-I/usr/lib/jvm/default-java/include -I/usr/lib/jvm/default-java/include\""
      "	};"
      "  ldflags : {"
      "      \"-lm\""
      "	};"
 ...
 private:
  static mfront::TargetsDescription
  extract(const std::string& td){
  ...
  void check(const mfront::TargetsDescription& t){
    ...
    TFEL_TESTS_CHECK_THROW(t["libVanadiumAlloy2"],std::runtime_error);
    const auto& l1 = t["libVanadiumAlloy"];
    ...
    TFEL_TESTS_ASSERT(l1.sources.at(0)=="VanadiumAlloy_PoissonRatio_SRMA.cxx");
    TFEL_TESTS_ASSERT(l1.sources.at(1)=="VanadiumAlloy_YoungModulus_SRMA.cxx");
    ...
    TFEL_TESTS_ASSERT(l1.epts.at(1)=="VanadiumAlloy_PoissonRatio_SRMA_checkBounds");
    TFEL_TESTS_ASSERT(l1.epts.at(2)=="VanadiumAlloy_YoungModulus_SRMA");
    TFEL_TESTS_ASSERT(l1.epts.at(3)=="VanadiumAlloy_YoungModulus_SRMA_checkBounds");
    const auto& l2 = t["libVanadiumAlloy-java"];
    ...
    TFEL_TESTS_ASSERT(l2.sources.at(0)=="VanadiumAlloy_PoissonRatio_SRMA-java.cxx");
    TFEL_TESTS_ASSERT(l2.sources.at(1)=="VanadiumAlloy_YoungModulus_SRMA-java.cxx");
    TFEL_TESTS_ASSERT(l2.cppflags.size()==1u);
    TFEL_TESTS_ASSERT(l2.cppflags.at(0)==" -I/usr/lib/jvm/default-java/include "
		      "-I/usr/lib/jvm/default-java/include "
		      "-I/usr/lib/jvm/default-java/include");
    ...
    TFEL_TESTS_ASSERT(all.first.size()==1u);
    TFEL_TESTS_ASSERT(all.first.at(0)=="../java/VanadiumAlloy.class");
    TFEL_TESTS_ASSERT(all.second.empty());
    const auto& jclass = st.at("../java/VanadiumAlloy.class");
    TFEL_TESTS_ASSERT(jclass.first.size()==1u);
    TFEL_TESTS_ASSERT(jclass.first.at(0)=="../java/VanadiumAlloy.java");
    TFEL_TESTS_ASSERT(jclass.second.size()==1u);
    TFEL_TESTS_ASSERT(jclass.second.at(0)=="javac ../java/VanadiumAlloy.java");
  }
};
