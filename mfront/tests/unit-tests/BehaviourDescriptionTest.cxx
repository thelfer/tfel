...
private:
  ...
  void test1(void){
    ...
    TFEL_TESTS_CHECK_THROW(bd.getModellingHypotheses(),
			   runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.getDistinctModellingHypotheses(),
			   runtime_error);
  ...
  void test3(void (BehaviourDescription::* m)(const Hypothesis,const VariableDescription&)) {
    ...
    TFEL_TESTS_CHECK_THROW(bd.addAuxiliaryStateVariables(h, {v,v2}), runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.addIntegrationVariables(h, {v,v2}), runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.addLocalVariables(h, {v,v2}), runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.addExternalStateVariables(h, {v,v2}), runtime_error);
    TFEL_TESTS_CHECK_THROW(bd.addStaticVariable(h, v3), runtime_error);
  } // end of test3
  ...
  void test4() {
    ...
    bd.setUseQt(true);
    TFEL_TESTS_ASSERT(bd.useQt());
    TFEL_TESTS_CHECK_THROW(bd.setUseQt(false),
			   runtime_error);
  }
