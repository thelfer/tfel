...
namespace mfront::bbrick {
  ...
  bool ProviderBase::handleRequirement(const Requirement& r,
    ...
    if (this->getArraySize() != r.asize) {
      ...
      msg << "ProviderBase::handleRequirement : "
          << "unmatched array size for requirement '" << this->getExternalName()
          << "' "
  ...
  std::string StandardProvider::getExternalName() const { return this->ename; }

  unsigned short StandardProvider::getArraySize() const { return this->asize; }
  ...
  std::string ParameterProvider::getVariableType() const { return this->type; }

  std::string ParameterProvider::getExternalName() const { return this->ename; }
