...
namespace calculix 
{
  ...
  CalculiXException::CalculiXException(const std::string& s)
    : msg(s)
  {} // end of CalculiXException::CalculiXException
  ...
  const char* 
  CalculiXException::what () const noexcept
  { 
    return msg.c_str(); 
  } // end of CalculiXException::what

  std::string
  CalculiXException::getMsg() const noexcept
  {
    return msg;
  ...
  CalculiXInvalidModellingHypothesis::CalculiXInvalidModellingHypothesis(CalculiXInvalidModellingHypothesis&&) = default;

  CalculiXInvalidModellingHypothesis::CalculiXInvalidModellingHypothesis(const CalculiXInvalidModellingHypothesis&) = default;
  
  CalculiXInvalidModellingHypothesis::CalculiXInvalidModellingHypothesis(const char* b)
    : CalculiXException("current modelling hypothesis is not supported by behaviour '"+
		      std::string(b)+"'")
  {}

  CalculiXInvalidModellingHypothesis::~CalculiXInvalidModellingHypothesis() noexcept = default;
  ...
  CalculiXInvalidNTENSValue::CalculiXInvalidNTENSValue(CalculiXInvalidNTENSValue&&) = default;

  CalculiXInvalidNTENSValue::CalculiXInvalidNTENSValue(const CalculiXInvalidNTENSValue&) = default;
  ...
  CalculiXInvalidDimension::CalculiXInvalidDimension(const CalculiXInvalidDimension&) = default;

  CalculiXInvalidDimension::CalculiXInvalidDimension(CalculiXInvalidDimension&&) = default;
