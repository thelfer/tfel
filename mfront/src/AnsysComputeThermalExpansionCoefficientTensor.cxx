...
#define ANSYSCOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(real)                                                                 \
  static void																 \
  AnsysComputeIsotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
  ...
  {																	 \
    ...
    A(3)=0.;																 \
																	 ...
																	 \
  static void																 \
  AnsysComputeOrthotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
						 tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
    ...
    A(3)=0.;																 \
 																	 ...
 																	 \
  void																	 \
  AnsysComputeThermalExpansionCoefficientTensor<ansys::STANDARDSTRAINBASEDBEHAVIOUR,							 \
