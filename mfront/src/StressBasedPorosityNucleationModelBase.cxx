...
namespace mfront {
  ...
  namespace bbrick {
    ...
    StressBasedPorosityNucleationModelBase::getOptions() const {
      ...
      return opts;
    }  // end of StressBasedPorosityNucleationModelBase::getOptions()

    bool
    StressBasedPorosityNucleationModelBase::requiresSavingNucleatedPorosity()
        const {
      return true;
    }  // end of
       // StressBasedPorosityNucleationModelBase::requiresSavingNucleatedPorosity()
    ...
    }  // end of StressBasedPorosityNucleationModelBase::initialize
    ...
    std::string StressBasedPorosityNucleationModelBase::
      ...
      return c;
       ...
       // StressBasedPorosityNucleationModelBase::updateNextEstimateOfThePorosityIncrement
