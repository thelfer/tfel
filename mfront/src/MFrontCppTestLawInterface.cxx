...
namespace mfront
{
  ...
  std::string
  MFrontCppTestLawInterface::getName(void)
  {
    return "cpptest";
  }
  ...
  std::pair<bool,tfel::utilities::CxxTokenizer::TokensContainer::const_iterator>
  MFrontCppTestLawInterface::registerTestBounds(tfel::utilities::CxxTokenizer::TokensContainer::const_iterator current,
						const tfel::utilities::CxxTokenizer::TokensContainer::const_iterator endTokens)
  {
    using namespace std;
    string msg("MFrontCppTestLawInterface::registerTestBounds : ");
  ...
  MFrontCppTestLawInterface::getGlobalDependencies(const std::string&,
						   const std::string&,
						   const std::string&)
  {
    using namespace std;
    ...
    return libs;
  } // end of MFrontCppTestLawInterface::getGlobalDependencies

  std::map<std::string,std::vector<std::string> >
  MFrontCppTestLawInterface::getGlobalIncludes(const std::string&,
					       const std::string&,
					       const std::string&)
  {
    using namespace std;
    return map<string,vector<string> >();
  } // end of MFrontCppTestLawInterface::getGlobalIncludes

  std::map<std::string,std::vector<std::string> >
  MFrontCppTestLawInterface::getGeneratedSources(const std::string&,
						 const std::string&,
						 const std::string&)
  {
    using namespace std;
    return map<string,vector<string> >();
  } // end of MFrontCppTestLawInterface::getGeneratedSources

  std::vector<std::string>
  MFrontCppTestLawInterface::getGeneratedIncludes(const std::string&,
						  const std::string&,
						  const std::string&)
  {
    using namespace std;
    vector<string> incs;
    return incs;
  } // end of MFrontCppTestLawInterface::getGeneratedIncludes

  std::map<std::string,std::vector<std::string> >
  MFrontCppTestLawInterface::getLibrariesDependencies(const std::string&,
						      const std::string&,
						      const std::string&)
  {
    using namespace std;
    return map<string,vector<string> >();
  } // end of MFrontCppTestLawInterface::getLibrariesDependencies()

  std::map<std::string,
	   std::pair<std::vector<std::string>,
		     std::vector<std::string> > >
  MFrontCppTestLawInterface::getSpecificTargets(const std::string& lib,
						...
						const std::vector<std::string>&)
  {
    ...
    return res;
  } // end of MFrontCppLawInterface::getSpecificTargets

  void
  MFrontCppTestLawInterface::writeOutputFiles(const std::string& file,
					      const std::string& ,
  ...
  void
  MFrontCppTestLawInterface::writeSrcFile(const std::string& file,
					  ...
					  const std::vector<std::string>& namespaces)
  {
    ...
    if(testBounds.empty()){
      // we use bounds
      if(tests.empty())
	throw runtime_error("MFrontMaterialLawParser::writeTestFile:\nNo bounds defined to draw graph !") ;
    ...
    this->srcFile<<"  return 0;" << endl
		 << "}" << endl ;
  } // end of MFrontCppTestLawInterface::writeSrcFile
