...
namespace dianafea
{
  ...
  static void
  DianaFEAStandardSmallStrainStressFreeExpansionHandlerImpl(real * const e,
							 real * const de,
							 const real *const s0,
							 const real *const s1,
							 const DianaFEAInt d)
  ...
  void DianaFEAStandardSmallStrainStressFreeExpansionHandler(float * const e,
							   float * const de,
  ...
  void DianaFEAStandardSmallStrainStressFreeExpansionHandler(double * const e,
							   double * const de,
  ...
  template<typename real>
  static void
  DianaFEALogarithmicStrainStressFreeExpansionHandlerImpl(real * const e,
							real * const de,
							const real *const s0,
							const real *const s1,
							const DianaFEAInt d)
  ...
  } // end of DianaFEALogarithmicStrainStressFreeExpansionHandler

  void DianaFEALogarithmicStrainStressFreeExpansionHandler(float * const e,
							float * const de,
							const float *const s0,
							const float *const s1,
							const DianaFEAInt d)
  {
    DianaFEALogarithmicStrainStressFreeExpansionHandlerImpl(e,de,s0,s1,d);
  }
  
  void DianaFEALogarithmicStrainStressFreeExpansionHandler(double * const e,
							double * const de,
							const double *const s0,
							const double *const s1,
							const DianaFEAInt d)
