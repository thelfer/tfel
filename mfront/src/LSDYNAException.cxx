...
namespace lsdyna 
{
  ...
  LSDYNAException::LSDYNAException(const std::string& s)
    : msg(s)
  {} // end of LSDYNAException::LSDYNAException
  ...
  const char* 
  LSDYNAException::what () const noexcept
  { 
    return msg.c_str(); 
  } // end of LSDYNAException::what

  std::string
  LSDYNAException::getMsg() const noexcept
  {
    return msg;
  ...
  LSDYNAInvalidModellingHypothesis::LSDYNAInvalidModellingHypothesis(LSDYNAInvalidModellingHypothesis&&) = default;

  LSDYNAInvalidModellingHypothesis::LSDYNAInvalidModellingHypothesis(const LSDYNAInvalidModellingHypothesis&) = default;
  
  LSDYNAInvalidModellingHypothesis::LSDYNAInvalidModellingHypothesis(const char* b)
    : LSDYNAException("current modelling hypothesis is not supported by behaviour '"+
		      std::string(b)+"'")
  {}

  LSDYNAInvalidModellingHypothesis::~LSDYNAInvalidModellingHypothesis() noexcept = default;
  ...
  LSDYNAInvalidNTENSValue::LSDYNAInvalidNTENSValue(LSDYNAInvalidNTENSValue&&) = default;

  LSDYNAInvalidNTENSValue::LSDYNAInvalidNTENSValue(const LSDYNAInvalidNTENSValue&) = default;
  ...
  LSDYNAInvalidDimension::LSDYNAInvalidDimension(const LSDYNAInvalidDimension&) = default;

  LSDYNAInvalidDimension::LSDYNAInvalidDimension(LSDYNAInvalidDimension&&) = default;
