...
namespace mfront
{
  ...
  } // end of GenericBehaviourSmallStrainMTestFileGenerator::GenericBehaviourSmallStrainMTestFileGenerator
  ...
  void GenericBehaviourSmallStrainMTestFileGenerator::writeBehaviourDeclaration(
    ...
    os << "@Behaviour<generic> '" << this->library << ".so' '"
       << this->behaviour << "';" << std::endl;
#endif
  } // end of GenericBehaviourSmallStrainMTestFileGenerator::writeBehaviourDeclaration
  ...
  } // end of GenericBehaviourSmallStrainMTestFileGenerator::setStrainTensorAtTheBeginningOfTheTimeStep

  void GenericBehaviourSmallStrainMTestFileGenerator::setStrainTensorAtTheEndOfTheTimeStep(
  ...
  GenericBehaviourSmallStrainMTestFileGenerator::~GenericBehaviourSmallStrainMTestFileGenerator() = default;
