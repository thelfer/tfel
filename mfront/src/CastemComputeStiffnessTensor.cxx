...
namespace castem
{
					...
					const CastemReal* const props)
  {
    ...
    computeIsotropicStiffnessTensorII<1u,STAC::UNALTERED>(C,props[0],props[1]);
			       ...
			       
  {
    using namespace tfel::material;
    using STAC = StiffnessTensorAlterationCharacteristic;
    computeOrthotropicStiffnessTensorII<1u,STAC::UNALTERED>(C,props[0],props[1],props[2],
							  ...
							  const CastemReal* const props)
  {
    ...
    using namespace tfel::material;
    using STAC = StiffnessTensorAlterationCharacteristic;
    computeOrthotropicStiffnessTensorII<2u,STAC::ALTERED>(C,props[0],props[1],props[6],
							  props[2],props[7],props[8],
							  props[3],props[3],props[3]);
							  ...
							  const CastemReal* const props)
  {
    ...
    using namespace tfel::material;
    using STAC = StiffnessTensorAlterationCharacteristic;
    computeOrthotropicStiffnessTensorII<2u,STAC::UNALTERED>(C,props[0],props[1],props[6],
							    props[2],props[7],props[8],
							    props[3],props[3],props[3]);
  } // end of struct CastemComputeOrthotropicPlaneStressUnAlteredStiffnessTensor
