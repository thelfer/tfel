...
namespace mfront{
  ...
  std::string
  CyranoInterface::getFunctionName(const std::string& n) const
  {
  ...
  std::string
  CyranoInterface::getUmatFunctionName(const std::string& library,
					   const std::string& className) const
  {
  ...
  void
  CyranoInterface::writeGetOutOfBoundsPolicyFunctionImplementation(std::ostream& out,
  ...
  void
  CyranoInterface::writeMTestFileGeneratorSetModellingHypothesis(std::ostream& out) const
  {
...
#error "CyranoInterface::getGlobalIncludes : unsuported architecture"
    ...
    insert_if(d[lib].ldflags,"-l"+tfel::getLibraryInstallName("CyranoInterface"));
    if(this->generateMTestFile){
  ...
  void
  CyranoInterface::writeUMATxxAdditionalSymbols(std::ostream&,
						      const std::string&,
						      const Hypothesis,
  ...
  void
  CyranoInterface::writeCyranoBehaviourTraits(std::ostream& out,
