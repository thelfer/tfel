/*! 
 * \file  mfront/src/MFrontNonLinearSystemSolverBase.cxx
 * \brief
...
namespace mfront{
  ...
  MFrontNonLinearSystemSolverBase::getReservedNames(void) const
  {
    using namespace std;
    vector<string> n;
    n.push_back("error");
    ...
    return n;
  } // end of MFrontNonLinearSystemSolverBase::getReservedNames

  std::string
  MFrontNonLinearSystemSolverBase::getJacobianPart(const MechanicalBehaviourDescription& mb,
						   ...
						   const std::string& p)
  {
	...
	string msg("MFrontNonLinearSystemSolverBase::getJacobianPart : ");
    ...
    return d.str();
  } // end of MFrontNonLinearSystemSolverBase::getJacobianPart

  void
  MFrontNonLinearSystemSolverBase::writeComparisonToNumericalJacobian(std::ostream& out,
								      ...
								      const std::string& nj)
  {
    ...
    if(mb.getAttribute(h,MechanicalBehaviourData::compareToNumericalJacobian,false)){
	...
	if(p->arraySize==1){
	  ...
	  for(p2=d.getIntegrationVariables().begin();p2!=d.getIntegrationVariables().end();++p2){
	    if((p->arraySize==1)&&(p2->arraySize==1)){
		  ...
		  << " by variable " << p2->name << "\n";
	      out << MFrontNonLinearSystemSolverBase::getJacobianPart(mb,*p,*p2,n,n2,n3);
  ...
  } // end of MFrontNonLinearSystemSolverBase::writeComparisonToNumericalJacobian

  void
  MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValues(std::ostream& out,
								const MechanicalBehaviourDescription& mb,
								const tfel::material::ModellingHypothesis::Hypothesis h,
								const std::string& v)
  {
  ...
  } // end of MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValues
  
  void
  MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValuesBasedOnStateVariablesPhysicalBounds(std::ostream& out,
  												   const MechanicalBehaviourDescription& mb,
  												   const tfel::material::ModellingHypothesis::Hypothesis h)
  {
    using namespace std;
  ...
  } // end of MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValuesBasedOnStateVariablesPhysicalBounds

  void
  MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValuesBasedOnIntegrationVariablesIncrementsPhysicalBounds(std::ostream&,
														   const MechanicalBehaviourDescription&,
														   const tfel::material::ModellingHypothesis::Hypothesis)
  {} // end of MFrontNonLinearSystemSolverBase::writeLimitsOnIncrementValuesBasedOnIntegrationVariablesIncrementsPhysicalBounds

  MFrontNonLinearSystemSolverBase::~MFrontNonLinearSystemSolverBase()
  {} // end of MFrontNonLinearSystemSolverBase::~MFrontNonLinearSystemSolverBase
