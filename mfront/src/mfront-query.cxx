    ...
    for (auto a = argv + 1; a != argv + argc; ++a) {
      if ((*a)[0] != '-') {
        ...
        cout << "Available options are :" << endl
             ...
             << "--usage                       : show how to use " << argv[0]
             << endl
             << "--help-behaviour-queries-list : list all queries avaiable for "
                "mfront behaviour files"
             << endl
             << "--help-model-queries-list : list all queries avaiable for "
                "mfront model files"
             << endl;
        exit(EXIT_SUCCESS);
