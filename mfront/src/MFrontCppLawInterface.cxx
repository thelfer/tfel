...
namespace mfront
{
  ...
  MFrontCppLawInterface::getGlobalDependencies(const std::string& library,
					       ...
					       const std::string&)
  {
    ...
    return libs;
  } // end of MFrontCppLawInterface::getGeneratedSources

  std::map<std::string,std::vector<std::string> >
  MFrontCppLawInterface::getGlobalIncludes(const std::string&,
					   const std::string&,
					   const std::string&)
  {
    using namespace std;
  ...
  std::map<std::string,std::vector<std::string> >
  MFrontCppLawInterface::getGeneratedSources(const std::string& lib,
  ...
  MFrontCppLawInterface::getGeneratedIncludes(const std::string&,
					      const std::string&,
					      const std::string&)
  {
    using namespace std;
    ...
    return incs;
  } // end of MFrontCppLawInterface::getGeneratedIncludes

  std::map<std::string,std::vector<std::string> >
  MFrontCppLawInterface::getLibrariesDependencies(const std::string& lib,
						  const std::string& mat,
						  const std::string&)
  {
    using namespace std;
    ...
    return libs;
  } // end of MFrontCppLawInterface::getLibrariesDependencies()

  std::map<std::string,
	   std::pair<std::vector<std::string>,
		     std::vector<std::string> > >
  MFrontCppLawInterface::getSpecificTargets(const std::string&,
					    const std::string&,
					    const std::string&,
  ...
  } // end of MFrontCppLawInterface::writeOutputFiles

  void
  MFrontCppLawInterface::writeHeaderFile(const std::string& name,
					 const std::string& author,
					 const std::string& date,
					 const std::string& description,
					 const std::string& includes,
  ...
  } // end of MFrontCppLawInterface::writeHeaderFile(void)

  void
  MFrontCppLawInterface::writeSrcFile(const std::string& file,
				      const std::string& name,
				      const std::string& author,
				      const std::string& date,
				      const std::string& output,
				      ...
				      const std::vector<std::string>& namespaces)
  {
	...
	string msg("MFrontMaterialLawParser::writeCppSrcFile : ");
    ...
    // material laws
    writeMaterialLaws("MFrontMaterialLawParser::writeCppSrcFile",
    ...
    this->srcFile.close();
  } // end of MFrontCppLawInterface::writeSrcFile(void)
