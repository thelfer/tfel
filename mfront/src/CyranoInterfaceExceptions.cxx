...
namespace cyrano{
  ...
  void
  CyranoInterfaceExceptions::checkNTENSValue(const CyranoInt NTENS,
					     const unsigned short s)
  {
    using namespace std;
    using namespace tfel::utilities;
    if(NTENS!=s){
      string msg("CyranoInterfaceExceptions::checkNTENSValue : "
  ...
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwInvalidBehaviourTypeAndModellingHypothesis : "
  ...
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwPredictionComputationFailedException : ");
  ...
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwPredictionOperatorIsNotAvalaible : ");
  ...
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwConsistentTangentOperatorIsNotAvalaible : ");
  ...
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwUnsupportedStressFreeExpansionException : ");
  ...
  void
  CyranoInterfaceExceptions::throwThermalExpansionCoefficientShallBeNull(const std::string& b)
  {
    using namespace std;
    string msg("CyranoInterfaceExceptions::throwThermalExpansionCoefficientShallBeNull : ");
  ...
  void
  CyranoInterfaceExceptions::throwInvalidDDSOEException(const std::string& b,
							const CyranoReal v)
  {
    using namespace std;
    ostringstream msg;
