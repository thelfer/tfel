...
namespace mfront
{
						    ...
						    const FileDescription& fd)
  {
    ...
    if(mpd.inputs.size()>1){
      out << "static double\n";
      out << "get_scalar_value(const octave_value& value,const octave_idx_type,const octave_idx_type){\n";
      out << "return value.scalar_value();\n";
      out << "} // end of get_scalar_value\n\n";
      out << "static double\n";
      out << "get_matrix_value(const octave_value& value,const octave_idx_type i,const octave_idx_type j){\n";
      out << "return (value.matrix_value())(i,j);\n";
      out << "} // end of get_matrix_value\n\n";
      out << "static double\n";
      out << "get_range_value(const octave_value& value,const octave_idx_type,const octave_idx_type j){\n";
      out << "return value.range_value().elem(j);\n";
      out << "} // end of get_range_value\n\n";
    }
