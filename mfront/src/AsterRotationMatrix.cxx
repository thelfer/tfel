...
namespace aster
{
  ...
  void
  AsterRotationMatrix2D::rotateStrainsForward(const AsterReal *const eg,
  ...
  void
  AsterRotationMatrix2D::rotateStressesBackward(const AsterReal *const sm,
						AsterReal *const sg) const
  {
    // s11
  ...
  // sm : Contraintes dans le repère matériau
  void
  AsterRotationMatrix2D::rotateStressesForward(const AsterReal *const sg,
  ...
  void
  AsterRotationMatrix2D::rotateStrainsBackward(const AsterReal *const em,
  ...
  // em : Déformations dans le repère matériau
  void
  AsterRotationMatrix3D::rotateStrainsForward(const AsterReal *const eg,
					      AsterReal *const em) const
  {
  ...
  // sg : Contraintes dans le repère global
  void
  AsterRotationMatrix3D::rotateStressesBackward(const AsterReal *const sm,
						AsterReal *const sg) const
  {
  ...
  // sm : Contraintes dans le repère matériau
  void
  AsterRotationMatrix3D::rotateStressesForward(const AsterReal *const sg,
					       AsterReal *const sm) const
  {
  ...
  // eg : Contraintes dans le repère global
  void
  AsterRotationMatrix3D::rotateStrainsBackward(const AsterReal *const em,
					       AsterReal *const eg) const
  {
