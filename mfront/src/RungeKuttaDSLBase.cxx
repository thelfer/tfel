...
namespace mfront{
  ...
  void
  RungeKuttaDSLBase::treatEpsilon()
  {
  ...
  void RungeKuttaDSLBase::writeBehaviourLocalVariablesInitialisation(const Hypothesis h)
  {
    using Modifier = std::function<std::string(const MaterialPropertyInput&)>;
  ...
  void
  RungeKuttaDSLBase::writeBehaviourParserSpecificTypedefs()
  {
    this->checkBehaviourFile();
  }

  void
  RungeKuttaDSLBase::writeBehaviourParserSpecificMembers(const Hypothesis h)
  {
    this->checkBehaviourFile();
  ...
  void
  RungeKuttaDSLBase::writeBehaviourUpdateAuxiliaryStateVariables(const Hypothesis h)
  {
    if(this->mb.hasCode(h,BehaviourData::UpdateAuxiliaryStateVariables)){
      this->behaviourFile << "/*!\n"
			  ...
			  << "using namespace std;\n"
			  << "using namespace tfel::math;\n";
      writeMaterialLaws("RungeKuttaDSLBase::writeBehaviourUpdateAuxiliaryStateVariables",
			this->behaviourFile,this->mb.getMaterialLaws());
  ...
  void RungeKuttaDSLBase::writeBehaviourRK54Integrator(const Hypothesis h)
  {
    ...
    if(shallUpdateInternalStateValues){
      this->behaviourFile << "TFEL_CONSTEXPR const auto cste3544_2565   = Type(3544)/Type(2565);\n"
