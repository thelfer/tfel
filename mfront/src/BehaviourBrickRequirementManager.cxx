...
namespace mfront{
  ...
  namespace bbrick{
    ...
    static void
    throwIfRequirementHasAnIncompatibleProvider(const std::vector<std::shared_ptr<Provider>>& ps,
						const Requirement& r,
						const bool b)
    {
      for(const auto& p:ps){
    ...
    const Requirement&
    RequirementManager::getRequirement(const std::string& n) const{
    ...
    void RequirementManager::addRequirement(const std::shared_ptr<Requirement>& r){
