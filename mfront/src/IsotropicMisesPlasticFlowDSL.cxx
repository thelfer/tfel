...
namespace mfront{
  ...
  void IsotropicMisesPlasticFlowDSL::writeBehaviourComputeTangentOperator(std::ostream& os,
  ...
  void
  IsotropicMisesPlasticFlowDSL::writeBehaviourParserSpecificInitializeMethodPart(std::ostream& os,
										 const Hypothesis) const
  {
    this->checkBehaviourFile(os);
