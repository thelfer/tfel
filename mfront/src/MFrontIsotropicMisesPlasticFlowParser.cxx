...
namespace mfront{
  ...
  void
  MFrontIsotropicMisesPlasticFlowParser::endsInputFileProcessing(void)
  {
    using namespace std;
  ...
  } // end of MFrontIsotropicMisesPlasticFlowParser::endsInputFileProcessing

  void
  MFrontIsotropicMisesPlasticFlowParser::writeBehaviourParserSpecificMembers(const Hypothesis h)
  {
    using namespace std;
  ...
  void MFrontIsotropicMisesPlasticFlowParser::writeBehaviourIntegrator(const Hypothesis h)
  {
    using namespace std;
  ...
  void
  MFrontIsotropicMisesPlasticFlowParser::writeBehaviourParserSpecificInitializeMethodPart(const Hypothesis)
  {
    using namespace std;
    this->checkBehaviourFile();
    ...
    this->behaviourFile << "}\n";
  } // end of MFrontIsotropicMisesPlasticFlowParser::writeBehaviourParserSpecificInitializeMethodPart
