...
namespace mfront::bbrick {
  ...
  KinematicHardeningRuleFactory::KinematicHardeningRuleFactory() {
    ...
    this->addGenerator("BurletCailletaud", []() {
      return std::make_shared<bbrick::BurletCailletaudKinematicHardeningRule>();
    });
    ...
    this->addGenerator("DelobelleRobinetSchaffler", []() {
      return std::make_shared<
          bbrick::DelobelleRobinetSchafflerKinematicHardeningRule>();
    });
    this->addGenerator("DRS", []() {
      return std::make_shared<
          bbrick::DelobelleRobinetSchafflerKinematicHardeningRule>();
    });
