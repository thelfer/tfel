...
namespace mfront
{
  ...
  MaterialPropertyDescription::getVariableDescription(const std::string& n) const
  {
  ...
  VariableDescription&
  MaterialPropertyDescription::getVariableDescription(const std::string& n)
  {
    if(this->output.name==n){
      return this->output;
    }
  ...
  bool MaterialPropertyDescription::isGlossaryNameUsed(const std::string& g) const{
    using tfel::glossary::Glossary;
    const auto& glossary = Glossary::getGlossary();
    auto is_used  = [](const VariableDescription& v,
		       const std::string& k){
  ...
  bool MaterialPropertyDescription::isEntryNameUsed(const std::string& e) const
  {
						    ...
						    const std::string& g)
  {
    ...
    throw_if(this->isGlossaryNameUsed(g),"glossary name '"+g+"' already used");
