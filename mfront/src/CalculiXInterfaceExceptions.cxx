...
namespace calculix{
  ...
  void
  CalculiXInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties(const std::string& b,
									const unsigned short n1,
									const CalculiXInt n2)
  {
    std::ostringstream msg;
    msg << "CalculiXInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties : "
  ...
  void
  CalculiXInterfaceExceptions::throwUnMatchedNumberOfStateVariables(const std::string& b,
								    const unsigned short n1,
								    const CalculiXInt n2)
  {
    std::ostringstream msg;
  ...
  void
  CalculiXInterfaceExceptions::treatCalculiXException(const std::string& b,
						      const CalculiXException& e)
  {
    std::cout << "The behaviour '" << b 
	      << "' has thrown an CalculiXException : "
	      << e.what() << std::endl;
  } // end of CalculiXInterfaceExceptions::treatCalculiXException

  void
  CalculiXInterfaceExceptions::treatMaterialException(const std::string& b,
  ...
  void
  CalculiXInterfaceExceptions::treatTFELException(const std::string& b,
  ...
  void
  CalculiXInterfaceExceptions::treatStandardException(const std::string& b,
  ...
  void
  CalculiXInterfaceExceptions::treatUnknownException(const std::string& b)
  {
    std::cout << "The behaviour '" << b 
  ...
  {
    std::cout << "CalculiXInterfaceExceptions::displayUnsupportedHypothesisMessage : "
	      << "unsupported hypothesis" << std::endl;
  }
  
  void
  CalculiXUnSupportedCaseHandler::exe(const CalculiXReal *const,
