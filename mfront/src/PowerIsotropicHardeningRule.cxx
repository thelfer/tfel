...
namespace mfront {
  ...
  namespace bbrick {
    ...
    }  // end of PowerIsotropicHardeningRule::initialize
    ...
    std::vector<OptionDescription> PowerIsotropicHardeningRule::getOptions()
      ...
      opts.emplace_back("n", "Strain exponent",
                        OptionDescription::MATERIALPROPERTY);
      return opts;
    }  // end of PowerIsotropicHardeningRule::getOptions
    ...
    std::string PowerIsotropicHardeningRule::computeElasticPrediction(
      ...
      return c;
    }  // end of PowerIsotropicHardeningRule::computeElasticPrediction
    ...
    std::string PowerIsotropicHardeningRule::computeElasticLimit(
      ...
      return c;
    }  // end of PowerIsotropicHardeningRule::computeElasticLimit
    ...
    std::string PowerIsotropicHardeningRule::computeElasticLimitAndDerivative(
      ...
      if (!this->p0.empty()) {
        ...
        c += "const auto " + dR + " = ";
        c += "(this->theta)*(this->" + nn + ")*" + R + "/(std::max(this->" +
             pn + "+(this->theta)*(this->d" + pn + "),strain(1e-12)));\n";
      }
      return c;
    }  // end of PowerIsotropicHardeningRule::computeElasticLimitAndDerivative
    ...
    }  // end of PowerIsotropicHardeningRule::endTreatment
