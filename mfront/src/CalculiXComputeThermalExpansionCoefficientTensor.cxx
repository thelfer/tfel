...
namespace calculix
{
  ...
  void
  CalculiXComputeThermalExpansionCoefficientTensor<ISOTROPIC>::exe(const CalculiXReal* const props,
								   tfel::config::Types<3u,CalculiXReal,false>::ThermalExpansionCoefficientTensor& A)
  {
  ...
  void
  CalculiXComputeThermalExpansionCoefficientTensor<ORTHOTROPIC>::exe(const CalculiXReal* const props,
								     tfel::config::Types<3u,CalculiXReal,false>::ThermalExpansionCoefficientTensor& A)
  {
