...
#define LSDYNACOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(real)       \
  static void LSDYNAComputeIsotropicThermalExpansionCoefficientTensor2D(       \
    ...
    A(3) = 0.;                                                                 \
                                                                               ...
                                                                               \
  static void LSDYNAComputeOrthotropicThermalExpansionCoefficientTensor2D(     \
      const real* const props,                                                 \
      tfel::config::Types<2u, real, false>::ThermalExpansionCoefficientTensor& \
          A) {                                                                 \
    ...
    A(3) = 0.;                                                                 \
                                                                               ...
                                                                               \
  void LSDYNAComputeThermalExpansionCoefficientTensor<                         \
