...
namespace dianafea{
  ...
  void
  DianaFEAInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties(const std::string& b,
								     const unsigned short n1,
								     const DianaFEAInt n2)
  {
    std::ostringstream msg;
    msg << "DianaFEAInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties : "
  ...
  void
  DianaFEAInterfaceExceptions::throwUnMatchedNumberOfStateVariables(const std::string& b,
								 const unsigned short n1,
								 const DianaFEAInt n2)
  {
    std::ostringstream msg;
  ...
  void
  DianaFEAInterfaceExceptions::treatDianaFEAException(const std::string& b,
						const DianaFEAException& e)
  {
    std::cout << "The behaviour '" << b 
	      << "' has thrown an DianaFEAException : "
	      << e.what() << std::endl;
  } // end of DianaFEAInterfaceExceptions::treatDianaFEAException

  void
  DianaFEAInterfaceExceptions::treatMaterialException(const std::string& b,
  ...
  void
  DianaFEAInterfaceExceptions::treatTFELException(const std::string& b,
  ...
  void
  DianaFEAInterfaceExceptions::treatStandardException(const std::string& b,
  ...
  void
  DianaFEAInterfaceExceptions::treatUnknownException(const std::string& b)
  {
    std::cout << "The behaviour '" << b 
  ...
  void
  DianaFEAInterfaceExceptions::throwNegativeTimeStepException(const std::string& b)
  {
    tfel::raise("DianaFEAInterfaceExceptions::throwNegativeTimeStepException: "
		"negative time step detected for behaviour '"+b+"'");
  } // end of DianaFEAInterfaceExceptions::throwNegativeTimeStepException
  
  void
  DianaFEAInterfaceExceptions::throwPredictionComputationFailedException(const std::string& b)
  {
    tfel::raise("DianaFEAInterfaceExceptions::throwPredictionComputationFailedException: "
		"prediction computation failed for behaviour '"+b+"'");
  }

  void
  DianaFEAInterfaceExceptions::throwPredictionOperatorIsNotAvalaible(const std::string& b)
  {
    tfel::raise("DianaFEAInterfaceExceptions::throwPredictionOperatorIsNotAvalaible: "
		"behaviour '"+b+"' can't compute a prediction operator");
  } // end of DianaFEAInterfaceExceptions::throwBehaviourIntegrationFailedException

  void
  DianaFEAInterfaceExceptions::throwConsistentTangentOperatorIsNotAvalaible(const std::string& b)
  {
    tfel::raise("DianaFEAInterfaceExceptions::throwConsistentTangentOperatorIsNotAvalaible: "
  ...
  {
    std::cout << "DianaFEAInterfaceExceptions::displayUnsupportedHypothesisMessage : "
	      << "unsupported hypothesis" << std::endl;
  }
  
  void
  DianaFEAUnSupportedCaseHandler::exe(const DianaFEAReal *const,
  ...
  {
    tfel::raise("DianaFEAUnSupportedCaseHandler::exe : "
