/*!
 * \file   mfront/src/LaTeXMaterialPropertyInterface.cxx
 * \brief    
...
namespace mfront
{
  ...
  std::string
  LaTeXMaterialPropertyInterface::getName(void)
  {
    return "LaTeX";
  }

  LaTeXMaterialPropertyInterface::LaTeXMaterialPropertyInterface()
  {}

  void
  LaTeXMaterialPropertyInterface::reset(void)
  {} // end of LaTeXMaterialPropertyInterface::reset(void)

  std::pair<bool,tfel::utilities::CxxTokenizer::TokensContainer::const_iterator>
  LaTeXMaterialPropertyInterface::treatKeyword(const std::string&,
  ...
  LaTeXMaterialPropertyInterface::getGlobalDependencies(const std::string&,
						 const std::string&,
						 const std::string&)
  {
    using namespace std;
    return map<string,vector<string> >();
  } // end of LaTeXMaterialPropertyInterface::getGeneratedSources

  std::map<std::string,std::vector<std::string> >
  LaTeXMaterialPropertyInterface::getGlobalIncludes(const std::string&,
					     const std::string&,
					     const std::string&)
  {
    using namespace std;
  ...
  std::map<std::string,std::vector<std::string> >
  LaTeXMaterialPropertyInterface::getGeneratedSources(const std::string&,
					       const std::string&,
					       const std::string&)
  {
    using namespace std;
  ...
  LaTeXMaterialPropertyInterface::getGeneratedIncludes(const std::string&,
						const std::string&,
						const std::string&)
  {
    using namespace std;
    return vector<string>();
  } // end of LaTeXMaterialPropertyInterface::getGeneratedIncludes

  std::map<std::string,std::vector<std::string> >
  LaTeXMaterialPropertyInterface::getLibrariesDependencies(const std::string&,
						    const std::string&,
						    const std::string&)
  {
    using namespace std;
    return map<string,vector<string> >();
  } // end of LaTeXMaterialPropertyInterface::getLibrariesDependencies()

  std::map<std::string,
	   std::pair<std::vector<std::string>,
		     std::vector<std::string> > >
  LaTeXMaterialPropertyInterface::getSpecificTargets(const std::string&,
					      const std::string&,
					      const std::string&,
  ...
  } // end of LaTeXMaterialPropertyInterface::getSpecificTargets
  ...
  void
  LaTeXMaterialPropertyInterface::writeOutputFiles(const std::string& file,
					    const std::string&,
					    ...
					    const std::vector<std::string>&)
  {
    ...
    if(!out){
      string msg("LaTeXMaterialPropertyInterface::writeOutputFiles : ");
  ...
  } // end of LaTeXMaterialPropertyInterface::writeOutputFiles
