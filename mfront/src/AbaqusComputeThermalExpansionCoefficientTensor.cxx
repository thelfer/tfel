...
#define ABAQUSCOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(real)                                                                 \
  static void																 \
  AbaqusComputeIsotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
  ...
  {																	 \
    ...
    A(3)=0.;																 \
																	 ...
																	 \
  static void																 \
  AbaqusComputeOrthotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
						 tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
