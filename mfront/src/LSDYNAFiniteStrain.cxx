...
namespace lsdyna
{
  ...
  void
  LSDYNAFiniteStrain::computeGreenLagrangeStrain(LSDYNAReal* const e,
  ...
  void
  LSDYNAFiniteStrain::computeSecondPiolaKirchhoffStressFromCauchyStress(LSDYNAReal* const STRESS,
  								      const LSDYNAReal* const F,
  								      const LSDYNAInt NTENS,
  								      const bool ps,
								      const LSDYNAReal Fzz)
  {
    ...
    // determinant
    const LSDYNAReal J  = F0*(F4*F8-F5*F7)-F3*(F1*F8-F2*F7)+(F1*F5-F2*F4)*F6;
  ...
  } // end of LSDYNAFiniteStrain::computeSecondPiolaKirchhoffStressFromCauchyStress

  void
  LSDYNAFiniteStrain::computeSecondPiolaKirchhoffStressFromCauchyStress(LSDYNAReal* const sk2,
								      ...
								      const LSDYNAReal Fzz)
  {
    ...
    LSDYNAFiniteStrain::computeSecondPiolaKirchhoffStressFromCauchyStress(sk2,F,NTENS,ps,Fzz);
  } // end of LSDYNAFiniteStrain::computeSecondPiolaKirchhoffStressFromCauchyStress

  void
  LSDYNAFiniteStrain::computeCauchyStressFromSecondPiolaKirchhoffStress(LSDYNAReal* const s,
									const LSDYNAReal* const F,
									const LSDYNAInt NTENS,
									const bool ps,
									const LSDYNAReal Fzz)
  {
    ...
    const LSDYNAReal F8 = !ps ? F[8] : Fzz;
    // determinant
    const LSDYNAReal inv_J = 1/(F0*(F4*F8-F5*F7)-F3*(F1*F8-F2*F7)+(F1*F5-F2*F4)*F6);
  ...
  } // end of LSDYNAFiniteStrain::computeCauchyStressFromSecondPiolaKirchhoffStress
