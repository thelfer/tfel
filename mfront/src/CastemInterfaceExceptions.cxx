...
namespace castem{
  ...
  void
  CastemInterfaceExceptions::checkNTENSValue(const CastemInt NTENS,
  ...
  CastemInterfaceExceptions::throwInvalidBehaviourTypeAndModellingHypothesis(const CastemBehaviourType,
									   const std::string& h)
  {
    throw(std::runtime_error("CastemInterfaceExceptions::"
  ...
  {
    throw(std::runtime_error("CastemInterfaceExceptions::throwPredictionComputationFailedException: "
  ...
  {
    throw(std::runtime_error("CastemInterfaceExceptions::throwPredictionOperatorIsNotAvalaible: "
  ...
  {
    throw(std::runtime_error("CastemUnSupportedCaseHandler::exe : "
