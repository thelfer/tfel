...
namespace castem{
  ...
  void
  CastemInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties(const std::string& b,
								    const unsigned short n1,
								    const CastemInt n2)
  {
    std::ostringstream msg;
    msg << "CastemInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties : "
  ...
  void
  CastemInterfaceExceptions::throwUnMatchedNumberOfStateVariables(const std::string& b,
								const unsigned short n1,
								const CastemInt n2)
  {
    std::ostringstream msg;
  ...
  void
  CastemInterfaceExceptions::treatCastemException(const std::string& b,
					      const CastemException& e)
  {
    std::cout << "The behaviour '" << b 
	      << "' has thrown an CastemException : "
	      << e.what() << std::endl;
  } // end of treatCastemException

  void
  CastemInterfaceExceptions::treatMaterialException(const std::string& b,
  ...
  void
  CastemInterfaceExceptions::treatTFELException(const std::string& b,
  ...
  void
  CastemInterfaceExceptions::treatStandardException(const std::string& b,
  ...
  void
  CastemInterfaceExceptions::treatUnknownException(const std::string& b)
  {
    std::cout << "The behaviour '" << b 
  ...
  void
  CastemInterfaceExceptions::throwNegativeTimeStepException(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::throwNegativeTimeStepException: "
  ...
  {
    tfel::raise<CastemIntegrationFailed>("integration failed for behaviour '"+b+"'");
  ...
  {
    tfel::raise<CastemIntegrationFailed>("maximum number of sub stepping reached failed for behaviour '"+b+"'");    
  ...
  {
    tfel::raise<CastemIntegrationFailed>("maximum number of iterations of the plane stress algorithm "
  ...
  {
    tfel::raise_if(NTENS!=s,"CastemInterfaceExceptions::checkNTENSValue : "
		   "invalid value for the NTENS parameter "
		   "(got '"+std::to_string(NTENS)+"', "
		   "expected '"+std::to_string(static_cast<unsigned int>(s))+"')");  
  ...
  void
  CastemInterfaceExceptions::throwInvalidBehaviourTypeAndModellingHypothesis(const CastemBehaviourType,
									   const std::string& h)
  {
    tfel::raise("CastemInterfaceExceptions::"
		"throwInvalidBehaviourTypeAndModellingHypothesis: "
		"behaviour can't be used in '"+h+"'");  
  } // end of CastemInterfaceExceptions::throwInvalidBehaviourTypeAndModellingHypothesis

  void
  CastemInterfaceExceptions::throwPredictionComputationFailedException(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::throwPredictionComputationFailedException: "
		"prediction computation failed for behaviour '"+b+"'");
  }

  void
  CastemInterfaceExceptions::throwPredictionOperatorIsNotAvalaible(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::throwPredictionOperatorIsNotAvalaible: "
		"behaviour '"+b+"' can't compute a prediction operator");
  } // end of CastemInterfaceExceptions::throwBehaviourIntegrationFailedException

  void
  CastemInterfaceExceptions::throwConsistentTangentOperatorIsNotAvalaible(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::"
  ...
  void
  CastemInterfaceExceptions::throwUnsupportedStressFreeExpansionException(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::"
		"throwUnsupportedStressFreeExpansionException: "
		"behaviour '"+b+"' can handle stress-free expansion "
		"but the Castem interface can't");
  } // end of CastemInterfaceExceptions::throwUnsupportedStressFreeExpansionException

  void
  CastemInterfaceExceptions::throwThermalExpansionCoefficientShallBeNull(const std::string& b)
  {
    tfel::raise("CastemInterfaceExceptions::"
		"throwThermalExpansionCoefficientShallBeNull: "
		"behaviour '"+b+"' handle thermal expansion, so "
  ...
  CastemInterfaceExceptions::throwTangentOperatorNotAvailableThroughGenericPlaneStressHandler(const std::string&){
    tfel::raise("tangent operator is not available in the "
  ...
  CastemInterfaceExceptions::throwInvalidDDSDDEException(const std::string& b,
							 const CastemReal v)
  {
    tfel::raise("CastemInterfaceExceptions::throwInvalidDDSDDEException : "
  ...
  {
    tfel::raise("CastemUnSupportedCaseHandler::exe : "
