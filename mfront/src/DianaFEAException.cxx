...
namespace dianafea 
{
  ...
  DianaFEAException::DianaFEAException(const std::string& s)
    : msg(s)
  {} // end of DianaFEAException::DianaFEAException
  ...
  const char* 
  DianaFEAException::what () const noexcept
  { 
    return msg.c_str(); 
  } // end of DianaFEAException::what

  std::string
  DianaFEAException::getMsg() const noexcept
  {
    return msg;
  ...
  DianaFEAInvalidModellingHypothesis::DianaFEAInvalidModellingHypothesis(DianaFEAInvalidModellingHypothesis&&) = default;

  DianaFEAInvalidModellingHypothesis::DianaFEAInvalidModellingHypothesis(const DianaFEAInvalidModellingHypothesis&) = default;
  
  DianaFEAInvalidModellingHypothesis::DianaFEAInvalidModellingHypothesis(const char* b)
    : DianaFEAException("current modelling hypothesis is not supported by behaviour '"+
		      std::string(b)+"'")
  {}

  DianaFEAInvalidModellingHypothesis::~DianaFEAInvalidModellingHypothesis() noexcept = default;
  ...
  DianaFEAInvalidNTENSValue::DianaFEAInvalidNTENSValue(DianaFEAInvalidNTENSValue&&) = default;

  DianaFEAInvalidNTENSValue::DianaFEAInvalidNTENSValue(const DianaFEAInvalidNTENSValue&) = default;
  ...
  DianaFEAInvalidDimension::DianaFEAInvalidDimension(const DianaFEAInvalidDimension&) = default;

  DianaFEAInvalidDimension::DianaFEAInvalidDimension(DianaFEAInvalidDimension&&) = default;
