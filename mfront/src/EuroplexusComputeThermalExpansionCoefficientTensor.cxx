...
namespace epx
{
  ...
  static void
  EuroplexusComputeIsotropicThermalExpansionCoefficientTensor2D(const EuroplexusReal* const props,
  ...
  static void
  EuroplexusComputeOrthotropicThermalExpansionCoefficientTensor2D(const EuroplexusReal* const props,
								  tfel::config::Types<2u,EuroplexusReal,false>::ThermalExpansionCoefficientTensor& A)
  {
