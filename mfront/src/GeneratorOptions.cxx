...
namespace mfront{
  ...
  GeneratorOptions::GeneratorOptions(GeneratorOptions&&) = default;
  GeneratorOptions&
  GeneratorOptions::operator=(const GeneratorOptions&) = default;
  GeneratorOptions&
  GeneratorOptions::operator =(GeneratorOptions&&) = default;
  GeneratorOptions::~GeneratorOptions() = default;
