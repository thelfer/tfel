...
namespace ansys{
  ...
  void
  AnsysInterfaceExceptions::throwUnMatchedNumberOfMaterialProperties(const std::string& b,
  ...
  void
  AnsysInterfaceExceptions::throwUnMatchedNumberOfStateVariables(const std::string& b,
								 const unsigned short n1,
								 const AnsysInt n2)
  {
    std::ostringstream msg;
  ...
  void
  AnsysInterfaceExceptions::treatAnsysException(const std::string& b,
						const AnsysException& e)
  {
    std::cout << "The behaviour '" << b 
	      << "' has thrown an AnsysException : "
	      << e.what() << std::endl;
  } // end of AnsysInterfaceExceptions::treatAnsysException

  void
  AnsysInterfaceExceptions::treatMaterialException(const std::string& b,
  ...
  void
  AnsysInterfaceExceptions::treatTFELException(const std::string& b,
  ...
  void
  AnsysInterfaceExceptions::treatStandardException(const std::string& b,
  ...
  void
  AnsysInterfaceExceptions::treatUnknownException(const std::string& b)
  {
    std::cout << "The behaviour '" << b 
  ...
  {
    std::cout << "AnsysInterfaceExceptions::displayUnsupportedHypothesisMessage : "
	      << "unsupported hypothesis" << std::endl;
  }
  
  void
  AnsysUnSupportedCaseHandler::exe(const AnsysReal *const,
