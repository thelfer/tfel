...
namespace mtest
{
  ...
  CastemUmatFiniteStrainBehaviour::buildCastemUmatFiniteStrainBehaviour(const std::string& l,
									const std::string& f,
									const Parameters& p,
									const Hypothesis h){
    return CastemUmatStandardBehaviour::buildCastemUmatStandardBehaviour(l,f,p,2u,h);
  } // end of CastemUmatFiniteStrainBehaviour::buildCastemUmatFiniteStrainBehaviour
  
  CastemUmatFiniteStrainBehaviour::CastemUmatFiniteStrainBehaviour(const StandardBehaviourDescription& bd,
								   const std::string& cn)
  ...
  void
  CastemUmatFiniteStrainBehaviour::setOptionalMaterialPropertiesDefaultValues(EvolutionManager& mp,
									      const EvolutionManager& evm) const
  {
    CastemUmatStandardBehaviour::setOptionalMaterialPropertiesDefaultValues(mp,evm,this->stype,this->getHypothesis());
  } // end of CastemUmatFiniteStrainBehaviour::setOptionalMaterialPropertiesDefaultValues
  
  const char*
  CastemUmatFiniteStrainBehaviour::getBehaviourNameForUMATFunctionCall() const{
    return this->mname;
  } // end of CastemUmatFiniteStrainBehaviour::getBehaviourNameForUMATFunctionCal
