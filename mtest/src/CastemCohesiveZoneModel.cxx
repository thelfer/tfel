...
namespace mtest {
  ...
  tfel::math::tmatrix<3u, 3u, real> CastemCohesiveZoneModel::getRotationMatrix(
    ...
    throw(
        std::runtime_error("CastemCohesiveZoneModel::getRotationMatrix : "
                           "invalid call"));
  ...
  std::pair<bool, real> CastemCohesiveZoneModel::integrate(
    ...
    if ((h == ModellingHypothesis::AXISYMMETRICALGENERALISEDPLANESTRAIN) ||
      ...
      throw(
          runtime_error("CastemCohesiveZoneModel::integrate: "
  ...
  void CastemCohesiveZoneModel::computeElasticStiffness(
    ...
    if (this->stype == 0u) {
      ...
      if ((h == ModellingHypothesis::PLANESTRESS) ||
        ...
        throw(
            std::runtime_error("CastemCohesiveZoneModel::integrate: "
                               "unsupported hypothesis"));
      }
