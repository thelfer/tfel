...
namespace mtest
{
  ...
  void
  AnsysFiniteStrainBehaviour::getDrivingVariablesDefaultInitialValues(tfel::math::vector<real>& v) const
  {
    v[0] = v[1] = v[2] = real(1);
  ...
  std::pair<bool,real>
  AnsysFiniteStrainBehaviour::call_behaviour(tfel::math::matrix<real>& Kt,
					     CurrentState& s,
					     ...
					     const bool b) const
  {
    ...
    auto throw_if = [](const bool c, const std::string& m){
      tfel::raise_if(c,"AnsysFiniteStrainBehaviour::"
		     "call_behaviour: "+m);
    };
    ...
    const AnsysReal var[8] = {0,0,0,0,0,0,0,0,};
    AnsysInt keycut = 0;
    (this->fct)(&matId,&elemId,&kDomIntPt,&kLayer,&kSectPt,&ldsetp,&isubst,&keycut,
		&ndirect,&nshear,&ntens,&nstatv,&nprops,&TIME,&dt,
		&(s.esv0(0)),&(s.desv(0)),&us(0),
