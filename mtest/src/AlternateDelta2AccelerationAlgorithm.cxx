...
namespace mtest
{
  ...
  void AlternateDelta2AccelerationAlgorithm::setParameter(const std::string& p,
							  const std::string& v)
  {
  ...
  AlternateDelta2AccelerationAlgorithm::~AlternateDelta2AccelerationAlgorithm() = default;
