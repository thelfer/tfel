...
namespace mtest {
  ...
  static std::pair<bool, real> iterate(StudyCurrentState& scs,
    ...
    if (o.ppolicy == PredictionPolicy::LINEARPREDICTION) {
      ...
      if (o.ppolicy != PredictionPolicy::NOPREDICTION) {
        throw(
            runtime_error("GenericSolver::execute: internal error, "
  ...
  void GenericSolver::execute(StudyCurrentState& scs,
    ...
    if (dt < 0) {
      throw(
          std::runtime_error("GenericSolver::execute: "
                             "negative time step"));
    }
    // almost bone
  ...
  GenericSolver::~GenericSolver() {}  // end of GenericSolver::~GenericSolver
