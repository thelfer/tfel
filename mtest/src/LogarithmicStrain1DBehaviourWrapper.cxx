...
namespace mtest {
  ...
  LogarithmicStrain1DBehaviourWrapper::getGradientsNames() const {
    return {"Strain"};
  }  // end of LogarithmicStrain1DBehaviourWrapper::getGradientsNames

  std::vector<int> LogarithmicStrain1DBehaviourWrapper::getGradientsTypes()
      const {
    return {1};
  }  // end of LogarithmicStrain1DBehaviourWrapper::getGradientsTypes
  ...
  std::vector<std::string>
  LogarithmicStrain1DBehaviourWrapper::getThermodynamicForcesNames() const {
    return {"Stress"};
  }  // end of LogarithmicStrain1DBehaviourWrapper::getThermodynamicForcesNames

  std::vector<int>
  LogarithmicStrain1DBehaviourWrapper::getThermodynamicForcesTypes() const {
    return {1};
  }  // end of LogarithmicStrain1DBehaviourWrapper::getThermodynamicForcesTypes
  ...
  std::vector<int>
  LogarithmicStrain1DBehaviourWrapper::getInternalStateVariablesTypes() const {
    return this->b->getInternalStateVariablesTypes();
  }  // end of
     // LogarithmicStrain1DBehaviourWrapper::getInternalStateVariablesTypes
