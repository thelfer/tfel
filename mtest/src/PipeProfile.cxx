...
namespace mtest{
  ...
  PipeStressProfile::PipeStressProfile()
    : all(true),
      c(0u)
  {}
  ...
  PipeStressProfile::PipeStressProfile(const unsigned short cn)
    : all(false),
      c(cn)
  {} // end of PipeStressProfile::PipeStressProfile
  
  void
  PipeStressProfile::report(std::ostream& os,
  ...
  PipeStrainProfile::PipeStrainProfile()
    : all(true),
      c(0u)
  {}
  ...
  PipeStrainProfile::PipeStrainProfile(const unsigned short cn)
    : all(false),
      c(cn)
  {} // end of PipeStrainProfile::PipeStrainProfile
  
  void
  PipeStrainProfile::report(std::ostream& os,
			    const CurrentState& s) const
  {
    if(all){
  ...
  PipeInternalStateVariableProfile::PipeInternalStateVariableProfile(const unsigned short cn)
    : all(false),
      c(cn)
  {} // end of PipeInternalStateVariableProfile::PipeInternalStateVariableProfile
  
  void
  PipeInternalStateVariableProfile::report(std::ostream& os,
					   const CurrentState& s) const
  {
    if(all){
