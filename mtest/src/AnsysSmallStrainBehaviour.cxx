...
namespace mtest
{
  ...
  std::pair<bool,real>
  AnsysSmallStrainBehaviour::call_behaviour(tfel::math::matrix<real>& Kt,
					     CurrentState& s,
					     ...
					     const bool b) const
  {
    ...
    auto throw_if = [](const bool c, const std::string& m){
      if(c){throw(std::runtime_error("AnsysSmallStrainBehaviour::"
				     "call_behaviour: "+m));}
    };
    ...
    (this->fct)(&matId,&elemId,&kDomIntPt,&kLayer,&kSectPt,&ldsetp,&isubst,&keycut,
		...
		coords,&drot(0,0),nullptr,nullptr,&tsstif,&epsZZ,
