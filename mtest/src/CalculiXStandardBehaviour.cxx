...
namespace mtest
{
  ...
  CalculiXStandardBehaviour::getRotationMatrix(const tfel::math::vector<real>&,
  ...
  StiffnessMatrixType
  CalculiXStandardBehaviour::getDefaultStiffnessMatrixType() const
  {
    return StiffnessMatrixType::CONSISTENTTANGENTOPERATOR;
  }
  
  std::pair<bool,real>
  CalculiXStandardBehaviour::computePredictionOperator(BehaviourWorkSpace& wk,
  ...
  std::pair<bool,real>
  CalculiXStandardBehaviour::integrate(CurrentState& s,
