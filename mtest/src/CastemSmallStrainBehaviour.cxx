...
namespace mtest {
  ...
  void CastemSmallStrainBehaviour::getDrivingVariablesDefaultInitialValues(
      tfel::math::vector<real>& v) const {
    std::fill(v.begin(), v.end(), real(0));
  }  // end of
     // CastemSmallStrainBehaviour::setDrivingVariablesDefaultInitialValue
    ...
    auto throw_if = [](const bool c, const std::string& m) {
      if (c) {
        throw(std::runtime_error(
            "CastemSmallStrainBehaviour::call_behaviour: " + m));
      }
    };
  ...
  void CastemSmallStrainBehaviour::setOptionalMaterialPropertiesDefaultValues(
    ...
    if (this->stype == 0) {
      ...
      throw(
          std::runtime_error("CastemSmallStrainBehaviour::"
                             "setOptionalMaterialPropertiesDefaultValues: "
                             "unsupported symmetry type"));
    }
  }  // end of
     // CastemSmallStrainBehaviour::setOptionalMaterialPropertiesDefaultValues
