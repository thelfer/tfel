...
namespace mtest {
  ...
  CyranoBehaviour::CyranoBehaviour(const Hypothesis h,
    ...
    auto throw_if = [](const bool c, const std::string& m) {
      if (c) {
        throw(std::runtime_error("CyranoBehaviour::CyranoBehaviour: " + m));
      }
    };
    auto& elm =
    ...
    if (this->stype == 0) {
      ...
      if ((h == ModellingHypothesis::AXISYMMETRICALGENERALISEDPLANESTRAIN) ||
        ...
        throw(
            std::runtime_error("CyranoBehaviour::CyranoBehaviour: "
  ...
  void CyranoBehaviour::getDrivingVariablesDefaultInitialValues(
  ...
  std::pair<bool, real> CyranoBehaviour::call_behaviour(
    ...
    auto throw_if = [](const bool c, const std::string& m) {
      if (c) {
        throw(std::runtime_error("CyranoBehaviour::call_behaviour: " + m));
      }
    };
    CyranoInt ntens;
    CyranoInt ndi;
