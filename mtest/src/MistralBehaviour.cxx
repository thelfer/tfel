...
namespace mtest {
  ...
  struct MistralBehaviourDescription : public StandardBehaviourDescription {
    //! Young modulus
  ...
  std::shared_ptr<Behaviour> MistralBehaviour::buildMistralBehaviour(
    ...
    return std::shared_ptr<Behaviour>(new MistralBehaviour(
  ...
  void MistralBehaviour::setOptionalMaterialPropertiesDefaultValues(
    ...
    auto throw_if = [](const bool c, const std::string& m) {
      tfel::raise_if(c,
                     "MTestStandardStandardBehaviour::"
