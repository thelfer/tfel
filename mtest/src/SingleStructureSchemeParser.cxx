...
namespace mtest {
  ...
  static unsigned short getSTensorSize(const unsigned short d) {
    ...
    throw(
        std::runtime_error("mfront::getSTensorSize : "
                           "invalid dimension"));
  }
  ...
  static unsigned short getTensorSize(const unsigned short d) {
    ...
    throw(
        std::runtime_error("mfront::getTensorSize : "
                           "invalid dimension"));
  }
  ...
  void SingleStructureSchemeParser::handleBehaviour(SingleStructureScheme& t,
    ...
    if (i.empty()) {
      throw(
          std::runtime_error("SingleStructureSchemeParser::handleBehaviour: "
                             "unknown interface '" +
                             p->value + "'"));
    }
    ++p;
  ...
  void SingleStructureSchemeParser::handleMaterialProperty(
    ...
    if ((p->value == "constant") || (p->value == "castem") ||
      ...
      throw(
          runtime_error("SingleStructureSchemeParser::handleMaterialProperty: "
                        "unknown interface '" +
                        p->value + "'"));
    }
    ++p;
