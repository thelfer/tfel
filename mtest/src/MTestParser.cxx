...
namespace mtest {
  ...
  void MTestParser::execute(MTest& t,
    ...
    for (const auto& c : ecmds) {
      ...
      try {
        ...
        throw(
            std::runtime_error("MTestParser::execute : "
  ...
  void MTestParser::displayKeyWordDescription(const std::string& k) const {
    ...
    if (std::find(keys.begin(), keys.end(), k) == keys.end()) {
      throw(
          std::runtime_error("MTestParser::displayKeyWordDescription: "
                             "unknown keyword '" +
                             k + "'"));
    }
    const auto f = SchemeParserBase::getDocumentationFilePath("mtest", k);
  ...
  void MTestParser::registerCallBacks() {
    ...
    this->registerCallBack("@Test", &MTestParser::handleTest);
    this->registerCallBack("@RotationMatrix",
                           &MTestParser::handleRotationMatrix);
    this->registerCallBack("@StrainEpsilon", &MTestParser::handleStrainEpsilon);
    ...
    this->registerCallBack("@StressEpsilon", &MTestParser::handleStressEpsilon);
    ...
    this->registerCallBack("@OpeningDisplacement",
                           &MTestParser::handleOpeningDisplacement);
    this->registerCallBack("@DrivingVariable",
                           &MTestParser::handleDrivingVariable);
    this->registerCallBack("@DeformationGradient",
    ...
    this->registerCallBack("@ThermodynamicForce",
                           &MTestParser::handleThermodynamicForce);
    this->registerCallBack("@ImposedStrain", &MTestParser::handleImposedStrain);
    ...
    this->registerCallBack("@ImposedStress", &MTestParser::handleImposedStress);
  ...
  void MTestParser::handleTest(MTest& t, tokens_iterator& p) {
    ...
    auto throw_if = [](const bool c, const std::string& m) {
      if (c) {
        throw(std::runtime_error("MTestParser::handleTest: " + m));
      }
    };
  ...
  void MTestParser::handleStrainEpsilon(MTest& t, tokens_iterator& p) {
    ...
    if (!((t.getBehaviourType() ==
      ...
      throw(
          std::runtime_error("MTestParser::handleStrainEpsilon: "
  ...
  void MTestParser::handleStressEpsilon(MTest& t, tokens_iterator& p) {
    ...
    if ((t.getBehaviourType() !=
        ...
        (t.getBehaviourType() !=
         MechanicalBehaviourBase::FINITESTRAINSTANDARDBEHAVIOUR)) {
      throw(
          std::runtime_error("MTestParser::handleStressEpsilon: "
  ...
  void MTestParser::handleCohesiveForceEpsilon(MTest& t, tokens_iterator& p) {
    ...
    if (t.getBehaviourType() != MechanicalBehaviourBase::COHESIVEZONEMODEL) {
      throw(
          std::runtime_error("MTestParser::handleCohesiveForceEpsilon: "
    ...
    if (!((t.getBehaviourType() ==
          ...
          ((t.getBehaviourType() ==
           ...
           (t.getBehaviourKinematic() ==
            MechanicalBehaviourBase::FINITESTRAINKINEMATIC_ETO_PK1)))) {
      throw(
          std::runtime_error("MTestParser::handleImposedStrain: "
    ...
    if (!((t.getBehaviourType() ==
          ...
          ((t.getBehaviourType() ==
           ...
           (t.getBehaviourKinematic() ==
            MechanicalBehaviourBase::FINITESTRAINKINEMATIC_ETO_PK1)))) {
      throw(
          std::runtime_error("MTestParser::handleStrain: "
  ...
  void MTestParser::handleDeformationGradient(MTest& t, tokens_iterator& p) {
    ...
    if (!((t.getBehaviourType() ==
          ...
          (t.getBehaviourKinematic() ==
           MechanicalBehaviourBase::FINITESTRAINKINEMATIC_F_CAUCHY))) {
      throw(
          std::runtime_error("MTestParser::handleDeformationGradient: "
  ...
  void MTestParser::handleOpeningDisplacement(MTest& t, tokens_iterator& p) {
    ...
    if (t.getBehaviour()->getBehaviourType() !=
      ...
      throw(
          std::runtime_error("MTestParser::handleOpeningDisplacement: "
  ...
  void MTestParser::handleStress(MTest& t, tokens_iterator& p) {
    ...
    if ((t.getBehaviour()->getBehaviourType() !=
        ...
        (t.getBehaviour()->getBehaviourType() !=
         MechanicalBehaviourBase::FINITESTRAINSTANDARDBEHAVIOUR)) {
      throw(
          std::runtime_error("MTestParser::handleStress: "
  ...
  void MTestParser::handleCohesiveForce(MTest& t, tokens_iterator& p) {
    ...
    if (t.getBehaviour()->getBehaviourType() !=
        MechanicalBehaviourBase::COHESIVEZONEMODEL) {
      throw(
          std::runtime_error("MTestParser::handleCohesiveForce: "
