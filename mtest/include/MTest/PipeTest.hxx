...
#ifndef LIB_MTEST_PIPETEST_HXX_
#define LIB_MTEST_PIPETEST_HXX_
...
namespace mtest {
  ...
  struct MTEST_VISIBILITY_EXPORT PipeTest : public SingleStructureScheme {
     ...
     */
    virtual tfel::tests::TestResult execute(void) override;
    /*!
     ...
     */
    virtual size_type getNumberOfUnknowns(void) const override;
    /*!
     * \return the total number of nodes
     */
    virtual size_type getNumberOfNodes(void) const;
    /*!
     ...
     */
    virtual void setModellingHypothesis(const std::string&) override;
   ...
   protected:
     ...
     */
    virtual void checkBehaviourConsistency(
        const std::shared_ptr<Behaviour>&) override;
