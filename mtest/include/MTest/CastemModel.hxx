/*!
 * \file  mtest/include/MTest/CastemModel.hxx
 * \brief
...
#ifndef LIB_MTEST_CASTEMMODEL_HXX
#define LIB_MTEST_CASTEMMODEL_HXX
...
namespace mtest {
   ...
   */
  struct TFEL_VISIBILITY_LOCAL CastemModel : public StandardBehaviourBase {
    /*!
     * \param[in] h : modelling hypothesis
     * \param[in] l : library name
     * \param[in] b : behaviour name
     */
    CastemModel(const Hypothesis, const std::string&, const std::string&);
...
#endif /* LIB_MTEST_CASTEMMODEL_HXX */
