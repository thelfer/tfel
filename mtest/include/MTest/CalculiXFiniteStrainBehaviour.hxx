/*!
 * \file  mtest/include/MTest/CalculiXFiniteStrainBehaviour.hxx
 * \brief
...
#ifndef LIB_MTEST_MTESTCALCULIXFINITESTRAINBEHAVIOUR_HXX
#define LIB_MTEST_MTESTCALCULIXFINITESTRAINBEHAVIOUR_HXX
...
namespace mtest {
   ...
   * interface
   */
  struct TFEL_VISIBILITY_LOCAL CalculiXFiniteStrainBehaviour
      : public CalculiXStandardBehaviour {
    /*!
    ...
    //! destructor
    virtual ~CalculiXFiniteStrainBehaviour();
...
#endif /* LIB_MTEST_MTESTCALCULIXFINITESTRAINBEHAVIOUR_HXX */
