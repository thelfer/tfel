...
#ifndef LIB_MTEST_MTEST_MTESTALTERNATE2DELTAACCELERATIONALGORITHM_HXX
#define LIB_MTEST_MTEST_MTESTALTERNATE2DELTAACCELERATIONALGORITHM_HXX
...
namespace mtest {
   ...
   */
  struct MTEST_VISIBILITY_EXPORT Alternate2DeltaAccelerationAlgorithm
    ...
    //! destructor
    ~Alternate2DeltaAccelerationAlgorithm() override;
...
#endif /* LIB_MTEST_MTEST_MTESTALTERNATE2DELTAACCELERATIONALGORITHM_HXX */
