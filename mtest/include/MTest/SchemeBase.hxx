...
#ifndef LIB_MTEST_SCHEMEBASE_HXX_
#define LIB_MTEST_SCHEMEBASE_HXX_
...
namespace mtest {
  ...
  struct MTEST_VISIBILITY_EXPORT SchemeBase : public Scheme, public Study {
    ...
    virtual unsigned short getDimension(void) const;
    //! \return the modelling hypothesis
    virtual ModellingHypothesis::Hypothesis getModellingHypothesis(void) const;
    /*!
...
#endif /* LIB_MTEST_SCHEMEBASE_HXX_ */
