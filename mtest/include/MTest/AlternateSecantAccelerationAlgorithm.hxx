...
#ifndef LIB_MTEST_MTEST_MTESTALTERNATESECANTACCELERATIONALGORITHM_HXX
#define LIB_MTEST_MTEST_MTESTALTERNATESECANTACCELERATIONALGORITHM_HXX
...
namespace mtest {
  ...
  struct MTEST_VISIBILITY_EXPORT AlternateSecantAccelerationAlgorithm
    ...
    //! destructor
    ~AlternateSecantAccelerationAlgorithm() override;
...
#endif /* LIB_MTEST_MTEST_MTESTALTERNATESECANTACCELERATIONALGORITHM_HXX */
