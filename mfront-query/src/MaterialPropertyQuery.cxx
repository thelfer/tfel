...
namespace mfront{
  ...
  MaterialPropertyQuery::MaterialPropertyQuery(const int argc,
  ...
  MaterialPropertyQuery::registerCommandLineCallBacks(){
    ...
    Parser::registerNewCallBack("--include","-I",&MaterialPropertyQuery::treatSearchPath,
				"add a new path at the beginning of the search paths",true);
    Parser::registerNewCallBack("--search-path",&MaterialPropertyQuery::treatSearchPath,
				"add a new path at the beginning of the search paths",true);
    Parser::registerNewCallBack("--debug",&MaterialPropertyQuery::treatDebug,
				"set debug mode");
    Parser::registerNewCallBack("--warning","-W",&MaterialPropertyQuery::treatWarning,"print warnings");
    Parser::registerNewCallBack("--pedantic",&MaterialPropertyQuery::treatPedantic,
    ...
    Parser::registerNewCallBack("--cppflags",&MaterialPropertyQuery::treatCppFlags,
				"show all the global headers");
    Parser::registerNewCallBack("--libraries-dependencies",&MaterialPropertyQuery::treatLibrariesDependencies,
				"show all the libraries dependencies");
    Parser::registerNewCallBack("--specific-targets",&MaterialPropertyQuery::treatSpecificTargets,
