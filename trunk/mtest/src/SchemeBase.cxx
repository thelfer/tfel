...
namespace mtest{
				     ...
				     const real v)
  {
    ...
    tfel::raise_if(pev==this->evm->end(),
		   "SchemeBase::setEvolutionValue : no evolution '"+
		   n+"' declared");
  ...
  void SchemeBase::setMinimalTimeStepScalingFactor(const real v)
  {
    tfel::raise_if(this->options.minimal_time_step_scaling_factor>0,
		   ...
		   "has already been declared");
    tfel::raise_if(v>=1,"SchemeBase::setMinimalTimeStepScalingFactor: "
		   "the minimal time step scaling factor "
		   "is greater than one ");
  ...
  void SchemeBase::setMaximalTimeStepScalingFactor(const real v)
  {
    tfel::raise_if(this->options.maximal_time_step_scaling_factor>0,
		   ...
		   "has already been declared");
    tfel::raise_if(v<1,"SchemeBase::setMaximalTimeStepScalingFactor: "
		   "the maximal time step scaling factor "
		   "is lower than one ");
  ...
  {
    tfel::raise_if(this->options.ppolicy!=PredictionPolicy::UNSPECIFIEDPREDICTIONPOLICY,
  ...
  {
    tfel::raise_if(this->options.ktype!=StiffnessMatrixType::UNSPECIFIEDSTIFFNESSMATRIXTYPE,
  ...
  {
    tfel::raise_if(this->options.ks!=StiffnessUpdatingPolicy::UNSPECIFIEDSTIFFNESSUPDATINGPOLICY,
