/*! 
 * \file  mtest/src/Crossed2DeltaAccelerationAlgorithm.cxx
 * \brief
...
namespace mtest
{
  ...
  Crossed2DeltaAccelerationAlgorithm::Crossed2DeltaAccelerationAlgorithm()
    : csat(-1)      
  {} // end of Crossed2DeltaAccelerationAlgorithm::Crossed2DeltaAccelerationAlgorithm
    
  std::string
  Crossed2DeltaAccelerationAlgorithm::getName() const{
