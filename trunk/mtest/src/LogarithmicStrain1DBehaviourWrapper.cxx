...
namespace mtest{
  ...
  std::vector<std::string> LogarithmicStrain1DBehaviourWrapper::
      getOptionalMaterialProperties() const {
    return {};
  }  // end of
  ...
  void LogarithmicStrain1DBehaviourWrapper::
    ...
    bool LogarithmicStrain1DBehaviourWrapper::hasBounds(const std::string& v)
        const {
    ...
    void LogarithmicStrain1DBehaviourWrapper::allocate(BehaviourWorkSpace & wk)
        const {
      this->b->allocate(wk);
    ...
    LogarithmicStrain1DBehaviourWrapper::computePredictionOperator(
        BehaviourWorkSpace & wk, const CurrentState& s,
    ...
    std::pair<bool, real> LogarithmicStrain1DBehaviourWrapper::integrate(
        CurrentState & s, BehaviourWorkSpace & wk, const real dt,
        const StiffnessMatrixType ktype) const {
      const auto eps = std::numeric_limits<real>::epsilon();
      // logarithmic strains
      if ((1 + s.e0[0] < eps) || (1 + s.e0[1] < eps) || (1 + s.e0[2] < eps) ||
    ...
    LogarithmicStrain1DBehaviourWrapper::
        ~LogarithmicStrain1DBehaviourWrapper() = default;
