...
#ifndef _LIB_TFEL_BASIC_WSTREAM_IXX_
#define _LIB_TFEL_BASIC_WSTREAM_IXX_ 
...
namespace tfel
{
  ...
  namespace system
  {
    ...
    template<typename Child,typename Traits>
    basic_wstream<Child,Traits>&
    basic_wstream<Child,Traits>::operator<<(const void*& p)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    basic_wstream<Child,Traits>&
    basic_wstream<Child,Traits>::operator<<(const std::string& s)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    basic_wstream<Child,Traits>&
    basic_wstream<Child,Traits>::operator<<(const char* s)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    basic_wstream<Child,Traits>&
    basic_wstream<Child,Traits>::operator=(const basic_wstream<Child,Traits>&)
    {
      return *this;
    }  // end of basic_wstream<Child,Traits>::operator=
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const char* const c,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const bool * const b,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const short * const s,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const unsigned short * const u,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const int* const i,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const unsigned int * const u,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const long * const l,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const unsigned long * const u,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const float * const f,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const double * const d,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
    ...
    template<typename Child,typename Traits>
    TFEL_INLINE2 void
    basic_wstream<Child,Traits>::write(const long double * const l,const size_t size)
    {
      int fd = static_cast<const Child* const>(this)->getFileDescriptor();
...
#endif /* _LIB_TFEL_BASIC_WSTREAM_IXX */
