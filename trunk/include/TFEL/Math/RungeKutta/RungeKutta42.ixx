...
#ifndef _LIB_TFEL_RUNGEKUTTA42_IXX_
#define _LIB_TFEL_RUNGEKUTTA42_IXX_ 
...
namespace tfel
{
  namespace math
  {
    ...
    void
    RungeKutta42<N,C,S>::setInitialValue(const typename RungeKutta42<N,C,S>::VariableType& y_)
    {
      this->y = y_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta42<N,C,S>::setInitialTime(const S ti_)
    {
      this->ti = ti_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta42<N,C,S>::setFinalTime(const S tf_)
    {
      this->tf = tf_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta42<N,C,S>::setInitialTimeIncrement(const S dt_)
    {
      this->dt = dt_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta42<N,C,S>::setCriterium(const S e_)
    {
      this->epsilon = e_;
    } // end of RungeKutta42<N,C,S>::setInitialTimeIncrement
    ...
    {
      static const Scalar cste1_6 = Scalar(1)/Scalar(6);
      static const Scalar cste1_3 = Scalar(1)/Scalar(3);
...
#endif /* _LIB_TFEL_RUNGEKUTTA42_IXX */
