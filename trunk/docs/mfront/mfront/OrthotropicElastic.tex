...
\hlstd{@ProvidesSymmetricTangentOperator}\hlsym{;}\hspace*{\fill}\\
\hlstd{\hspace*{\fill}\\
@Integrator}\hlsym{\{}\hspace*{\fill}\\
\hlstd{}\hlstd{\ \ }\hlstd{sig\ }\hlsym{=\ }\hlstd{D}\hlsym{{*}(}\hlstd{eto}\hlsym{+}\hlstd{deto}\hlsym{);}\hspace*{\fill}\\
\hlstd{}\hlstd{\ \ }\hlstd{}\hlkwa{if}\hlstd{}\hlsym{(}\hlstd{computeTangentOperator\textunderscore }\hlsym{)\{}\hspace*{\fill}\\
\hlstd{}\hlstd{\ \ \ \ }\hlstd{Dt\ }\hlsym{=\ }\hlstd{D}\hlsym{;}\hspace*{\fill}\\
