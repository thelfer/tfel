/*!
 * \file   mfront/src/LSDYNAComputeThermalExpansionCoefficientTensor.cxx
 * \brief    
...
#define LSDYNACOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(real)                                                                 \
  static void																 \
  LSDYNAComputeIsotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
  ...
  {																	 \
    ...
    A(3)=0.;																 \
																	 ...
																	 \
  static void																 \
  LSDYNAComputeOrthotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
						 tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
    ...
    A(3)=0.;																 \
 																	 ...
 																	 \
  void																	 \
  LSDYNAComputeThermalExpansionCoefficientTensor<lsdyna::STANDARDSTRAINBASEDBEHAVIOUR,							 \
				    tfel::material::ModellingHypothesis::PLANESTRESS,							 \
				    ISOTROPIC>::exe(const real* const props,							         \
						    tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
    LSDYNAComputeIsotropicThermalExpansionCoefficientTensor2D(props,A);									 \
  } /* end of struct LSDYNAComputeThermalExpansionCoefficientTensor */	                                                                 \
																	 \
  void																	 \
  LSDYNAComputeThermalExpansionCoefficientTensor<lsdyna::STANDARDSTRAINBASEDBEHAVIOUR,							 \
  ...
  LSDYNAComputeThermalExpansionCoefficientTensor<lsdyna::STANDARDSTRAINBASEDBEHAVIOUR,							 \
				    ...
				    ORTHOTROPIC>::exe(const real* const props,							         \
						      tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
    LSDYNAComputeOrthotropicThermalExpansionCoefficientTensor2D(props,A);								 \
  } /* end of struct LSDYNAComputeThermalExpansionCoefficientTensor */								         \
																	 \
  void																	 \
  LSDYNAComputeThermalExpansionCoefficientTensor<lsdyna::STANDARDSTRAINBASEDBEHAVIOUR,							 \
  ...
  {																	 \
    LSDYNAComputeOrthotropicThermalExpansionCoefficientTensor2D(props,C);								 \
  } /* end of struct LSDYNAComputeThermalExpansionCoefficientTensor */	                                                                 \
  																	 \
  void																	 \
  LSDYNAComputeThermalExpansionCoefficientTensor<lsdyna::STANDARDSTRAINBASEDBEHAVIOUR,							 \
...
namespace lsdyna
{
  ...
  LSDYNACOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(float)
  LSDYNACOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(double)
