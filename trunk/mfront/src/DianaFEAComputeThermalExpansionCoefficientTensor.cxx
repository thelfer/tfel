...
#define ANSYSCOMPUTEISOTROPICTHERMALEXPANSIONCOEFFICIENTTENSORIMP(real)                                                                 \
  static void																 \
  DianaFEAComputeIsotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
  ...
  {																	 \
    ...
    A(3)=0.;																 \
																	 ...
																	 \
  static void																 \
  DianaFEAComputeOrthotropicThermalExpansionCoefficientTensor2D(const real* const props,						         \
						 tfel::config::Types<2u,real,false>::ThermalExpansionCoefficientTensor& A)	         \
  {																	 \
    ...
    A(3)=0.;																 \
 																	 ...
 																	 \
  void																	 \
  DianaFEAComputeThermalExpansionCoefficientTensor<dianafea::STANDARDSTRAINBASEDBEHAVIOUR,							 \
