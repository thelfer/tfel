...
namespace ansys 
{
  ...
  AnsysException::AnsysException(const std::string& s)
    : msg(s)
  {} // end of AnsysException::AnsysException
  ...
  const char* 
  AnsysException::what () const noexcept
  { 
    return msg.c_str(); 
  } // end of AnsysException::what

  std::string
  AnsysException::getMsg() const noexcept
  {
    return msg;
  ...
  AnsysInvalidModellingHypothesis::AnsysInvalidModellingHypothesis(AnsysInvalidModellingHypothesis&&) = default;

  AnsysInvalidModellingHypothesis::AnsysInvalidModellingHypothesis(const AnsysInvalidModellingHypothesis&) = default;
  
  AnsysInvalidModellingHypothesis::AnsysInvalidModellingHypothesis(const char* b)
    : AnsysException("current modelling hypothesis is not supported by behaviour '"+
		      std::string(b)+"'")
  {}

  AnsysInvalidModellingHypothesis::~AnsysInvalidModellingHypothesis() noexcept = default;
  ...
  AnsysInvalidNTENSValue::AnsysInvalidNTENSValue(AnsysInvalidNTENSValue&&) = default;

  AnsysInvalidNTENSValue::AnsysInvalidNTENSValue(const AnsysInvalidNTENSValue&) = default;
  ...
  AnsysInvalidDimension::AnsysInvalidDimension(const AnsysInvalidDimension&) = default;

  AnsysInvalidDimension::AnsysInvalidDimension(AnsysInvalidDimension&&) = default;
