...
namespace dianafea
{
  ...
  private:
	...
	using  TangentOperatorType     = typename DianaFEATangentOperatorType<DianaFEATraits<Behaviour>::btype,real,N>::type;
	using  TangentOperatorViewType = typename DianaFEATangentOperatorType<DianaFEATraits<Behaviour>::btype,real,N>::view_type;
  ...
  private:
	...
	using  TangentOperatorType
	  = typename DianaFEATangentOperatorType<DianaFEATraits<Behaviour>::btype,real,2u>::type;
