...
namespace abaqus
{
  ...
  template<typename real>
  void AbaqusRotation2D<real>::rotateDeformationGradientForward(const real *const F,
								real *const Fm)
  {
  ...
  // D^g=tN:D^m:N
  template<typename real>
  void AbaqusRotation2D<real>::rotateTangentOperatorBackward(real *const D) const
  {
    real MN[4][4];
    // Première ligne
    MN[0][0]=a[0]*a[0];
  ...
  template<typename real>
  void AbaqusRotation3D<real>::rotateDeformationGradientForward(const real *const F,
								real *const Fm)
  {
  ...
  template<typename real>
  void AbaqusRotation3D<real>::rotateTangentOperatorBackward(real *const D) const
  {
    real MN[6][6];
