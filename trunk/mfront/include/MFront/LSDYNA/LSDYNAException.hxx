...
namespace lsdyna {
    ...
    : public LSDYNAException
  {
    ...
    LSDYNAInvalidModellingHypothesis&
      operator=(const LSDYNAInvalidModellingHypothesis&) = delete;
  ...
  private:
    ...
    LSDYNAInvalidNTENSValue&
    operator=(const LSDYNAInvalidNTENSValue&) = delete;
  ...
  struct MFRONT_LSDYNA_VISIBILITY_EXPORT LSDYNAInvalidDimension
    : public LSDYNAException
  {
    LSDYNAInvalidDimension(const std::string&,
  ...
  private:
    ...
    LSDYNAInvalidDimension&
    operator=(const LSDYNAInvalidDimension&) = delete;
