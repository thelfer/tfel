...
extern "C" {
  ...
  int *
  tfel_getArrayOfInts(LibraryHandlerPtr,
		      const char * const);
   ...
   * \return the searched function pointer if the call succeed, the NULL pointer if not.
   */
  int (TFEL_ADDCALL_PTR tfel_getGenericBehaviourFunction(LibraryHandlerPtr,const char * const))(struct MFront_GB_BehaviourData* const);
  /*!
