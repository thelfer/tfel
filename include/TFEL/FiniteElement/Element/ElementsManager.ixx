  ...
  namespace fe
  {
	...
	: protected ContainerRebind::template Rebind<Element>::type
      ...
      template<typename CurrentElement,typename NextElement,
	       typename ContainerRebind>
      struct ElementsContainer<tfel::meta::TypeListNode<CurrentElement,NextElement>,
			       ContainerRebind>
	: protected ElementsContainer<CurrentElement,ContainerRebind>,
      ...
      struct ElementsContainer<tfel::meta::TypeListEndType,ContainerRebind>
      {};
    ...
    protected:
      ...
      typedef typename tfel::meta::IF<tfel::meta::IsSubClassOf<Element,tfel::meta::TypeList>::cond,
	...
	tfel::meta::TypeListCountNbrOfT<T1,ElementList>::value==1, 
	const T1&>::type 
