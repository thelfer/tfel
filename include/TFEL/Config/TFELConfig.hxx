...
#if defined _WIN32 || defined _WIN64 ||defined __CYGWIN__
#  if defined TFELMaterialSingleCristal_EXPORTS
#    define TFELMATERIALSINGLECRISTAL_VISIBILITY_EXPORT TFEL_VISIBILITY_EXPORT
#  else
#    define TFELMATERIALSINGLECRISTAL_VISIBILITY_EXPORT TFEL_VISIBILITY_IMPORT
#  endif
#else
#  define TFELMATERIALSINGLECRISTAL_VISIBILITY_EXPORT TFEL_VISIBILITY_EXPORT
#endif
