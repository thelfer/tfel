...
namespace tfel::config {
  ...
  struct ScalarTypes {
    ...
    typedef tfel::math::qt<tfel::math::StandardUnit<-1, 1, 2, 0, 0, 0, 0>,
                           T>
        compliance;
    typedef tfel::math::
        qt<tfel::math::StandardUnit<1, -1, -1, 0, 0, 0, 0>, T>
            viscosity;
    typedef tfel::math::qt<tfel::math::StandardUnit<-1, 1, 1, 0, 0, 0, 0>,
                           T>
        viscouscompliance;
