...
namespace tfel{
  ...
  namespace material{
	...
	tfel::material::ModellingHypothesisToSpaceDimension<H>;
      ...
      /*!
       * \brief partial specialisation of the `OrthotropicStressLinearTransformation`
       * in `1D`.
       */
      template<>
	    ...
	    const real c66)
	{
       ...
       */
      template<ModellingHypothesis::Hypothesis H>
      struct OrthotropicStressLinearTransformationII<H,OrthotropicAxesConvention::DEFAULT>
	: public OrthotropicStressLinearTransformation<ModellingHypothesisToSpaceDimension<H>::value>
      {}; // end of struct OrthotropicStressLinearTransformationII<H,OrthotropicAxesConvention::DEFAULT>
      /*!
       * \brief partial specialisation of the
       * `OrthotropicStressLinearTransformationII` for the
       ...
       */
      template<ModellingHypothesis::Hypothesis H>
      struct OrthotropicStressLinearTransformationII<H,OrthotropicAxesConvention::PIPE>
	: public OrthotropicStressLinearTransformation<ModellingHypothesisToSpaceDimension<H>::value>
      {}; // end of struct OrthotropicStressLinearTransformationII<H,OrthotropicAxesConvention::PIPE>
      /*!
       * \brief partial specialisation of the
       * `OrthotropicStressLinearTransformationII` for the
       ...
       */
      template<>
      struct OrthotropicStressLinearTransformationII<ModellingHypothesis::PLANESTRAIN,
	...
	exe(const real c12,const real c21,
	    ...
	    const real c66)
	{
	  return OrthotropicStressLinearTransformation<2u>::exe(c13,c31,c12,c21,c32,
								c23,c55,c44,c66);
	} // end of exe
       ...
       */
      template<>
      struct OrthotropicStressLinearTransformationII<ModellingHypothesis::PLANESTRESS,
						     OrthotropicAxesConvention::PIPE>
      {
	/*!
	 * \return a linear transformation of the stresses
	    ...
	    const real c66)
	{
      ...
      }; // end of struct OrthotropicStressLinearTransformationII<H,tfel::material::OrthotropicAxesConvention::PIPE>
      /*!
       * \brief partial specialisation of the
       * `OrthotropicStressLinearTransformationII` for the
       * `tfel::material::OrthotropicAxesConvention::PIPE` orthotropic
       ...
       */
      template<>
      struct OrthotropicStressLinearTransformationII<ModellingHypothesis::GENERALISEDPLANESTRAIN,
					  OrthotropicAxesConvention::PIPE>
      {
	/*!
	 * \return a linear transformation of the stresses
	    ...
	    const real c66)
	{
       ...
       */
      template<>
      struct OrthotropicStressLinearTransformationII<ModellingHypothesis::TRIDIMENSIONAL,
