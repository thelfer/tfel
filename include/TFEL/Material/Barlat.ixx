  ...
  namespace material{
	    ...
	    const real c66)
	{
      ...
      typename std::enable_if<tfel::math::StensorTraits<StressStensor>::dime==2u,
			      void>::type
      completeBaralatStressSecondDerivative(tfel::material::BarlatStressSecondDerivativeType<StressStensor>& d2Psi_ds2,
					   const tfel::math::tvector<3u,tfel::material::BarlatBaseType<StressStensor>>& dPsi_dvp,
					   const tfel::math::tvector<6u,tfel::material::BarlatInvertStressType<StressStensor>>& d2Psi_dvp2,
					...
					const BarlatExponentType a)
    {
      ...
      const auto Psi_a = (std::pow(std::abs(rvp1[0]-rvp2[0]),a)+
			  ...
			  std::pow(std::abs(rvp1[2]-rvp2[1]),a)+
			  std::pow(std::abs(rvp1[2]-rvp2[2]),a))/4;
      d.Psi = seq*std::pow(Psi_a,1/real(a));
      // For the derivatives, the stress eigenvalues are normalised by
      // the Barlat equivalent stress
      const auto rvp1b = vp1/d.Psi;
      const auto rvp2b = vp2/d.Psi;
      const tfel::math::tvector<9u,real> drvpb_am2 =
	{std::pow(std::abs(rvp1b[0]-rvp2b[0]),a-2),  // s'1-s''1
	 ...
	 std::pow(std::abs(rvp1b[2]-rvp2b[2]),a-2)}; // s'3-s''3
      d.dPsi_dsvp1 = {((rvp1b[0]-rvp2b[0])*drvpb_am2[0]+
		       (rvp1b[0]-rvp2b[1])*drvpb_am2[1]+
		       (rvp1b[0]-rvp2b[2])*drvpb_am2[2])/4,
		      ((rvp1b[1]-rvp2b[0])*drvpb_am2[3]+
		       (rvp1b[1]-rvp2b[1])*drvpb_am2[4]+
		      ...
		      ((rvp1b[2]-rvp2b[0])*drvpb_am2[6]+
		       (rvp1b[2]-rvp2b[1])*drvpb_am2[7]+
		       (rvp1b[2]-rvp2b[2])*drvpb_am2[8])/4};
      d.dPsi_dsvp2 = {((rvp2b[0]-rvp1b[0])*drvpb_am2[0]+
		       (rvp2b[0]-rvp1b[1])*drvpb_am2[3]+
		       (rvp2b[0]-rvp1b[2])*drvpb_am2[6])/4,
		      ((rvp2b[1]-rvp1b[0])*drvpb_am2[1]+
		       (rvp2b[1]-rvp1b[1])*drvpb_am2[4]+
		      ...
		      ((rvp2b[2]-rvp1b[0])*drvpb_am2[2]+
		       ...
		       (rvp2b[2]-rvp1b[2])*drvpb_am2[8])/4};
      // second derivative
      const auto cste = (a-1)/d.Psi;
      d.d2Psi_dsvp12 = {cste*((drvpb_am2[0]+drvpb_am2[1]+drvpb_am2[2])/4-
			      d.dPsi_dsvp1[0]*d.dPsi_dsvp1[0]), // s1s1
			cste*((drvpb_am2[3]+drvpb_am2[4]+drvpb_am2[5])/4-
			      d.dPsi_dsvp1[1]*d.dPsi_dsvp1[1]), // s2s2
			cste*((drvpb_am2[6]+drvpb_am2[7]+drvpb_am2[8])/4-
			      d.dPsi_dsvp1[2]*d.dPsi_dsvp1[2]), // s3s3
			-cste*d.dPsi_dsvp1[0]*d.dPsi_dsvp1[1],  // s1s2
			-cste*d.dPsi_dsvp1[0]*d.dPsi_dsvp1[2],  // s1s3
			-cste*d.dPsi_dsvp1[1]*d.dPsi_dsvp1[2]}; // s2s3
      d.d2Psi_dsvp22 = {cste*((drvpb_am2[0]+drvpb_am2[3]+drvpb_am2[6])/4-
			      d.dPsi_dsvp2[0]*d.dPsi_dsvp2[0]), // s1s1
			cste*((drvpb_am2[1]+drvpb_am2[4]+drvpb_am2[7])/4-
			      d.dPsi_dsvp2[1]*d.dPsi_dsvp2[1]), // s2s2
			cste*((drvpb_am2[2]+drvpb_am2[5]+drvpb_am2[8])/4-
			      d.dPsi_dsvp2[2]*d.dPsi_dsvp2[2]), // s3s3
			-cste*d.dPsi_dsvp2[0]*d.dPsi_dsvp2[1],  // s1s2
			-cste*d.dPsi_dsvp2[0]*d.dPsi_dsvp2[2],  // s1s3
			-cste*d.dPsi_dsvp2[1]*d.dPsi_dsvp2[2]}; // s2s3
      d.d2Psi_dsvp1dsvp2 = {-cste*(drvpb_am2[0]/4+d.dPsi_dsvp1[0]*d.dPsi_dsvp2[0]), //s'1 s''1
			    -cste*(drvpb_am2[1]/4+d.dPsi_dsvp1[0]*d.dPsi_dsvp2[1]), //s'1 s''2
			    -cste*(drvpb_am2[2]/4+d.dPsi_dsvp1[0]*d.dPsi_dsvp2[2]), //s'1 s''3
			    -cste*(drvpb_am2[3]/4+d.dPsi_dsvp1[1]*d.dPsi_dsvp2[0]), //s'2 s''1
			    -cste*(drvpb_am2[4]/4+d.dPsi_dsvp1[1]*d.dPsi_dsvp2[1]), //s'2 s''2
			    -cste*(drvpb_am2[5]/4+d.dPsi_dsvp1[1]*d.dPsi_dsvp2[2]), //s'2 s''3
			    -cste*(drvpb_am2[6]/4+d.dPsi_dsvp1[2]*d.dPsi_dsvp2[0]), //s'3 s''1
			    -cste*(drvpb_am2[7]/4+d.dPsi_dsvp1[2]*d.dPsi_dsvp2[1]), //s'3 s''2
			    -cste*(drvpb_am2[8]/4+d.dPsi_dsvp1[2]*d.dPsi_dsvp2[2])}; //s'3 s''3
      return d;
					...
					const BarlatStressType<StressStensor> e)
    {
      ...
      // Barlat normal
      const auto dPsi_ds1 = (d.dPsi_dsvp1[0]*std::get<0>(n1)+
			     d.dPsi_dsvp1[1]*std::get<1>(n1)+
			     d.dPsi_dsvp1[2]*std::get<2>(n1));
      const auto dPsi_ds2 = (d.dPsi_dsvp2[0]*std::get<0>(n2)+
			     d.dPsi_dsvp2[1]*std::get<1>(n2)+
			     d.dPsi_dsvp2[2]*std::get<2>(n2));
      const auto dPsi_ds = eval(dPsi_ds1*l1+dPsi_ds2*l2);
      // second derivatives with respect to s'
      auto d2Psi_ds1ds1 =
	eval(d.d2Psi_dsvp12[0]*(std::get<0>(n1)^std::get<0>(n1))+  // s'1s'1
	     d.d2Psi_dsvp12[3]*(std::get<0>(n1)^std::get<1>(n1))+  // s'1s'2
	     d.d2Psi_dsvp12[4]*(std::get<0>(n1)^std::get<2>(n1))+  // s'1s'3
	     d.d2Psi_dsvp12[3]*(std::get<1>(n1)^std::get<0>(n1))+  // s'2s'1
	     d.d2Psi_dsvp12[1]*(std::get<1>(n1)^std::get<1>(n1))+  // s'2s'2
	     d.d2Psi_dsvp12[5]*(std::get<1>(n1)^std::get<2>(n1))+  // s'2s'3
	     d.d2Psi_dsvp12[4]*(std::get<2>(n1)^std::get<0>(n1))+  // s'3s'1
	     d.d2Psi_dsvp12[5]*(std::get<2>(n1)^std::get<1>(n1))+  // s'3s'2
	     d.d2Psi_dsvp12[2]*(std::get<2>(n1)^std::get<2>(n1))); // s'3s'3
      // a now, terms related to the eigen vectors derivatives
      internals::completeBaralatStressSecondDerivative<StressStensor>(d2Psi_ds1ds1,
								      d.dPsi_dsvp1,
								      d.d2Psi_dsvp12,
								      vp1,m1,e);
      // second derivatives with respect to s's''
      const auto d2Psi_ds1ds2 =
	eval(d.d2Psi_dsvp1dsvp2[0]*(std::get<0>(n1)^std::get<0>(n2))+  // s'1s''1
	     d.d2Psi_dsvp1dsvp2[1]*(std::get<0>(n1)^std::get<1>(n2))+  // s'1s''2
	     d.d2Psi_dsvp1dsvp2[2]*(std::get<0>(n1)^std::get<2>(n2))+  // s'1s''3
	     d.d2Psi_dsvp1dsvp2[3]*(std::get<1>(n1)^std::get<0>(n2))+  // s'2s''1
	     d.d2Psi_dsvp1dsvp2[4]*(std::get<1>(n1)^std::get<1>(n2))+  // s'2s''2
	     d.d2Psi_dsvp1dsvp2[5]*(std::get<1>(n1)^std::get<2>(n2))+  // s'2s''3
	     d.d2Psi_dsvp1dsvp2[6]*(std::get<2>(n1)^std::get<0>(n2))+  // s'3s''1
	     d.d2Psi_dsvp1dsvp2[7]*(std::get<2>(n1)^std::get<1>(n2))+  // s'3s''2
	     d.d2Psi_dsvp1dsvp2[8]*(std::get<2>(n1)^std::get<2>(n2))); // s'3s''3
      // second derivatives with respect to s''
      auto d2Psi_ds2ds2 =
	eval(d.d2Psi_dsvp22[0]*(std::get<0>(n2)^std::get<0>(n2))+  // s''1s''1
	     d.d2Psi_dsvp22[3]*(std::get<0>(n2)^std::get<1>(n2))+  // s''1s''2
	     d.d2Psi_dsvp22[4]*(std::get<0>(n2)^std::get<2>(n2))+  // s''1s''3
	     d.d2Psi_dsvp22[3]*(std::get<1>(n2)^std::get<0>(n2))+  // s''2s''1
	     d.d2Psi_dsvp22[1]*(std::get<1>(n2)^std::get<1>(n2))+  // s''2s''2
	     d.d2Psi_dsvp22[5]*(std::get<1>(n2)^std::get<2>(n2))+  // s''2s''3
	     d.d2Psi_dsvp22[4]*(std::get<2>(n2)^std::get<0>(n2))+  // s''3s''1
	     d.d2Psi_dsvp22[5]*(std::get<2>(n2)^std::get<1>(n2))+  // s''3s''2
	     d.d2Psi_dsvp22[2]*(std::get<2>(n2)^std::get<2>(n2))); // s''3s''3
      // a now, terms related to the eigen vectors derivatives
      internals::completeBaralatStressSecondDerivative<StressStensor>(d2Psi_ds2ds2,
								      d.dPsi_dsvp2,
								      d.d2Psi_dsvp22,
								      vp2,m2,e);
      // second derivatives with respect to s''s'
      const auto d2Psi_ds2ds1 =
	eval(d.d2Psi_dsvp1dsvp2[0]*(std::get<0>(n2)^std::get<0>(n1))+  // s''1s'1
	     d.d2Psi_dsvp1dsvp2[3]*(std::get<0>(n2)^std::get<1>(n1))+  // s''1s'2
	     d.d2Psi_dsvp1dsvp2[6]*(std::get<0>(n2)^std::get<2>(n1))+  // s''1s'3
	     d.d2Psi_dsvp1dsvp2[1]*(std::get<1>(n2)^std::get<0>(n1))+  // s''2s'1
	     d.d2Psi_dsvp1dsvp2[4]*(std::get<1>(n2)^std::get<1>(n1))+  // s''2s'2
	     d.d2Psi_dsvp1dsvp2[7]*(std::get<1>(n2)^std::get<2>(n1))+  // s''2s'3
	     d.d2Psi_dsvp1dsvp2[2]*(std::get<2>(n2)^std::get<0>(n1))+  // s''3s'1
	     d.d2Psi_dsvp1dsvp2[5]*(std::get<2>(n2)^std::get<1>(n1))+  // s''3s'2
	     d.d2Psi_dsvp1dsvp2[8]*(std::get<2>(n2)^std::get<2>(n1))); // s''3s'3
      const auto d2Psi_ds2 = eval(tl1*(d2Psi_ds1ds1*l1+d2Psi_ds1ds2*l2)+
				  tl2*(d2Psi_ds2ds1*l1+d2Psi_ds2ds2*l2));
      return std::make_tuple(d.Psi,dPsi_ds,d2Psi_ds2);
