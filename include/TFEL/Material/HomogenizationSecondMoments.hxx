...
namespace tfel::material::homogenization::elasticity {
  ...
  /*!
   * This function computes the averages on each phase of the square of the equivalent strain
   * assuming a Hashin-Shtrikman homogenization scheme, and assuming two phases: spherical
   * isotropic inclusions embedded in an isotropic matrix (note that the inclusion can be softer
   * or stiffer than the matrix)
   * \tparam StressType: type of the elastic constants related to the matrix and
   * the inclusions
   * \return an object of type std::pair<real<StressType>,real<StressType>>
   * \param [in] IM0: IsotropicModuli of the matrix
   * \param [in] f: volumic fraction of inclusions
   * \param [in] IMi: IsotropicModuli of the spherical inclusions
   * \param [in] em2: Square of the hydrostatic part of the macroscopic strain (third of the trace of the strain)
   * \param [in] eeq2: Square of the equivalent macroscopic strain
   */
  ...
  /*!
   * This function computes the averages on each phase of the square of the third of the trace of the strain
   * assuming a Hashin-Shtrikman homogenization scheme, and assuming two phases: spherical
   * isotropic inclusions embedded in an isotropic matrix (note that the inclusion can be softer
   * or stiffer than the matrix).
   * \tparam StressType: type of the elastic constants related to the matrix and
