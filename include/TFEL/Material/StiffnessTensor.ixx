...
namespace tfel::material::internals {
  ...
  struct ComputeOrthotropicStiffnessTensor<ModellingHypothesis::PLANESTRESS,
    ...
    TFEL_HOST_DEVICE static constexpr void exe(
        ...
        const StressType G13) noexcept {
      using COST =
          ComputeOrthotropicStiffnessTensorII<ModellingHypothesis::PLANESTRESS,
                                              smt>;
  ...
  struct ComputeOrthotropicStiffnessTensor<ModellingHypothesis::PLANESTRAIN,
    ...
    TFEL_HOST_DEVICE static constexpr void exe(
        ...
        const StressType G13) noexcept {
      using COST =
          ComputeOrthotropicStiffnessTensorII<ModellingHypothesis::PLANESTRAIN,
                                              smt>;
      COST::exe(C, E1, E3, E2, n13, n23 * E3 / E2, n12, G13, G23, G12);
    }
  };
...
namespace tfel::material {
  ...
  TFEL_HOST_DEVICE constexpr void ComputeAlteredStiffnessTensor<H>::exe(
      tfel::math::st2tost2<ModellingHypothesisToSpaceDimension<H>::value,
                           StressType>& Da,
      const tfel::math::st2tost2<ModellingHypothesisToSpaceDimension<H>::value,
                                 StressType>& D) noexcept {
    Da = D;
  }

  template <typename StressType>
  TFEL_HOST_DEVICE constexpr void
  ComputeAlteredStiffnessTensor<ModellingHypothesis::PLANESTRESS>::exe(
      tfel::math::st2tost2<2u, StressType>& Da,
      const tfel::math::st2tost2<2u, StressType>& D) noexcept {
  ...
  TFEL_HOST_DEVICE constexpr void computeOrthotropicStiffnessTensorII(
      ...
      const StressType G23,
      const StressType G13) noexcept {
    tfel::material::internals::ComputeOrthotropicStiffnessTensorI<N, smt>::exe(
  ...
  TFEL_HOST_DEVICE constexpr void computeOrthotropicStiffnessTensor(
      ...
      const StressType G23,
      const StressType G13) noexcept {
    tfel::material::internals::ComputeOrthotropicStiffnessTensorII<H, smt>::exe(
        C, E1, E2, E3, n12, n23, n13, G12, G23, G13);
  }
