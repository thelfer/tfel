...
namespace tfel {
  ...
  namespace material {
    ...
    namespace lame {
       ...
       */
      template <typename T>
      TFEL_MATERIAL_INLINE const T computeLambda(const T young, const T nu) {
       ...
       */
      template <typename T>
      TFEL_MATERIAL_INLINE const tfel::math::qt<tfel::math::Stress, T> computeLambda(
       ...
       */
      template <typename T>
      TFEL_MATERIAL_INLINE const T computeMu(const T young, const T nu) {
        return young / (2 * (1 + nu));
      }
       ...
       */
      template <typename T>
      TFEL_MATERIAL_INLINE const tfel::math::qt<tfel::math::Stress, T> computeMu(
          const tfel::math::qt<tfel::math::Stress, T> young,
          const tfel::math::qt<tfel::math::NoUnit, T> nu) {
        return young / (2 * (1 + nu));
      }
