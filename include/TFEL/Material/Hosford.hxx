...
namespace tfel {
  ...
  namespace material {
     ...
     * HosfordExponentType: type of the hosford exponent (could be a numeric
     * type or an integer type) \tparam es: eigen solver to be used \param[in]
     * s: stress tensor \param[in] a: Hosford exponent \param[in] e: criterion
     * used to check if the stress are null
     */
    template <typename StressStensor,
              typename HosfordExponentType,
              tfel::math::stensor_common::EigenSolver =
