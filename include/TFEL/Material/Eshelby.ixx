  ...
  namespace homogenization {
    namespace elasticity {
      ...
      computeAxisymmetricalEshelbyTensor(const real& nu,
        ...
        const auto S11 = 3 / (8 * (1 - nu)) * e2 / e21 +
                         q / 4 / (1 - nu) * (u2nu - 9 / e21 / 4);
        const auto S12 =
        ...
        const tfel::math::st2tost2<3u, real> S = {
            S11,  S12,  S13,  zero, zero, zero, S12,  S11,  S13,
            zero, zero, zero, S31,  S31,  S33,  zero, zero, zero,
            zero, zero, zero, S44,  zero, zero, zero, zero, zero,
            zero, S55,  zero, zero, zero, zero, zero, zero, S55};
        if (e > 1) {
          using namespace tfel::math;
      ...
      namespace internals {
        /*!
         * This function takes a,b,c and returns the indices of the lengths
         * (a,b,c) sorted from the biggest to the smallest \return an object of
         * type std::array<int,3> \tparam LengthType: type of the lengths
      ...
      TFEL_HOST_DEVICE static tfel::math::st2tost2<3u, real>
      computeEshelbyTensor(const real& nu,
                           const LengthType& a,
                           const LengthType& b,
                           const LengthType& c,
                           const real precf,
      ...
      computeSphereLocalisationTensor(const StressType& young,
        ...
        using namespace tfel::math;
        return 3 * ka * st2tost2<3u, real>::J() +
               2 * mu * st2tost2<3u, real>::K();
