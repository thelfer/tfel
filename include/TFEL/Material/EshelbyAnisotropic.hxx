...
namespace tfel::material::homogenization::elasticity{
       ...
       * in an ANISOTROPIC matrix. The function returns the Hill tensor in the
       * basis (e1,e2) where e1 (resp. e2) is aligned with the axis with the
       * biggest (resp. the smallest) length \return an object of type
      ...
      TFEL_HOST_DEVICE static tfel::math::
          ...
          compute2DAnisotropicHillTensor(
              const tfel::math::st2tost2<2u, StressType>&, const real&);

      // TODO 2D
      /*!
       * This function builds the Eshelby tensor of a general 2d ellipse
       * embedded in an ANISOTROPIC matrix. The function returns the Eshelby
       * tensor in the basis (e1,e2) where e1 (resp. e2) is aligned with the
       * axis with the biggest (resp. the smallest) length \return an object of
       * type st2tost2<2u,real> \tparam real: underlying type \tparam
       * StressType: type of the elastic constants \param[in] C: stiffness
       * tensor of the matrix \param[in] e: aspect ratio
       */
      template <typename real, typename StressType>
