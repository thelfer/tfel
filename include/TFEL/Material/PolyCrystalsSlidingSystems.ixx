...
namespace tfel
{
  ...
  namespace material
  {
    ...
    PolyCrystalsSlidingSystems<Np,GS,NumType>::getPolyCrystalsSlidingSystems(const std::string& f){
    ...
    template<unsigned short Np,
	     typename GS,
	     typename NumType>
    PolyCrystalsSlidingSystems<Np,GS,NumType>::PolyCrystalsSlidingSystems(const std::string& f)
      : mus(Np)
    {
      using namespace std;
