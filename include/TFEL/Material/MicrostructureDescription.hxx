...
namespace tfel::material::homogenization::elasticity {
  ...
  requires(tfel::math::checkUnitCompatibility<
    ...
    [[nodiscard]] virtual tfel::math::st2tost2<N, compliance> computeDerivativesOfMeanLocalisator(
    ...
    [[nodiscard]] tfel::math::st2tost2<3u, compliance> computeDerivativesOfMeanLocalisator(
