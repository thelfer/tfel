  ...
  namespace material{
    ...
    namespace internals{
      ...
      typename std::enable_if<tfel::math::StensorTraits<StressStensor>::dime==1u,
			      void>::type
      computeHosfordStressSecondDerivative(tfel::material::HosfordStressSecondDerivativeType<StressStensor>& d2Psi_ds2,
	...
	{cste*( (drvp2_am2[0]+drvp2_am2[1])/2-dPsi_dsvp[0]*dPsi_dsvp[0]), // s1s1
	 ...
	 cste*(-(drvp2_am2[2])/2-dPsi_dsvp[1]*dPsi_dsvp[2])}; // s2s3
      ...
      internals::computeHosfordStressSecondDerivative<StressStensor>(d2Psi_ds2,dPsi_dsvp,d2Psi_dsvp2,
