...
namespace tfel {
  ...
  namespace material {
    ...
    namespace internals {
       ...
       * stress \param[in] dPsi_dvp: first derivative of the Hosford equivalent
       * stress with respect to the eigenvalue \param[in] d2Psi_dvp2: second
       * derivative of the Hosford equivalent stress with respect to the
    ...
    computeHosfordStressNormal(const StressStensor& s,
      ...
      return std::make_tuple(Psi,
                             tfel::math::eval(dPsi_ds[0] * std::get<0>(n) +
