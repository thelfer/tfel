  ...
  namespace utilities {
    ...
    namespace internals {
      ...
      struct GenTypeBaseApply {
       ...
       private:
        struct EndRecursion {
          TFEL_NORETURN static return_type apply(const GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static return_type apply(T&, const GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static return_type apply(GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static return_type apply(T&, GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
        };  // end of struct EndRecursion

        struct EndRecursionII {
          TFEL_NORETURN static void apply(const GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static void apply(T&, const GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static void apply(GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          TFEL_NORETURN static void apply(T&, GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
       ...
       public:
        ...
        static return_type apply(const GenTypeBase<List>& v) {
          typedef
              typename tfel::meta::TLFindNthElt<List, N>::type current_value;
      ...
      struct GenTypeBaseApplyII {
       ...
       private:
        ...
        struct EndRecursionII {
          static void apply(const GenTypeBase<List>&,
                            const GenTypeBase<List>&) {
            throw(GenTypeCastError());
          }
          static void apply(T&,
       ...
       public:
        ...
        static return_type apply(const GenTypeBase<List>& v1,
          ...
          typedef
              typename tfel::meta::TLFindNthElt<List, N>::type current_value1;
          typedef
              typename tfel::meta::TLFindNthElt<List, M>::type current_value2;
    ...
    template <typename T, typename List>
    typename T::return_type apply(GenTypeBase<List>& v1,
                                  GenTypeBase<List>& v2) {
      return internals::GenTypeBaseApplyII<T, List>::apply(v1, v2);
    }
