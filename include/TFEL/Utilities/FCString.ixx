...
namespace tfel{
  ...
  namespace utilities{
    ...
    basic_fcstring<N,CharT,Traits>::basic_fcstring(const std::basic_string<CharT,Traits,Alloc>& src){
      this->operator=(src);
    ...
    template<std::size_t N,typename CharT,typename Traits>
    basic_fcstring<N,CharT,Traits>::basic_fcstring(const CharT* src, const bool b){
      if(!b){
	this->operator=(src);
      } else {
    ...
    template<std::size_t N,typename CharT,typename Traits>
    basic_fcstring<N,CharT,Traits>::basic_fcstring(const basic_fcstring&) = default;
    ...
    template<std::size_t N,typename CharT,typename Traits>
    basic_fcstring<N,CharT,Traits>&
    basic_fcstring<N,CharT,Traits>::operator=(const basic_fcstring&) = default;

    template<std::size_t N,typename CharT,typename Traits>
    template<typename Alloc>
    basic_fcstring<N,CharT,Traits>&
    basic_fcstring<N,CharT,Traits>::operator = (const std::basic_string<CharT,Traits,Alloc>& rhs)
    {
      const auto s = rhs.size();
      if(s>N){
	throw(std::length_error("basic_fcstring::operator = "
				"rhs too long"));
      }
    ...
    template<std::size_t N,typename CharT,typename Traits>
    const CharT& basic_fcstring<N,CharT,Traits>::operator[](const std::size_t i) const{
      return this->at(i);
    } // end of basic_fcstring<N,CharT,Traits>::operator[]
