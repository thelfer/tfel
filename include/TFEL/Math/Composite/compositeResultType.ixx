/*!
 * \file   include/TFEL/Math/Composite/compositeResultType.ixx
...
namespace tfel{
  ...
  namespace math{
	...
	typedef tfel::meta::InvalidType type;
      ...
      class CompositeComputeResultList<tfel::meta::TLE,
					tfel::meta::TLE,
					Op>
      {
      public:
	...
	>::type type;
      ...
      class ScalarCompositeComputeResultList<S,tfel::meta::TLE,Op>
      {
      public:
	typedef tfel::meta::TLE type;
      };
	...
	typedef tfel::meta::TLNode<Result,Next> type;
      ...
      template<typename S,typename Op>
      class CompositeScalarComputeResultList<tfel::meta::TLE,S,Op>
      {
      public:
	typedef tfel::meta::TLE type;
      };
	...
	typedef tfel::meta::TLNode<Result,Next> type;
      ...
      template<typename Op>
      class CompositeComputeUnaryResultList<tfel::meta::TLE,Op>
      {
      public:
	typedef tfel::meta::TLE type;
      };
