/*!
 * \file   include/TFEL/Math/Vector/ConstTVectorView.hxx
 * \brief  TVectorFromConstTVectorView
 *
...
#ifndef LIB_TFEL_MATH_CONSTTVECTORVIEW_HXX
#define LIB_TFEL_MATH_CONSTTVECTORVIEW_HXX
...
namespace tfel::math {
   ...
   */
  template <unsigned short N, typename T>
  struct Expr<tvector<N, T>, ConstTVectorViewExpr<N, T>>
      : public VectorConcept<Expr<tvector<N, T>, ConstTVectorViewExpr<N, T>>> {
    ...
    Expr(const T* const v_) noexcept : v(v_) {}  // end of TvectorExpr
  ...
  using ConstTVectorView = Expr<tvector<N, T>, ConstTVectorViewExpr<N, T>>;

}  // end of namespace tfel::math

#endif /* LIB_TFEL_MATH_CONSTTVECTORVIEW_HXX */
