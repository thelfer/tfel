...
#ifndef LIB_TFEL_MATH_TINYVECTOROFTVECTORFROMTINYVECTORVIEW_HXX
#define LIB_TFEL_MATH_TINYVECTOROFTVECTORFROMTINYVECTORVIEW_HXX 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    {
      typedef Expr<tvector<Nn,tvector<N,T> >,TinyVectorOfTinyVectorFromTinyVectorViewExpr<N,Mn,In,Nn,T> > type;
...
#endif /* LIB_TFEL_MATH_TINYVECTOROFTVECTORFROMTINYVECTORVIEW_HXX */
