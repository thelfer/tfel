...
#ifndef LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW2_HXX_
#define LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW2_HXX_
...
namespace tfel {
  ...
  namespace math {
    ...
    struct TvectorExpr<tvector<N, T>,
                       TVectorFromTinyMatrixRowView2Expr<N, Mn, Mm, In, Im, T>>
...
#endif /* LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW2_HXX_ */
