/*!
 * \file   TVectorFromTinyMatrixRowView.hxx
 * \brief  
...
#ifndef _LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW_HXX_
#define _LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    template<unsigned short N, unsigned short Mn,
	     unsigned short Mm,unsigned short In,
	     unsigned short Im,typename T>
    struct TvectorExpr<tvector<N,T>,TVectorFromTinyMatrixRowViewExpr<N,Mn,Mm,In,Im,T> >
      : public TvectorConcept<TvectorExpr<tvector<N,T>,TVectorFromTinyMatrixRowViewExpr<N,Mn,Mm,In,Im,T> > >,
	public tvector_base<TvectorExpr<tvector<N,T>,TVectorFromTinyMatrixRowViewExpr<N,Mn,Mm,In,Im,T> >,N,T >
    {
    ...
    {
      typedef TvectorExpr<tvector<N,T>,TVectorFromTinyMatrixRowViewExpr<N,Mn,Mm,In,Im,T> > type;
...
#endif /* _LIB_TFEL_MATH_TVECTORFROMTINYMATRIXROWVIEW_HXX */
