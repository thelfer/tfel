/*!
 * \file   include/TFEL/Math/Forward/st2tot2.hxx
 * \brief
...
#ifndef LIB_TFEL_MATH_FORWARD_ST2TOT2_HXX
#define LIB_TFEL_MATH_FORWARD_ST2TOT2_HXX
...
namespace tfel::math {
  ...
  /*
   * \class st2tot2
   * \brief linear operator which turns a symmetric tensor to an unsymmetric
   * tensor.
