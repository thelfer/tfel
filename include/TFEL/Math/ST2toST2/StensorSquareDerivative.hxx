...
namespace tfel{
  ...
  namespace math{
    ...
    struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<1u> >
      : public ST2toST2Concept<ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<1u> > >,
	...
	this->v[6] = this->v[7] = zero;
      ...
      ST2toST2Expr(const StensorType& s,
    ...
    }; // end of struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<1u> >

    /*!
     * Partial specialisation for 2D tensor
     */
    template<typename ST2toST2ResultType>
    struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<2u> >
      : public ST2toST2Concept<ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<2u> > >,
    ...
    }; // end of struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<2u> >

    /*!
     * Partial specialisation for 3D tensor
     */
    template<typename ST2toST2ResultType>
    struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<3u> >
      : public ST2toST2Concept<ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<3u> > >,
	...
	this->v[18] = (cste*C(4,0)*s(5)+cste*C(5,0)*s(4)+(2*C(1,0)+2*C(0,0))*s(3)+2*C(3,0)*s(1)+2*C(3,0)*s(0))*one_half;
	this->v[19] = (cste*C(4,1)*s(5)+cste*C(5,1)*s(4)+(2*C(1,1)+2*C(0,1))*s(3)+2*C(3,1)*s(1)+2*C(3,1)*s(0))*one_half;
	this->v[20] = (cste*C(4,2)*s(5)+cste*C(5,2)*s(4)+(2*C(1,2)+2*C(0,2))*s(3)+2*C(3,2)*s(1)+2*C(3,2)*s(0))*one_half;
	this->v[21] = (cste*C(4,3)*s(5)+cste*C(5,3)*s(4)+(2*C(1,3)+2*C(0,3))*s(3)+2*C(3,3)*s(1)+2*C(3,3)*s(0))*one_half;
	this->v[22] = (cste*C(4,4)*s(5)+cste*C(5,4)*s(4)+(2*C(1,4)+2*C(0,4))*s(3)+2*C(3,4)*s(1)+2*C(3,4)*s(0))*one_half;
	this->v[23] = (cste*C(4,5)*s(5)+cste*C(5,5)*s(4)+(2*C(1,5)+2*C(0,5))*s(3)+2*C(3,5)*s(1)+2*C(3,5)*s(0))*one_half;
	this->v[24] = (cste*C(3,0)*s(5)+(2*C(2,0)+2*C(0,0))*s(4)+cste*C(5,0)*s(3)+2*C(4,0)*s(2)+2*C(4,0)*s(0))*one_half;
	this->v[25] = (cste*C(3,1)*s(5)+(2*C(2,1)+2*C(0,1))*s(4)+cste*C(5,1)*s(3)+2*C(4,1)*s(2)+2*C(4,1)*s(0))*one_half;
	this->v[26] = (cste*C(3,2)*s(5)+(2*C(2,2)+2*C(0,2))*s(4)+cste*C(5,2)*s(3)+2*C(4,2)*s(2)+2*C(4,2)*s(0))*one_half;
	this->v[27] = (cste*C(3,3)*s(5)+(2*C(2,3)+2*C(0,3))*s(4)+cste*C(5,3)*s(3)+2*C(4,3)*s(2)+2*C(4,3)*s(0))*one_half;
	this->v[28] = (cste*C(3,4)*s(5)+(2*C(2,4)+2*C(0,4))*s(4)+cste*C(5,4)*s(3)+2*C(4,4)*s(2)+2*C(4,4)*s(0))*one_half;
	this->v[29] = (cste*C(3,5)*s(5)+(2*C(2,5)+2*C(0,5))*s(4)+cste*C(5,5)*s(3)+2*C(4,5)*s(2)+2*C(4,5)*s(0))*one_half;
	this->v[30] = ((2*C(2,0)+2*C(1,0))*s(5)+cste*C(3,0)*s(4)+cste*C(4,0)*s(3)+2*C(5,0)*s(2)+2*C(5,0)*s(1))*one_half;
	this->v[31] = ((2*C(2,1)+2*C(1,1))*s(5)+cste*C(3,1)*s(4)+cste*C(4,1)*s(3)+2*C(5,1)*s(2)+2*C(5,1)*s(1))*one_half;
	this->v[32] = ((2*C(2,2)+2*C(1,2))*s(5)+cste*C(3,2)*s(4)+cste*C(4,2)*s(3)+2*C(5,2)*s(2)+2*C(5,2)*s(1))*one_half;
	this->v[33] = ((2*C(2,3)+2*C(1,3))*s(5)+cste*C(3,3)*s(4)+cste*C(4,3)*s(3)+2*C(5,3)*s(2)+2*C(5,3)*s(1))*one_half;
	this->v[34] = ((2*C(2,4)+2*C(1,4))*s(5)+cste*C(3,4)*s(4)+cste*C(4,4)*s(3)+2*C(5,4)*s(2)+2*C(5,4)*s(1))*one_half;
	this->v[35] = ((2*C(2,5)+2*C(1,5))*s(5)+cste*C(3,5)*s(4)+cste*C(4,5)*s(3)+2*C(5,5)*s(2)+2*C(5,5)*s(1))*one_half;
      }
      /*!
       * \brief access operator
       * \param[in] i : line   index
    ...
    }; // end of struct ST2toST2Expr<ST2toST2ResultType,StensorSquareDerivativeExpr<3u> >
