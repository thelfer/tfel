...
namespace tfel::math {
  ...
  typename std::enable_if<((getSpaceDimension<ST2toST2Type>() == 1u) &&
   ...
   */
  template <typename ST2toST2Type, typename StensorType>
  typename std::enable_if<((getSpaceDimension<ST2toST2Type>() == 2u) &&
   ...
   */
  template <typename ST2toST2Type, typename StensorType>
  typename std::enable_if<((getSpaceDimension<ST2toST2Type>() == 3u) &&
