...
#ifndef _LIB_TFEL_MATH_ST2TOST2_BUILDFROMROTATIONMATRIX_HXX_
#define _LIB_TFEL_MATH_ST2TOST2_BUILDFROMROTATIONMATRIX_HXX_
...
namespace tfel{
  ...
  namespace math{
	 ...
	 */
	template<typename T>
	static TFEL_MATH_INLINE2 tfel::math::st2tost2<1u,T>
	...
	exe(const tfel::math::tmatrix<3,3,T>& r){
	  ...
	  // tmp[1]  = cste*r(0,1)*r(1,1)*s[3]+r(1,1)*r(1,1)*s[1]+r(0,1)*r(0,1)*s[0];
	  s(1,0) = r(0,1)*r(0,1);
	  s(1,1) = r(1,1)*r(1,1);
	  s(1,2) = zero;
...
#endif /* _LIB_TFEL_MATH_ST2TOST2_BUILDFROMROTATIONMATRIX_HXX_ */
