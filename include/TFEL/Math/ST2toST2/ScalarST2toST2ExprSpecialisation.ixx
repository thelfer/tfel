/*!
 * \file   ScalarST2toST2ExprSpecialisation.ixx
...
#ifndef _LIB_TFEL_SCALARST2TOST2EXPRSPECIALISATION_I_
#define _LIB_TFEL_SCALARST2TOST2EXPRSPECIALISATION_I_ 
...
namespace tfel{
  ...
  namespace math {
    ...
    class ScalarST2toST2Expr<A,B,OpMult>
    {
	...
	return string("ScalarST2toST2Expr<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpMult>::getName()+string(">");
      }
	...
	: a(l), b(r)
      ...
      TFEL_MATH_INLINE ScalarST2toST2Expr(const ScalarST2toST2Expr<A,B,OpMult>& src)
	: a(src.a), b(src.b)
      {}
     ...
     */
    template<typename A, typename B>
    class ST2toST2ScalarExpr<A,B,OpMult>
    {
	...
	using namespace std;
	using namespace tfel::utilities;
	return string("ST2toST2ScalarExpr<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpMult>::getName()+string(">");
      }
     ...
     */
    template<typename A, typename B>
    class ST2toST2ScalarExpr<A,B,OpDiv>
    {
...
#endif /* _LIB_TFEL_SCALARST2TOST2EXPRSPECIALISATION_I_ */
