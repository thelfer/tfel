...
#ifndef LIB_TFEL_MATH_ST2TOST2_CHANGEBASIS_HXX_
#define LIB_TFEL_MATH_ST2TOST2_CHANGEBASIS_HXX_
    ...
    namespace st2tost2_internals {
      ...
      struct ChangeBasis<1u> {
        ...
        static TFEL_MATH_INLINE2 typename std::enable_if<
            ...
            tfel::math::st2tost2<1u,
                                 typename tfel::math::ST2toST2Traits<
                                     ST2toST2Type>::NumType>>::type
            ...
            const tfel::math::tmatrix<3,
                                      ...
                                      typename tfel::typetraits::BaseType<
                                          typename tfel::math::ST2toST2Traits<
                                              ST2toST2Type>::NumType>::type>&
                r) {
          using st2tost2 = tfel::math::st2tost2<
              2u, typename tfel::math::ST2toST2Traits<ST2toST2Type>::NumType>;
      ...
      struct ChangeBasis<3u> {
        ...
        exe(const ST2toST2Type& s,
            const tfel::math::tmatrix<3,
                ...
                r) {
          using st2tost2 = tfel::math::st2tost2<
              3u, typename tfel::math::ST2toST2Traits<ST2toST2Type>::NumType>;
          const auto sr = st2tost2::fromRotationMatrix(r);
          const auto sir = st2tost2::fromRotationMatrix(transpose(r));
          return sr * s * sir;
...
#endif /* LIB_TFEL_MATH_ST2TOST2_CHANGEBASIS_HXX_ */
