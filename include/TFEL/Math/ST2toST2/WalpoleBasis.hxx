...
namespace tfel::math {
  ...
  struct TransverseIsotropicWalpoleBasis {
    TFEL_HOST_DEVICE static stensor<3u, real> p(const tvector<3u, real>& n) {
      const stensor<3u, real> p_ = {n(0) * n(0), n(1) * n(1), n(2) * n(2),
    ...
    TFEL_HOST_DEVICE static st2tost2<3u, real> dyadic_ov(
      ...
      const st2tost2<3u, real> a_b = {a(0) * b(0),
                                      a(3) * b(3),
                                      a(4) * b(4),
                                      sqrt(2) / 2 * (a(0) * b(3) + a(3) * b(0)),
                                      sqrt(2) / 2 * (a(0) * b(4) + a(4) * b(0)),
                                      sqrt(2) / 2 * (a(3) * b(4) + a(4) * b(3)),
                                      a(3) * b(3),
                                      a(1) * b(1),
                                      a(5) * b(5),
                                      sqrt(2) / 2 * (a(1) * b(3) + a(3) * b(1)),
                                      sqrt(2) / 2 * (a(3) * b(5) + a(5) * b(3)),
                                      sqrt(2) / 2 * (a(1) * b(5) + a(5) * b(1)),
                                      a(4) * b(4),
                                      a(5) * b(5),
                                      a(2) * b(2),
                                      sqrt(2) / 2 * (a(4) * b(5) + a(5) * b(4)),
                                      sqrt(2) / 2 * (a(2) * b(4) + a(4) * b(2)),
                                      sqrt(2) / 2 * (a(2) * b(5) + a(5) * b(2)),
