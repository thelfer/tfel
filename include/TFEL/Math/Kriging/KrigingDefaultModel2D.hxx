...
namespace tfel
{
  ...
  namespace math
  {
    ...
    template<typename T,
	     typename NM>
    struct KrigingDefaultModel<2u,T,NM>
      : public NM
    {
    ...
    KrigingDefaultModel<2u,T,NM>::drifts[3u] = {KrigingDefaultModel<2u,T,NM>::one,
						KrigingDefaultModel<2u,T,NM>::x,
						KrigingDefaultModel<2u,T,NM>::y};
