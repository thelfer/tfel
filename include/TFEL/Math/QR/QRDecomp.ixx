...
#ifndef _LIB_TFEL_MATH_QRDECOMP_IXX_
#define _LIB_TFEL_MATH_QRDECOMP_IXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    template<typename VectorType,
	     typename MatrixType>
    void
    QRDecomp::householder_product(VectorType& v,
				  const MatrixType& a,
    ...
    template<typename VectorType,
	     typename MatrixType>
    void
    QRDecomp::tq_product(VectorType& v,
			 const MatrixType& a,
			 const VectorType& beta)
    {
      typedef typename MatrixTraits<MatrixType>::IndexType integer;
    ...
    QRDecomp::enorm(const MatrixType& m,
		    const typename MatrixTraits<MatrixType>::IndexType c,
...
#endif /* _LIB_TFEL_MATH_QRDECOMP_IXX */
