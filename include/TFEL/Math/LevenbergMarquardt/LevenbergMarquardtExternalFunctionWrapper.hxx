/*! 
 * \file  include/TFEL/Math/LevenbergMarquardt/LevenbergMarquardtExternalFunctionWrapper.hxx
 * \brief
...
#ifndef LIB_LEVENBERGMARQUARDTEXTERNALFUNCTIONWRAPPER_H_
#define LIB_LEVENBERGMARQUARDTEXTERNALFUNCTIONWRAPPER_H_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct TFELMATHPARSER_VISIBILITY_EXPORT LevenbergMarquardtExternalFunctionWrapper
    {
      ...
      LevenbergMarquardtExternalFunctionWrapper(std::shared_ptr<tfel::math::parser::ExternalFunction>,
						const size_type,
						const size_type);
...
#endif /* LIB_LEVENBERGMARQUARDTEXTERNALFUNCTIONWRAPPER_H_ */
