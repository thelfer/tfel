...
#ifndef _LIB_TFEL_MATH_EXPRESSIONTEMPLATES_STANDARDOPERATIONS_H_
#define _LIB_TFEL_MATH_EXPRESSIONTEMPLATES_STANDARDOPERATIONS_H_ 
  ...
  namespace math{
    ...
    operator + (T1&& a,T2&& b)
      -> typename std::enable_if<isBinaryOperationResultTypeValid<decltype(a),decltype(b),OpPlus>::value&&
				    ...
				    (tfel::typetraits::IsScalar<typename std::decay<T2>::type>::cond))),
...
#endif /* _LIB_TFEL_MATH_EXPRESSIONTEMPLATES_STANDARDOPERATIONS_H */
