...
namespace tfel {
  ...
  namespace math {
    ...
    namespace parser {
      ...
      template <typename Op>
      bool LogicalOperation<Op>::getValue(void) const {
      ...
      std::shared_ptr<LogicalExpr> LogicalOperation<Op>::resolveDependencies(
        ...
        return std::shared_ptr<LogicalExpr>(new LogicalOperation<Op>(
      ...
      std::shared_ptr<LogicalExpr> LogicalOperation<Op>::clone(
        ...
        return std::shared_ptr<LogicalExpr>(
            new LogicalOperation<Op>(this->a->clone(v), this->b->clone(v)));
      ...
      template <typename Op>
      bool LogicalBinaryOperation<Op>::getValue(void) const {
        return Op::apply(this->a->getValue(), this->b->getValue());
