...
#ifndef LIB_TFEL_MATH_EVALUATORFUNCTION_HXX
#define LIB_TFEL_MATH_EVALUATORFUNCTION_HXX
  ...
  namespace math {
    ...
    namespace parser {
      ...
      struct EvaluatorFunction1VBase : public EvaluatorFunctionBase {
       ...
       protected:
        EvaluatorFunction1VBase& operator=(const EvaluatorFunction1VBase&) =
            delete;
      ...
      struct EvaluatorFunction2VBase : public EvaluatorFunctionBase {
       ...
       protected:
        EvaluatorFunction2VBase& operator=(const EvaluatorFunction2VBase&) =
            delete;
      ...
      struct TFEL_VISIBILITY_LOCAL EvaluatorFunction1UPNV final
       ...
       protected:
        EvaluatorFunction1UPNV& operator=(const EvaluatorFunction1UPNV&) =
            delete;
      ...
      struct TFEL_VISIBILITY_LOCAL EvaluatorFunction2UPNV final
       ...
       protected:
        EvaluatorFunction2UPNV& operator=(const EvaluatorFunction2UPNV&) =
            delete;
...
#endif /* LIB_TFEL_MATH_EVALUATORFUNCTION_HXX */
