...
#ifndef TFEL_LIB_MATH_PARSER_DIFFERENTIATEDFUNCTIONEXPR_HXX
#define TFEL_LIB_MATH_PARSER_DIFFERENTIATEDFUNCTIONEXPR_HXX
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    namespace parser
    {
      ...
      struct DifferentiatedFunctionExpr final
	: public Expr
      {
...
#endif /* TFEL_LIB_MATH_PARSER_DIFFERENTIATEDFUNCTIONEXPR_HXX */
