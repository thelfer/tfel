  ...
  namespace math {
    ...
    namespace parser {
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction1P1VGenerator(
        ...
        nbr = Evaluator::convertToInt("EvaluatorFunction1P1VGenerator",
                                      params[0]);
        return std::shared_ptr<Expr>(
            new EvaluatorFunction1P1V(f, nbr, args[0]));
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction2P1VGenerator(
        ...
        Evaluator::checkVariableNumber(1, args.size());
        nbr = Evaluator::convertToInt("EvaluatorFunction2P1VGenerator",
                                      params[0]);
        nbr2 = Evaluator::convertToInt("EvaluatorFunction2P1VGenerator",
                                       params[1]);
        return std::shared_ptr<Expr>(
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction1P2VGenerator(
        ...
        nbr = Evaluator::convertToInt("EvaluatorFunction1P2VGenerator",
                                      params[0]);
        return std::shared_ptr<Expr>(
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction2P2VGenerator(
        ...
        Evaluator::checkParameterNumber(2, params.size());
        Evaluator::checkVariableNumber(2, args.size());
        nbr = Evaluator::convertToInt("EvaluatorFunction2P2VGenerator",
                                      params[0]);
        nbr2 = Evaluator::convertToInt("EvaluatorFunction2P2VGenerator",
                                       params[1]);
        return std::shared_ptr<Expr>(
      ...
      typedef double (*EvaluatorFunctionWrapper2_type2P)(int,
                                                         int,
                                                         double,
                                                         double);
      ...
      typedef double (*EvaluatorFunctionWrapper8_type2P)(int,
                                                         int,
                                                         double,
                                                         double,
                                                         double,
      ...
      typedef double (*EvaluatorFunctionWrapper9_type)(double,
                                                       double,
                                                       double,
                                                       double,
                                                       double,
      ...
      template <unsigned short N>
      double EvaluatorFunctionNV<N>::getValue(void) const {
      ...
      EvaluatorFunctionNV<N>::createFunctionByChangingParametersIntoVariables(
        ...
        vector<shared_ptr<Expr>>::size_type i;
        for (p = this->args.begin(), i = 0; p != this->args.end(); ++p, ++i) {
          nargs[i] = (*p)->createFunctionByChangingParametersIntoVariables(
              v, params, pos);
        }
        return shared_ptr<Expr>(new EvaluatorFunctionNV<N>(this->f, nargs));
      }  // end of
      ...
      template <unsigned short N>
      double EvaluatorFunction1PNV<N>::getValue(void) const {
      ...
      template <unsigned short N>
      double EvaluatorFunction2PNV<N>::getValue(void) const {
      ...
      template <unsigned short N>
      double EvaluatorFunction1UPNV<N>::getValue(void) const {
        return EvaluatorFunctionWrapper<N>::apply(this->f, this->n, this->args);
      ...
      template <unsigned short N>
      std::shared_ptr<Expr> EvaluatorFunction1UPNV<N>::
      ...
      template <unsigned short N>
      double EvaluatorFunction2UPNV<N>::getValue(void) const {
        return EvaluatorFunctionWrapper<N>::apply(this->f, this->n, this->m,
                                                  this->args);
      ...
      template <unsigned short N>
      std::shared_ptr<Expr> EvaluatorFunction2UPNV<N>::
          createFunctionByChangingParametersIntoVariables(
              const std::vector<double>& v,
              const std::vector<std::string>& params,
              const std::map<std::string, std::vector<double>::size_type>& pos)
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction1PNVGenerator(
        ...
        Evaluator::checkParameterNumber(1, params.size());
        Evaluator::checkVariableNumber(N, args.size());
        nbr = Evaluator::convertToInt("EvaluatorFunction1PNVGenerator",
                                      params[0]);
        return std::shared_ptr<Expr>(
            new EvaluatorFunction1PNV<N>(f, nbr, args));
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction2PNVGenerator(
        ...
        Evaluator::checkParameterNumber(2, params.size());
        Evaluator::checkVariableNumber(N, args.size());
        nbr = Evaluator::convertToInt("EvaluatorFunction2PNVGenerator",
                                      params[0]);
        nbr2 = Evaluator::convertToInt("EvaluatorFunction2PNVGenerator",
                                       params[1]);
        return std::shared_ptr<Expr>(
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction1UPNVGenerator(
        ...
        nbr = Evaluator::convertToUnsignedInt("EvaluatorFunction1UPNVGenerator",
                                              params[0]);
        return std::shared_ptr<Expr>(
            new EvaluatorFunction1UPNV<N>(f, nbr, args));
      ...
      std::shared_ptr<tfel::math::parser::Expr> EvaluatorFunction2UPNVGenerator(
        ...
        nbr = Evaluator::convertToUnsignedInt("EvaluatorFunction2UPNVGenerator",
                                              params[0]);
        nbr2 = Evaluator::convertToUnsignedInt(
            "EvaluatorFunction2UPNVGenerator", params[1]);
        return std::shared_ptr<Expr>(
