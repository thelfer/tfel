...
namespace tfel{
  ...
  namespace typetraits{
     ...
     */     
    template<typename unit,typename T>
    struct IsSafelyReinterpretCastableTo<tfel::math::qt<unit,T>,tfel::math::qt<tfel::math::NoUnit,T> >
    {
      /*!		                      
       *  Check if qt<unit,T> and T have the same size	                      
       */		                      
      TFEL_STATIC_ASSERT(sizeof(tfel::math::qt<unit,T>)==sizeof(tfel::math::qt<tfel::math::NoUnit,T>));
      /*!		                      
       *  Result	                      
       */		                      
      static constexpr bool cond = true;
     ...
     */     
    template<typename unit,typename T>
    struct IsSafelyReinterpretCastableTo<tfel::math::qt<tfel::math::NoUnit,T>,tfel::math::qt<unit,T> >
    {
      /*!		                      
       *  Check if qt<unit,T> and T have the same size	                      
       */		                      
     ...
     */     
    template<typename T>
    struct IsSafelyReinterpretCastableTo<tfel::math::qt<tfel::math::NoUnit,T>,tfel::math::qt<tfel::math::NoUnit,T> >
    {
      /*!		                      
       *  Result	                      
       */		                      
