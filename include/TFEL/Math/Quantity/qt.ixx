...
namespace tfel {
  ...
  namespace math {
    ...
    T& qt<unit, T>::getValue(void) noexcept {
      return this->value;
    }

    template <typename unit, typename T>
    constexpr const T& qt<unit, T>::getValue(void) const noexcept {
      return value;
    }
    ...
    template <typename T>
    T& qt<NoUnit, T>::getValue(void) noexcept {
      return value;
    }

    template <typename T>
    constexpr const T& qt<NoUnit, T>::getValue(void) const noexcept {
      return value;
    }
