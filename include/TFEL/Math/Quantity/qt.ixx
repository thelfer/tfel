...
namespace tfel::math {
  ...
  namespace stdfunctions {
    ...
    TFEL_MATH_INLINE tfel::math::qt<typename PowUnit_<N, 1u, Unit>::type, float>
    ...
    TFEL_MATH_INLINE
      ...
      typedef
          typename tfel::math::PowerImplSelector<N, 1u>::type Implementation;
      typedef tfel::math::qt<typename PowUnit_<N, 1u, Unit>::type, long double>
          Res;
      return Res(Implementation::exe(x.getValue()));
    }
    ...
    TFEL_MATH_INLINE tfel::math::qt<typename PowUnit_<N, D, Unit>::type, float>
    power(const tfel::math::qt<Unit, float> x) {
    ...
    template <int N, unsigned int D, typename Unit>
    TFEL_MATH_INLINE tfel::math::qt<typename PowUnit_<N, D, Unit>::type, double>
    power(const tfel::math::qt<Unit, double> x) {
      typedef typename tfel::math::PowerImplSelector<N, D>::type Implementation;
