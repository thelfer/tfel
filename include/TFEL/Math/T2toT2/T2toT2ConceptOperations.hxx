...
namespace tfel
{
  ...
  namespace math
  {
    ...
    // 	       typename T2,
    // 	       typename Result>
    //   struct T2toT2byT2toT2Multiplication
    //   {
    ...
    // 	  }
    // 	} // end of exe
    //   }; // end of struct T2toT2byT2toT2Multiplication

    //   template<unsigned short N,
    // 	       typename T1,
    // 	       typename T2,
    // 	       typename Result>
    //   struct T2toT2byStensorMultiplication
    //   {}; // end of struct T2toT2byStensorMultiplication

    //   template<typename T1,
    // 	       typename T2,
    // 	       typename Res>
    //   struct T2toT2byStensorMultiplication<1u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    ...
    // 	       typename T2,
    // 	       typename Res>
    //   struct T2toT2byStensorMultiplication<2u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    // 	exe(const T1& a,const T2& b,Res &r)
    // 	{
    ...
    // 	       typename T2,
    // 	       typename Res>
    //   struct T2toT2byStensorMultiplication<3u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    // 	exe(const T1& a,const T2& b,Res &r)
    // 	{
    ...
    // 	       typename T2,
    // 	       typename Result>
    //   struct StensorbyT2toT2Multiplication
    //   {}; // end of struct StensorbyT2toT2Multiplication

    //   template<typename T1,
    // 	       typename T2,
    // 	       typename Res>
    //   struct StensorbyT2toT2Multiplication<1u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    ...
    // 	       typename T2,
    // 	       typename Res>
    //   struct StensorbyT2toT2Multiplication<2u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    // 	exe(const T1& b,const T2& a,Res &r)
    // 	{
    ...
    // 	       typename T2,
    // 	       typename Res>
    //   struct StensorbyT2toT2Multiplication<3u,T1,T2,Res>
    //   {
    // 	static TFEL_MATH_INLINE void 
    // 	exe(const T1& b,const T2& a,Res &r)
    // 	{
    ...
    // /*
    //  * Partial Specialisation of ComputeBinaryResult_ for t2tot2-stensor operations
    //  */
    // template<typename A, typename B>
    // class ComputeBinaryResult_<T2toT2Tag,StensorTag,A,B,OpMult>
    // {
    //   struct DummyHandle{};
    //   typedef typename T2toT2Type<A>::type StensA;
    ...
    // /*
    //  * Partial Specialisation of ComputeBinaryResult_ for stensor-t2tot2 operations
    //  */
    // template<typename A, typename B>
    // class ComputeBinaryResult_<StensorTag,T2toT2Tag,A,B,OpMult>
    // {
    //   struct DummyHandle{};
    ...
    //   Res res;
    //   T2toT2byT2toT2Multiplication<T2toT2Traits<Res>::dime,T1,T2,Res>::exe(a,b,res);
    //   return  res;
    // }
    ...
    //   typedef typename ComputeBinaryResult<T1,T2,OpMult>::Result Res;
    //   Res res;
    //   T2toT2byStensorMultiplication<StensorTraits<Res>::dime,T1,T2,Res>::exe(a,b,res);
    //   return  res;
    // }
    ...
    //   typedef typename ComputeBinaryResult<T1,T2,OpMult>::Result Res;
    //   Res res;
    //   StensorbyT2toT2Multiplication<StensorTraits<Res>::dime,T1,T2,Res>::exe(a,b,res);
    //   return  res;
    // }
