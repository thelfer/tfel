...
namespace tfel::math {
  ...
  class ComputeBinaryOperationResult<T2toT2Tag, ScalarTag, t2tot2<N, T>, Scal, OpMult> {
   ...
   */
  template <unsigned short N, typename T, typename Scal>
  class ComputeBinaryOperationResult<T2toT2Tag, ScalarTag, t2tot2<N, T>, Scal, OpDiv> {
  ...
  class ComputeBinaryOperationResult<ScalarTag, T2toT2Tag, Scal, t2tot2<N, T>, OpMult> {
