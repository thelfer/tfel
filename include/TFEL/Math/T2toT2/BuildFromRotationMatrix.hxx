...
#ifndef _LIB_TFEL_MATH_T2TOT2_BUILDFROMROTATIONMATRIX_HXX_
#define _LIB_TFEL_MATH_T2TOT2_BUILDFROMROTATIONMATRIX_HXX_
...
namespace tfel{
  ...
  namespace math{
	 ...
	 */
	template<typename T>
	static TFEL_MATH_INLINE2 tfel::math::t2tot2<1u,T>
	exe(const tfel::math::tmatrix<3,3,T>&){
	 ...
	 */
	template<typename T>
	static TFEL_MATH_INLINE2 tfel::math::t2tot2<2u,T>
	 ...
	 */
	template<typename T>
	static TFEL_MATH_INLINE2 tfel::math::t2tot2<3u,T>
	exe(const tfel::math::tmatrix<3,3,T>& r){
	  const T a = r(0,0);
	  const T b = r(0,1);
	  const T c = r(0,2);
...
#endif /* _LIB_TFEL_MATH_T2TOT2_BUILDFROMROTATIONMATRIX_HXX_ */
