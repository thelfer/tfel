...
namespace tfel{
  ...
  namespace math{
	...
	typename std::enable_if<(tfel::meta::Implements<T2toT2Type,tfel::math::T2toT2Concept>::cond&&
				 tfel::math::T2toT2Traits<T2toT2Type>::dime==1u),
				tfel::math::t2tot2<1u,typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>
				>::type
	exe(const T2toT2Type& s,
	    const tfel::math::tmatrix<3,3,typename tfel::typetraits::BaseType<typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>::type>&){
	  return s;
	}
	...
	typename std::enable_if<(tfel::meta::Implements<T2toT2Type,tfel::math::T2toT2Concept>::cond&&
				...
				tfel::math::t2tot2<2u,typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>
				>::type
	exe(const T2toT2Type& s,
	    const tfel::math::tmatrix<3,3,typename tfel::typetraits::BaseType<typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>::type>& r)
	{
	  using t2tot2 = tfel::math::t2tot2<2u,typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>;
	...
	typename std::enable_if<(tfel::meta::Implements<T2toT2Type,tfel::math::T2toT2Concept>::cond&&
				...
				tfel::math::t2tot2<3u,typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>
				>::type
	exe(const T2toT2Type& s,
	    const tfel::math::tmatrix<3,3,typename tfel::typetraits::BaseType<typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>::type>& r)
	{
	  using t2tot2 = tfel::math::t2tot2<3u,typename tfel::math::T2toT2Traits<T2toT2Type>::NumType>;
	  const auto sr  = t2tot2::fromRotationMatrix(r);
	  const auto sir = t2tot2::fromRotationMatrix(transpose(r));
	  return sr*s*sir;
