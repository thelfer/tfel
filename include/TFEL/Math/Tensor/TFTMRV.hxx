...
#ifndef _LIB_TFEL_MATH_TFTMRV_HXX_
#define _LIB_TFEL_MATH_TFTMRV_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    template<unsigned short N,
	     ...
	     unsigned short Im,
	     typename T>
    struct TensorExpr<tensor<N,T>,TFTMRVExpr<N,Mn,Mm,In,Im,T> >
      : public TensorConcept<TensorExpr<tensor<N,T>,TFTMRVExpr<N,Mn,Mm,In,Im,T> > >
    {
    ...
    struct TFTMRV
    {
      typedef TensorExpr<tensor<N,T>,TFTMRVExpr<N,Mn,Mm,In,Im,T> > type;
    }; // end of struct TFTMRV
    ...
    operator << (std::ostream & os,
		 const TensorExpr<tensor<N,T>,TFTMRVExpr<N,Mn,Mm,In,Im,T> >& s)
    {
      os << "[ ";
...
#endif /* _LIB_TFEL_MATH_TFTMRV_HXX */
