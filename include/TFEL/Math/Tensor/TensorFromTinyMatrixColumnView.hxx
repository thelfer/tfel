...
#ifndef LIB_TFEL_MATH_TENSORFROMTINYMATRIXCOLUMNVIEW_HXX
#define LIB_TFEL_MATH_TENSORFROMTINYMATRIXCOLUMNVIEW_HXX
...
namespace tfel::math {
  ...
  struct Expr<tensor<N, T>,
    ...
    static_assert(Im < Mm);
    static_assert(TensorDimeToSize<N>::value <= Mn - In);
...
#endif /* LIB_TFEL_MATH_TENSORFROMTINYMATRIXCOLUMNVIEW_HXX */
