...
namespace tfel {
  ...
  namespace math {
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<1u, typename TensorTraits<typename std::decay<
                                 decltype(t)>::type>::NumType>,
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<2u, typename TensorTraits<typename std::decay<
                                 decltype(t)>::type>::NumType>,
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<3u, typename TensorTraits<typename std::decay<
                                 decltype(t)>::type>::NumType>,
