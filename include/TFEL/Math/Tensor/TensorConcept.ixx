  ...
  namespace math {
    ...
    namespace internals {
      ...
      struct TensorConceptMatrixAccessOperator<1u> {
        template <typename TensorType>
        TFEL_MATH_INLINE static typename TensorTraits<TensorType>::NumType exe(
            const TensorType& t,
    ...
    template <class T>
    typename TensorTraits<T>::NumType TensorConcept<T>::operator()(
    ...
    template <typename TensorType>
    auto matrix_view(TensorType&& t) -> typename std::enable_if<
      ...
      using NumType = typename TensorTraits<
          typename std::decay<decltype(t)>::type>::NumType;
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<1u, typename TensorTraits<typename std::decay<decltype(
                                 t)>::type>::NumType>,
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<2u, typename TensorTraits<typename std::decay<decltype(
                                 t)>::type>::NumType>,
    ...
    TFEL_MATH_INLINE auto transpose(TensorType&& t) -> typename std::enable_if<
      ...
      return Expr<tensor<3u, typename TensorTraits<typename std::decay<decltype(
                                 t)>::type>::NumType>,
