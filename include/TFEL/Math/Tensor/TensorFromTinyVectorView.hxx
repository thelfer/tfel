...
namespace tfel
{
  ...
  namespace math
  {
	...
	public tensor_base<TensorExpr<tensor<N,T>,TensorFromTinyVectorViewExpr<N,Mn,In,T> > >
    {
      ...
      typedef typename tensor<N,T,TensorStatic>::value_type      value_type;      
      typedef typename tensor<N,T,TensorStatic>::pointer	   pointer;	    
      typedef typename tensor<N,T,TensorStatic>::const_pointer   const_pointer; 
      typedef typename tensor<N,T,TensorStatic>::reference	   reference;	    
      typedef typename tensor<N,T,TensorStatic>::const_reference const_reference;
      typedef typename tensor<N,T,TensorStatic>::size_type 	   size_type;	    
      typedef typename tensor<N,T,TensorStatic>::difference_type difference_type;
