...
namespace tfel {
  ...
  namespace math {
    ...
    struct TFEL_VISIBILITY_LOCAL fsarray : protected array_container<N, T> {
       ...
       */
      TFEL_MATH_INLINE const_iterator end(void) const noexcept;
      /*!
       * return an const iterator after the last element of the vector
       * (provided for stl compatibility)
       * \return const_iterator, a const iterator after the last element
       */
      TFEL_MATH_INLINE const_iterator cend(void) const noexcept;
      /*!
       ...
       */
      TFEL_MATH_INLINE reverse_iterator rbegin(void) noexcept;
      /*!
       ...
       * element
       */
      TFEL_MATH_INLINE const_reverse_iterator rbegin(void) const noexcept;
      /*!
       ...
       */
      TFEL_MATH_INLINE reverse_iterator rend(void) noexcept;
      /*!
       ...
       * first element
       */
      TFEL_MATH_INLINE const_reverse_iterator rend(void) const noexcept;
      /*!
       * size of the finite size array
       * (compatibility with array)
       */
      constexpr TFEL_MATH_INLINE unsigned short size(void) const noexcept;
      /*!
       * access operator
       */
