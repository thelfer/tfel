...
#ifndef LIB_TFEL_MATH_RIGHTCAUCHYGREENTENSORDERIVATIVEEXPR_H_
#define LIB_TFEL_MATH_RIGHTCAUCHYGREENTENSORDERIVATIVEEXPR_H_ 
...
namespace tfel{
  ...
  namespace math{
    ...
    struct Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<1u> >
      : public T2toST2Concept<Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<1u> > >,
    ...
    }; // end of struct Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<1u> >
    ...
    struct Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<2u> >
      : public T2toST2Concept<Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<2u> > >,
    ...
    struct Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<3u> >
      : public T2toST2Concept<Expr<T2toST2Type,RightCauchyGreenTensorDerivativeExpr<3u> > >,
...
#endif /* LIB_TFEL_MATH_RIGHTCAUCHYGREENTENSORDERIVATIVEEXPR_H_ */
