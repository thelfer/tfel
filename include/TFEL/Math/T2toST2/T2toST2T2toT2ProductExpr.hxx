  ...
  namespace math {
    ...
    struct TFEL_VISIBILITY_LOCAL
        ...
        : public T2toST2Concept<
          ...
          public fsarray<
              StensorDimeToSize<T2toST2Traits<T2toST2ResultType>::dime>::value *
                  TensorDimeToSize<
                      T2toST2Traits<T2toST2ResultType>::dime>::value,
      ...
      TFEL_MATH_INLINE Expr(const T2toST2Type& a, const T2toT2Type2& b) {
        ...
        //! a simple check
        TFEL_STATIC_ASSERT(
            (tfel::meta::Implements<T2toT2Type2, T2toT2Concept>::cond));
        //! a simple check
    ...
    struct TFEL_VISIBILITY_LOCAL
      ...
      TFEL_MATH_INLINE Expr(const T2toST2Type& a, const T2toT2Type2& b) {
        ...
        this->v[10] = a(2, 0) * b(0, 0) + a(2, 1) * b(1, 0) +
                      a(2, 2) * b(2, 0) + a(2, 3) * b(3, 0) + a(2, 4) * b(4, 0);
        this->v[11] = a(2, 0) * b(0, 1) + a(2, 1) * b(1, 1) +
                      a(2, 2) * b(2, 1) + a(2, 3) * b(3, 1) + a(2, 4) * b(4, 1);
        this->v[12] = a(2, 0) * b(0, 2) + a(2, 1) * b(1, 2) +
                      a(2, 2) * b(2, 2) + a(2, 3) * b(3, 2) + a(2, 4) * b(4, 2);
        this->v[13] = a(2, 0) * b(0, 3) + a(2, 1) * b(1, 3) +
                      a(2, 2) * b(2, 3) + a(2, 3) * b(3, 3) + a(2, 4) * b(4, 3);
        this->v[14] = a(2, 0) * b(0, 4) + a(2, 1) * b(1, 4) +
                      a(2, 2) * b(2, 4) + a(2, 3) * b(3, 4) + a(2, 4) * b(4, 4);
        this->v[15] = a(3, 0) * b(0, 0) + a(3, 1) * b(1, 0) +
                      a(3, 2) * b(2, 0) + a(3, 3) * b(3, 0) + a(3, 4) * b(4, 0);
        this->v[16] = a(3, 0) * b(0, 1) + a(3, 1) * b(1, 1) +
                      a(3, 2) * b(2, 1) + a(3, 3) * b(3, 1) + a(3, 4) * b(4, 1);
        this->v[17] = a(3, 0) * b(0, 2) + a(3, 1) * b(1, 2) +
                      a(3, 2) * b(2, 2) + a(3, 3) * b(3, 2) + a(3, 4) * b(4, 2);
        this->v[18] = a(3, 0) * b(0, 3) + a(3, 1) * b(1, 3) +
                      a(3, 2) * b(2, 3) + a(3, 3) * b(3, 3) + a(3, 4) * b(4, 3);
        this->v[19] = a(3, 0) * b(0, 4) + a(3, 1) * b(1, 4) +
                      a(3, 2) * b(2, 4) + a(3, 3) * b(3, 4) + a(3, 4) * b(4, 4);
      }  // end of Expr
      /*!
       * \brief access operator
       * \param[in] i : line index
