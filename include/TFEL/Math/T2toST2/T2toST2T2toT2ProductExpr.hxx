/*! 
 * \file   include/TFEL/Math/T2toST2/T2toST2T2toT2ProductExpr.hxx
 * \brief
...
#ifndef LIB_TFEL_MATH_T2TOST2T2TOT2PRODUCTEXPR_HXX
#define LIB_TFEL_MATH_T2TOST2T2TOT2PRODUCTEXPR_HXX 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct TFEL_VISIBILITY_LOCAL Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<1u> >
      : public T2toST2Concept<Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<1u> > >,
		       ...
		       typename T2toST2Traits<T2toST2ResultType>::NumType>
{
  ...
  {
    //! a simple check
    TFEL_STATIC_ASSERT((tfel::meta::Implements<T2toST2Type,tfel::math::T2toST2Concept>::cond));
    //! a simple check
    TFEL_STATIC_ASSERT((tfel::meta::Implements<T2toT2Type2,T2toT2Concept>::cond));
    //! a simple check
   ...
   */
  template<typename T2toST2ResultType>
  struct TFEL_VISIBILITY_LOCAL Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<2u> >
    : public T2toST2Concept<Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<2u> > >,
      public fsarray<StensorDimeToSize<T2toST2Traits<T2toST2ResultType>::dime>::value*
		     TensorDimeToSize<T2toST2Traits<T2toST2ResultType>::dime>::value,
		     typename T2toST2Traits<T2toST2ResultType>::NumType>
{
 ...
 */
template<typename T2toST2ResultType>
struct TFEL_VISIBILITY_LOCAL Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<3u> >
  : public T2toST2Concept<Expr<T2toST2ResultType,T2toST2T2toT2ProductExpr<3u> > >,
    public fsarray<StensorDimeToSize<T2toST2Traits<T2toST2ResultType>::dime>::value*
		   TensorDimeToSize<T2toST2Traits<T2toST2ResultType>::dime>::value,
		   typename T2toST2Traits<T2toST2ResultType>::NumType>
{
...
#endif /* LIB_TFEL_MATH_T2TOST2T2TOT2PRODUCTEXPR_HXX */
