...
#ifndef LIB_TFEL_MATH_CONSTT2TOST2VIEW_HXX_
#define LIB_TFEL_MATH_CONSTT2TOST2VIEW_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct Expr<t2tost2<N,T>,ConstT2toST2ViewExpr<N,T> >
      : public T2toST2Concept<Expr<t2tost2<N,T>,ConstT2toST2ViewExpr<N,T> > >,
	...
	return RunTimeProperties();
       ...
       */
      explicit Expr(const T * const v_) noexcept
	: v(v_)
      {} // end of Expr
...
#endif /* LIB_TFEL_MATH_CONSTT2TOST2VIEW_HXX_ */
