/*! 
 * \file  StensorT2toST2ProductExpr.hxx
 * \brief
 * \author Helfer Thomas
 * \brief 05 juin 2014
 */

#ifndef _LIB_TFEL_MATH_STENSORT2TOST2PRODUCTEXPR_H_
#define _LIB_TFEL_MATH_STENSORT2TOST2PRODUCTEXPR_H_ 
...
namespace tfel
{
  ...
  namespace math
  {
	...
	this->v[0]=b(3,0)*a[3]+b(2,0)*a[2]+b(1,0)*a[1]+b(0,0)*a[0];
	this->v[1]=b(3,1)*a[3]+b(2,1)*a[2]+b(1,1)*a[1]+b(0,1)*a[0];
	...
	this->v[0]=b(5,0)*a[5]+b(4,0)*a[4]+b(3,0)*a[3]+b(2,0)*a[2]+b(1,0)*a[1]+b(0,0)*a[0];
	this->v[1]=b(5,1)*a[5]+b(4,1)*a[4]+b(3,1)*a[3]+b(2,1)*a[2]+b(1,1)*a[1]+b(0,1)*a[0];
	this->v[2]=b(5,2)*a[5]+b(4,2)*a[4]+b(3,2)*a[3]+b(2,2)*a[2]+b(1,2)*a[1]+b(0,2)*a[0];
	this->v[3]=b(5,3)*a[5]+b(4,3)*a[4]+b(3,3)*a[3]+b(2,3)*a[2]+b(1,3)*a[1]+b(0,3)*a[0];
	this->v[4]=b(5,4)*a[5]+b(4,4)*a[4]+b(3,4)*a[3]+b(2,4)*a[2]+b(1,4)*a[1]+b(0,4)*a[0];
	this->v[5]=b(5,5)*a[5]+b(4,5)*a[4]+b(3,5)*a[3]+b(2,5)*a[2]+b(1,5)*a[1]+b(0,5)*a[0];
...
#endif /* _LIB_TFEL_MATH_STENSORT2TOST2PRODUCTEXPR_H */
