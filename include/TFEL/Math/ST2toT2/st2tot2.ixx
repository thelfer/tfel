...
#ifndef LIB_TFEL_MATH_ST2TOT2IXX
#define LIB_TFEL_MATH_ST2TOT2IXX 
...
namespace tfel{
  ...
  namespace math {
    ...
    template<unsigned short N,typename T>
    st2tot2<N,T>&
    st2tot2<N,T>::operator=(const st2tot2<N,T>& src){
      fsarray<TensorDimeToSize<N>::value*StensorDimeToSize<N>::value,T>::operator=(src);
      return *this;
    }
...
#endif /* LIB_TFEL_MATH_ST2TOT2IXX */
