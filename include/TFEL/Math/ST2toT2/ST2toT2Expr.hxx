/*!
 * \file   include/TFEL/Math/ST2toT2/ST2toT2Expr.hxx  
 * \brief    
...
namespace tfel{
  ...
  namespace math{
    ...
    template<typename T_type, typename Expr>
    struct ST2toT2Traits<ST2toT2Expr<T_type,Expr> >{
      typedef typename ST2toT2Traits<T_type>::NumType   NumType;
      typedef unsigned short IndexType;
      static const unsigned short dime = ST2toT2Traits<T_type>::dime;
    };

    template<typename T_type, typename Expr>
    struct ST2toT2Expr
      : public ST2toT2Concept<ST2toT2Expr<T_type,Expr> >,
	public Expr
    {
      ...
      explicit TFEL_MATH_INLINE ST2toT2Expr()
	: Expr()
      {}

      explicit TFEL_MATH_INLINE ST2toT2Expr(const typename Expr::first_arg& a_)
	: Expr(a_)
      {}
    ...
    template<typename T_type, typename Expr>
    struct ST2toT2Type<ST2toT2Expr<T_type,Expr> >
    {
      typedef T_type type;
    };
  ...
  namespace typetraits{
    ...
    template<typename T_type, typename Expr>
    struct IsTemporary<tfel::math::ST2toT2Expr<T_type,Expr> >
    {
...
#endif /* _LIB_TFEL_MATH_ST2TOT2_EXPR_LIB_ */
