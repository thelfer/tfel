...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct Expr<StensorResultType,TensorST2toT2ProductExpr<1u> >
      : public StensorConcept<Expr<StensorResultType,TensorST2toT2ProductExpr<1u> > >,
    ...
    struct Expr<StensorResultType,TensorST2toT2ProductExpr<2u> >
      : public StensorConcept<Expr<StensorResultType,TensorST2toT2ProductExpr<2u> > >,
	public fsarray<StensorDimeToSize<StensorTraits<StensorResultType>::dime>::value,
		       typename StensorTraits<StensorResultType>::NumType>
    {
      //! a simple alias
    ...
    struct Expr<StensorResultType,TensorST2toT2ProductExpr<3u> >
      : public StensorConcept<Expr<StensorResultType,TensorST2toT2ProductExpr<3u> > >,
	public fsarray<StensorDimeToSize<StensorTraits<StensorResultType>::dime>::value,
		       typename StensorTraits<StensorResultType>::NumType>
    {
      //! a simple alias
