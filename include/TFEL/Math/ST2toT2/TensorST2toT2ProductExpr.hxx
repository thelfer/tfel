/*! 
 * \file  TensorST2toT2ProductExpr.hxx
 * \brief
 * \author Helfer Thomas
 * \brief 05 juin 2014
 */

#ifndef _LIB_TFEL_MATH_TENSORST2TOT2PRODUCTEXPR_H_
#define _LIB_TFEL_MATH_TENSORST2TOT2PRODUCTEXPR_H_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct StensorExpr<StensorResultType,TensorST2toT2ProductExpr<1u> >
      : public StensorConcept<StensorExpr<StensorResultType,TensorST2toT2ProductExpr<1u> > >,
		       ...
		       typename StensorTraits<StensorResultType>::NumType>
    {
      ...
      template<typename TensorType,
	       typename ST2toT2Type>
      TFEL_MATH_INLINE
      StensorExpr(const TensorType&  a,
		  const ST2toT2Type& b)
      {
	//! a simple check
    ...
    }; // end of struct StensorExpr<StensorResultType,T2STensorST2toT2ProductExp>

    /*!
     * Partial specialisation
     */
    template<typename StensorResultType>
    struct StensorExpr<StensorResultType,TensorST2toT2ProductExpr<2u> >
      : public StensorConcept<StensorExpr<StensorResultType,TensorST2toT2ProductExpr<2u> > >,
	public fsarray<StensorDimeToSize<StensorTraits<StensorResultType>::dime>::value,
		       typename StensorTraits<StensorResultType>::NumType>
    {
      //! a simple alias
     ...
     */
    template<typename StensorResultType>
    struct StensorExpr<StensorResultType,TensorST2toT2ProductExpr<3u> >
      : public StensorConcept<StensorExpr<StensorResultType,TensorST2toT2ProductExpr<3u> > >,
	public fsarray<StensorDimeToSize<StensorTraits<StensorResultType>::dime>::value,
		       typename StensorTraits<StensorResultType>::NumType>
    {
      //! a simple alias
...
#endif /* _LIB_TFEL_MATH_TENSORST2TOT2PRODUCTEXPR_H */
