...
namespace tfel{
  ...
  namespace math{
    ...
    struct ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<1u> >
      : public ST2toT2Concept<ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<1u> > >,
	public fsarray<9u,typename ST2toT2Traits<ST2toT2ResultType>::NumType>
    {
      ...
      ST2toT2Expr(const StensorType& a)
      {
	//! a simple check
    ...
    }; // end of struct ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<1u> >

    /*!
     * Partial specialisation for 2D stensor
     */
    template<typename ST2toT2ResultType>
    struct ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<2u> >
      : public ST2toT2Concept<ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<2u> > >,
     ...
     */
    template<typename ST2toT2ResultType>
    struct ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<3u> >
      : public ST2toT2Concept<ST2toT2Expr<ST2toT2ResultType,StensorProductRightDerivativeExpr<3u> > >,
	...
	this->v[3u] =(C(4,3)*a(4)+C(3,3)*a(3))*one_half+C(0,3)*a(0);
	this->v[4u] =(C(4,4)*a(4)+C(3,4)*a(3))*one_half+C(0,4)*a(0);
	this->v[5u] =(C(4,5)*a(4)+C(3,5)*a(3))*one_half+C(0,5)*a(0);
	this->v[6u] =(C(5,0)*a(5)+C(3,0)*a(3))*one_half+C(1,0)*a(1);
	this->v[7u] =(C(5,1)*a(5)+C(3,1)*a(3))*one_half+C(1,1)*a(1);
	this->v[8u] =(C(5,2)*a(5)+C(3,2)*a(3))*one_half+C(1,2)*a(1);
	this->v[9u] =(C(5,3)*a(5)+C(3,3)*a(3))*one_half+C(1,3)*a(1);
	this->v[10u]=(C(5,4)*a(5)+C(3,4)*a(3))*one_half+C(1,4)*a(1);
	this->v[11u]=(C(5,5)*a(5)+C(3,5)*a(3))*one_half+C(1,5)*a(1);
	this->v[12u]=(C(5,0)*a(5)+C(4,0)*a(4))*one_half+C(2,0)*a(2);
	this->v[13u]=(C(5,1)*a(5)+C(4,1)*a(4))*one_half+C(2,1)*a(2);
	this->v[14u]=(C(5,2)*a(5)+C(4,2)*a(4))*one_half+C(2,2)*a(2);
