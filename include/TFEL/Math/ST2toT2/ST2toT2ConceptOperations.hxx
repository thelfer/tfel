...
namespace tfel::math {
  ...
  class ComputeBinaryOperationHandler<TensorTag, StensorTag, A, B, OpDiadicProduct> {
    struct DummyHandle {};
  ...
  /*
   * Partial Specialisation of ComputeBinaryOperationHandler for st2tot2-st2tost2
   * operations
   */
  template <typename A, typename B>
