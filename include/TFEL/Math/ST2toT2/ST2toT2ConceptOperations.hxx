...
#ifndef LIB_TFEL_ST2TOT2_CONCEPT_OPERATIONS_HXX_
#define LIB_TFEL_ST2TOT2_CONCEPT_OPERATIONS_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    public:
      ...
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,T2toT2ST2toT2ProductExpr<ST2toT2Traits<Result>::dime> > >::type Handle;
    };
    ...
    public:
      ...
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,ST2toT2T2toST2ProductExpr<T2toT2Traits<Result>::dime> > >::type Handle;
    };
    ...
    class ComputeBinaryResult_<ST2toT2Tag,ST2toST2Tag,A,B,OpMult>
    {
      struct DummyHandle{};
      typedef typename ST2toT2Type <typename std::decay<A>::type>::type ST2toT2A;
      typedef typename ST2toST2Type<typename std::decay<B>::type>::type ST2toST2B;
    public:
      typedef typename ResultType<ST2toT2A,ST2toST2B,OpMult>::type Result;
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,ST2toT2ST2toST2ProductExpr<ST2toT2Traits<Result>::dime> > >::type Handle;
    };
    ...
    public:
      ...
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,T2toST2ST2toT2ProductExpr<ST2toST2Traits<Result>::dime> > >::type Handle;
    };
    ...
    public:
      ...
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,ST2toT2StensorProductExpr<TensorTraits<Result>::dime> > >::type Handle;
    };
    ...
    public:
      ...
      typedef typename std::conditional<tfel::typetraits::IsInvalid<Result>::cond,
					DummyHandle,
					Expr<Result,TensorST2toT2ProductExpr<StensorTraits<Result>::dime> > >::type Handle;
    };
...
#endif /* LIB_TFEL_ST2TOT2_CONCEPT_OPERATIONS_HXX_ */
