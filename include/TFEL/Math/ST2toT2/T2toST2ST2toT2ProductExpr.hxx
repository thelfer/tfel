...
#ifndef LIB_TFEL_MATH_T2TOST2ST2TOT2PRODUCTEXPR_H_
#define LIB_TFEL_MATH_T2TOST2ST2TOT2PRODUCTEXPR_H_
  ...
  namespace math {
    ...
    struct TFEL_VISIBILITY_LOCAL
      ...
      TFEL_MATH_INLINE Expr(const T2toST2Type& a, const ST2toT2Type2& b) {
        ...
        //! a simple check
        TFEL_STATIC_ASSERT(
            (tfel::meta::Implements<ST2toT2Type2, ST2toT2Concept>::cond));
        //! a simple check
...
#endif /* LIB_TFEL_MATH_T2TOST2ST2TOT2PRODUCTEXPR_H_ */
