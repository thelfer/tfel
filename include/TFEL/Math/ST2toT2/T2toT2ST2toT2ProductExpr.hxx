  ...
  namespace math {
    ...
    struct TFEL_VISIBILITY_LOCAL
      ...
      TFEL_MATH_INLINE Expr(const T2toT2Type& a, const ST2toT2Type2& b) {
        ...
        //! a simple check
        TFEL_STATIC_ASSERT(
            (tfel::meta::Implements<ST2toT2Type2,
    ...
    struct TFEL_VISIBILITY_LOCAL
      ...
      TFEL_MATH_INLINE Expr(const T2toT2Type& a, const ST2toT2Type2& b) {
        ...
        this->v[16] = a(4, 0) * b(0, 0) + a(4, 1) * b(1, 0) +
                      a(4, 2) * b(2, 0) + a(4, 3) * b(3, 0) + a(4, 4) * b(4, 0);
        this->v[17] = a(4, 0) * b(0, 1) + a(4, 1) * b(1, 1) +
                      a(4, 2) * b(2, 1) + a(4, 3) * b(3, 1) + a(4, 4) * b(4, 1);
        this->v[18] = a(4, 0) * b(0, 2) + a(4, 1) * b(1, 2) +
                      a(4, 2) * b(2, 2) + a(4, 3) * b(3, 2) + a(4, 4) * b(4, 2);
        this->v[19] = a(4, 0) * b(0, 3) + a(4, 1) * b(1, 3) +
                      a(4, 2) * b(2, 3) + a(4, 3) * b(3, 3) + a(4, 4) * b(4, 3);
      }  // end of Expr
      /*!
       * \brief access operator
       * \param[in] i : line index
