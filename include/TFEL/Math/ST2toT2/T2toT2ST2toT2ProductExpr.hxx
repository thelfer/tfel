/*!
 * \file   include/TFEL/Math/ST2toT2/T2toT2ST2toT2ProductExpr.hxx
 * \brief
...
#ifndef LIB_TFEL_MATH_T2TOT2ST2TOT2PRODUCTEXPR_HXX
#define LIB_TFEL_MATH_T2TOT2ST2TOT2PRODUCTEXPR_HXX
...
namespace tfel::math {
  ...
  struct TFEL_VISIBILITY_LOCAL
      Expr<ST2toT2ResultType, T2toT2ST2toT2ProductExpr<1u>>
    ...
    static_assert(ST2toT2Traits<ST2toT2ResultType>::dime == 1u);
    //! a simple alias
    ...
    TFEL_MATH_INLINE Expr(const T2toT2Type& a, const ST2toT2Type2& b) {
      static_assert(tfel::meta::Implements<T2toT2Type, T2toT2Concept>::cond);
      static_assert(tfel::meta::Implements<ST2toT2Type2,
                                           tfel::math::ST2toT2Concept>::cond);
      static_assert(T2toT2Traits<T2toT2Type>::dime == 1u);
      static_assert(ST2toT2Traits<ST2toT2Type2>::dime == 1u);
  ...
  template <typename ST2toT2ResultType>
  struct TFEL_VISIBILITY_LOCAL
      Expr<ST2toT2ResultType, T2toT2ST2toT2ProductExpr<2u>>
      : public ST2toT2Concept<
            Expr<ST2toT2ResultType, T2toT2ST2toT2ProductExpr<2u>>>,
        public fsarray<
            TensorDimeToSize<ST2toT2Traits<ST2toT2ResultType>::dime>::value *
                StensorDimeToSize<
                    ST2toT2Traits<ST2toT2ResultType>::dime>::value,
            typename ST2toT2Traits<ST2toT2ResultType>::NumType> {
    static_assert(ST2toT2Traits<ST2toT2ResultType>::dime == 2u);
    //! a simple alias
    typedef EmptyRunTimeProperties RunTimeProperties;
    //! a simple alias
    typedef typename ST2toT2Traits<ST2toT2ResultType>::NumType value_type;
    ...
    TFEL_MATH_INLINE Expr(const T2toT2Type& a, const ST2toT2Type2& b) {
      ...
      static_assert(tfel::meta::Implements<ST2toT2Type2,
                                           tfel::math::ST2toT2Concept>::cond);
      static_assert(T2toT2Traits<T2toT2Type>::dime == 2u);
      static_assert(ST2toT2Traits<ST2toT2Type2>::dime == 2u);
      this->v[0] = a(0, 0) * b(0, 0) + a(0, 1) * b(1, 0) + a(0, 2) * b(2, 0) +
  ...
  template <typename ST2toT2ResultType>
  struct TFEL_VISIBILITY_LOCAL
      Expr<ST2toT2ResultType, T2toT2ST2toT2ProductExpr<3u>>
      : public ST2toT2Concept<
            Expr<ST2toT2ResultType, T2toT2ST2toT2ProductExpr<3u>>>,
        public fsarray<
            TensorDimeToSize<ST2toT2Traits<ST2toT2ResultType>::dime>::value *
    ...
    typedef typename ST2toT2Traits<ST2toT2ResultType>::NumType value_type;
    //! a simple check
    static_assert((ST2toT2Traits<ST2toT2ResultType>::dime == 3u));
    /*!
     * \param[in] a : first term of the product
     * \param[in] b : second term of the product
     */
    ...
    TFEL_MATH_INLINE Expr(const T2toT2Type& a, const ST2toT2Type2& b) {
      ...
      static_assert(tfel::meta::Implements<ST2toT2Type2,
                                           tfel::math::ST2toT2Concept>::cond);
      static_assert(T2toT2Traits<T2toT2Type>::dime == 3u);
      static_assert(ST2toT2Traits<ST2toT2Type2>::dime == 3u);
      this->v[0] = a(0, 0) * b(0, 0) + a(0, 1) * b(1, 0) + a(0, 2) * b(2, 0) +
...
#endif /* LIB_TFEL_MATH_T2TOT2ST2TOT2PRODUCTEXPR_HXX */
