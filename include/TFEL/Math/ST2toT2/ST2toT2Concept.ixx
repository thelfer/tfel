...
#ifndef LIB_TFEL_MATH_ST2TOT2_CONCEPT_IMPL_
#define LIB_TFEL_MATH_ST2TOT2_CONCEPT_IMPL_ 1
...
namespace tfel {
  ...
  namespace math {
    ...
    template <class T>
    TFEL_MATH_INLINE typename ST2toT2Traits<T>::NumType ST2toT2Concept<T>::
...
#endif /* LIB_TFEL_MATH_ST2TOT2_CONCEPT_IMPL_ */
