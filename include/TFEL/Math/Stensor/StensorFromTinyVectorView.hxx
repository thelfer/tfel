...
#ifndef LIB_TFEL_MATH_STENSORFROMTINYVECTORVIEW_HXX
#define LIB_TFEL_MATH_STENSORFROMTINYVECTORVIEW_HXX
...
namespace tfel::math {
   ...
   * \param T  : value type
   */
  template <unsigned short N, unsigned short Mn, unsigned short In, typename T>
  ...
  struct Expr<stensor<N, T>, StensorFromTinyVectorViewExpr<N, Mn, In, T>>
    ...
    static_assert(In < Mn);
    static_assert(StensorDimeToSize<N>::value <= Mn - In);
...
#endif /* LIB_TFEL_MATH_STENSORFROMTINYVECTORVIEW_HXX */
