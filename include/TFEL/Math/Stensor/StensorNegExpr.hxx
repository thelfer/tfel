...
#ifndef _LIB_TFEL_STENSOR_NEG_EXPR_H_
#define _LIB_TFEL_STENSOR_NEG_EXPR_H_ 
...
namespace tfel{
  ...
  namespace math{
    ...
    protected:
      ...
      TFEL_MATH_INLINE StensorNegExpr(const A& l)
	: a(l)
      {}
...
#endif /* _LIB_TFEL_STENSOR_NEG_EXPR_H */
