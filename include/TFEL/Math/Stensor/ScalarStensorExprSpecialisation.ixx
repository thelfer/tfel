...
namespace tfel{
  ...
  namespace math {
	...
	return string("ScalarStensorExpr<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpMult>::getName()+string(">");
      }
	...
	using namespace std;
	using namespace tfel::utilities;
	return string("StensorScalarExpr<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpMult>::getName()+string(">");
      }
