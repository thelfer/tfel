    ...
    namespace internals {
      ...
      struct StensorComputeEigenVectors_<1u> {
        ...
        static bool computeEigenVector(VectorType& v,
          ...
          TFEL_STATIC_ASSERT(tfel::typetraits::IsFundamentalNumericType<
                             typename VectorTraits<VectorType>::NumType>::cond);
          TFEL_STATIC_ASSERT(
              (std::is_same<typename VectorTraits<VectorType>::NumType,
                            T>::value));
          TFEL_STATIC_ASSERT(
      ...
      struct StensorComputeEigenVectors_<2u> {
        ...
        static bool exe(const T* const s,
          ...
          StensorComputeEigenVectors_<2u>::computeEigenValues(s[0], s[1], s[3],
                                                              vp(0), vp(1));
          prec =
          ...
          if (StensorComputeEigenVectors_<2u>::computeEigenVector(
          ...
          return tfel::math::internals::StensorComputeEigenVectors_<2u>::test(
              s, vp, vec);
#else
          return true;
      ...
      struct StensorComputeEigenVectors_<3u> {
        ...
        static bool test(const T* const s,
          ...
          T tmp;
          // first eigenvalue
          y0 = s[0] * m(0, 0) + s[3] * icste * m(1, 0) +
               s[4] * icste * m(2, 0) - vp(0) * m(0, 0);
          y1 = s[1] * m(1, 0) + s[3] * icste * m(0, 0) +
               s[5] * icste * m(2, 0) - vp(0) * m(1, 0);
          y2 = s[2] * m(2, 0) + s[4] * icste * m(0, 0) +
        ...
        static bool exe(const T* const s,
          ...
          if (bsmall) {
            ...
            vec = tmatrix<3u, 3u, T>::Id();
#ifdef TFEL_PARANOIC_CHECK
            return tfel::math::internals::StensorComputeEigenVectors_<3>::test(
                s, vp, vec);
#else
            return true;
#endif /* LIB_TFEL_STENSORCOMPUTEEIGENVECTORS_H_ */
