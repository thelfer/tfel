...
#ifndef _LIB_TFEL_MATH_STENSOR_DECOMPOSITIONINPOSITIVEANDNEGATIVEPARTS_H_
#define _LIB_TFEL_MATH_STENSOR_DECOMPOSITIONINPOSITIVEANDNEGATIVEPARTS_H_ 
...
namespace tfel{
  ...
  namespace math{
     ...
     * \tparam DPPType     : type in which derivative of the positive part is stored
     * \tparam PPType      : type of positive part of the symmetric tensor
     * \tparam StensorType : type of the symmetric tensor
     * \param[out] dpp     : derivative of the positive part of the symmetric tensor
     * \param[out] pp      : positive part of the symmetric tensor
     * \param[in]  s       : symmetric tensor
     * \param[in]  eps     : numerical precision used to decipher if two eigenvalues are equal
     * \pre DPPType must implement the ST2toST2Concept
     ...
     * \tparam DPPType     : type in which derivative of the positive part is stored
     * \tparam DNPType     : type in which derivative of the negative part is stored
     * \tparam PPType      : type of positive part of the symmetric tensor
     * \tparam NPType      : type of negative part of the symmetric tensor
     * \tparam StensorType : type of the symmetric tensor
     * \param[out] dpp     : derivative of the positive part of the symmetric tensor
     * \param[out] dnp     : derivative of the negative part of the symmetric tensor
     * \param[out] pp      : positive part of the symmetric tensor
     * \param[out] np      : positive part of the symmetric tensor
     * \param[in]  s       : symmetric tensor
     * \param[in]  eps     : numerical precision used to decipher if two eigenvalues are equal
     * \pre DPPType must implement the ST2toST2Concept
    ...
    typename std::enable_if<
      ...
      void>::type
    computeStensorDecompositionInPositiveAndNegativeParts(DPPType&,
							  DNPType&,
							  PPType&,
							  NPType&,
							  const StensorType&,
...
#endif /* _LIB_TFEL_MATH_STENSOR_DECOMPOSITIONINPOSITIVEANDNEGATIVEPARTS_H_ */
