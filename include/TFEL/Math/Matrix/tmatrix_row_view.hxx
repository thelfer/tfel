...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct tmatrix_row_view
      : public VectorExpr<tvector<M,T>, tmatrix_row_view_expr<N,M,I,T> >,
	public tvector_base<tmatrix_row_view<N,M,I,T>,M,T>
    {
      /*!
       * constructor
       * \param[in] m_ : the underlying matrix
      ...
      using tvector_base<tmatrix_row_view,M,T>::operator=;
      //! using tvector_base::operator+=
      using tvector_base<tmatrix_row_view,M,T>::operator+=;
      //! using tvector_base::operator-=
      using tvector_base<tmatrix_row_view,M,T>::operator-=;
