...
#ifndef LIB_TFEL_MATH_CONSTTMATRIXVIEW_HXX_
#define LIB_TFEL_MATH_CONSTTMATRIXVIEW_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct Expr<tmatrix<N,M,T>,ConstTMatrixViewExpr<N,M,T> >
      : public MatrixConcept<Expr<tmatrix<N,M,T>,ConstTMatrixViewExpr<N,M,T> > >
    {
    ...
    using ConstTMatrixView = Expr<tmatrix<N,M,T>,ConstTMatrixViewExpr<N,M,T>>;

  } // end of namespace math

} // end of namespace tfel

#endif /* LIB_TFEL_MATH_CONSTTMATRIXVIEW_HXX_ */
