...
#ifndef LIB_TFEL_MATH_TMATRIX_CONST_SUBMATRIX_VIEW_HXX
#define LIB_TFEL_MATH_TMATRIX_CONST_SUBMATRIX_VIEW_HXX
...
namespace tfel::typetraits {
  ...
  struct IsAssignableTo<
      tfel::math::tmatrix_const_submatrix_view_expr<N, M, I, J, R, C, T>,
      tfel::math::tmatrix<R, C, T2>> {
    //! \brief result
...
#endif /* LIB_TFEL_MATH_TMATRIX_CONST_SUBMATRIX_VIEW_HXX */
