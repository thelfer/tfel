...
#ifndef LIB_TFEL_MATH_TMATRIXVIEW_HXX_
#define LIB_TFEL_MATH_TMATRIXVIEW_HXX_ 
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    struct Expr<tmatrix<N,M,T>,TMatrixViewExpr<N,M,T> >
      : public MatrixConcept<Expr<tmatrix<N,M,T>,TMatrixViewExpr<N,M,T> > >,
	public tmatrix_base<Expr<tmatrix<N,M,T>,TMatrixViewExpr<N,M,T> >,N,M,T>
    {
...
#endif /* LIB_TFEL_MATH_TMATRIXVIEW_HXX_ */
