...
#ifndef LIB_TFEL_OBJECTOBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H_
#define LIB_TFEL_OBJECTOBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H_
  ...
  namespace math {
    ...
    class ObjectObjectRandomAccessConstIterator<A, B, OpPlus> {
     ...
     public:
      ...
      TFEL_MATH_INLINE value_type operator*(void)const { return (*pA) + (*pB); }
...
#endif /* LIB_TFEL_OBJECTOBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H_ */
