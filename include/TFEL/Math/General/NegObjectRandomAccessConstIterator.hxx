...
#ifndef LIB_TFEL_NEGOBJECTRANDOMACCESSCONSTITERATOR_H_
#define LIB_TFEL_NEGOBJECTRANDOMACCESSCONSTITERATOR_H_
  ...
  namespace math {
    ...
    class NegObjectRandomAccessConstIterator {
     ...
     public:
      ...
      TFEL_MATH_INLINE value_type operator*(void) const { return -(*p); }

      TFEL_MATH_INLINE NegObjectRandomAccessConstIterator& operator++(void) {
        p++;
        return *this;
      }
...
#endif /* LIB_TFEL_NEGOBJECTRANDOMACCESSCONSTITERATOR_H_ */
