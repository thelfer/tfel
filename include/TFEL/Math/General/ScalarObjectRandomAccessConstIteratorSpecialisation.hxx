 ...
 * Helfer \date   17 Oct 2006 \copyright Copyright (C) 2006-2018 CEA/DEN, EDF
...
#ifndef LIB_TFEL_MATH_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_HXX
#define LIB_TFEL_MATH_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_HXX
...
namespace tfel::math {
  ...
  class ScalarObjectRandomAccessConstIterator<A, B, OpMult> {
   ...
   public:
    ...
    TFEL_MATH_INLINE
    Distance operator-(const ScalarObjectRandomAccessConstIterator& src) const {
      return p - src.p;
    }
...
#endif /* LIB_TFEL_MATH_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_HXX */
