...
#ifndef LIB_TFEL_MATH_OBJECTOBJECTRANDOMACCESSCONSTITERATOR_HXX
#define LIB_TFEL_MATH_OBJECTOBJECTRANDOMACCESSCONSTITERATOR_HXX
...
namespace tfel::math {
  ...
  class ObjectObjectRandomAccessConstIterator {
    ...
    typedef
        typename std::iterator_traits<ConstIteratorTypeA>::value_type NumTypeA;
    typedef
        typename std::iterator_traits<ConstIteratorTypeB>::value_type NumTypeB;
...
#endif /* LIB_TFEL_MATH_OBJECTOBJECTRANDOMACCESSCONSTITERATOR_HXX */
