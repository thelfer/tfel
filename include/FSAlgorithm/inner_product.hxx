...
#ifndef _LIB_TFEL_INNER_PRODUCT_HXX_
#define _LIB_TFEL_INNER_PRODUCT_HXX_ 
...
namespace tfel{
  ...
  namespace fsalgo{
    ...
    /*!
     * \class inner_product 
     * \brief inner_product calculates a generalized inner product of the ranges [first1,first1+N) and [first2,first2+N)
    ...
    {
      /*! 
       * The first version of inner_product returns init plus the inner product of the two ranges [1]. That is, it first initializes the result to init and then computes:
...
#endif /* _LIB_TFEL_INNER_PRODUCT_HXX */
