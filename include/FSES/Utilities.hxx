...
namespace fses{
  ...
  //! a simple alias
  template<typename VectorType>
  using GetVectorNumericType_t = typename GetVectorNumericType<VectorType>::type;
  /*!
   * \brief get values of a vector
   */
  template<typename VectorType,typename IndexType>
  inline GetVectorNumericType_t<VectorType>&
  at(VectorType&,const IndexType&);
  /*!
   * \brief get values of a vector
   */
  template<typename VectorType,typename IndexType>
  inline const GetVectorNumericType_t<VectorType>&
  at(const VectorType&,const IndexType&);
  /*!
   * \brief a metafunction returning the numerical type used by a
   * matrix
   */
  ...
  //! a simple alias
  template<typename MatrixType>
  using GetMatrixNumericType_t = typename GetMatrixNumericType<MatrixType>::type;
  /*!
   * \brief get values of a matrix
   */
  template<typename MatrixType,typename IndexType>
  inline GetMatrixNumericType_t<MatrixType>&
  at(MatrixType&,const IndexType&,const IndexType&);
  /*!
   * \brief get values of a matrix
   */
  template<typename MatrixType,typename IndexType>
  inline const GetMatrixNumericType_t<MatrixType>&
  at(const MatrixType&,const IndexType&,const IndexType&);
  /*!
