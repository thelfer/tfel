...
namespace fses{
  ...
  struct VectorAccess<std::array<T,N>>
  {
    ...
    static T&
    exe(std::array<T,N>& v,const IndexType& i)
    {
      return v[i];
    }  
    template<typename IndexType>
    static const T&
    exe(const std::array<T,N>& v,const IndexType& i)
    {
      return v[i];
    }  
  };
  ...
  struct MatrixAccess<std::array<std::array<T,M>,N>>
  {
    template<typename IndexType>
    static T&
    exe(std::array<std::array<T,M>,N>& v,const IndexType& i,const IndexType& j)
    {
      return v[i][j];
    }  
    template<typename IndexType>
    static const T&
    exe(const std::array<std::array<T,M>,N>& v,const IndexType& i,const IndexType& j)
    {
      return v[i][j];
    }  
  };
