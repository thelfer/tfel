...
#ifndef _LIB_TFEL_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H_
#define _LIB_TFEL_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H_ 
...
namespace tfel{
  ...
  namespace math{
	...
	return string("ScalarObjectRandomAccessConstIterator<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpDiv>::getName()+string(">");        
      ...
      TFEL_MATH_INLINE ScalarObjectRandomAccessConstIterator(const A a_,const ConstIteratorType p_)
	: a(a_), p(p_)
      {}

      TFEL_MATH_INLINE ScalarObjectRandomAccessConstIterator(const ScalarObjectRandomAccessConstIterator& src)
	: a(src.a), p(src.p)
      {}
      
      TFEL_MATH_INLINE ScalarObjectRandomAccessConstIterator& operator=(const ScalarObjectRandomAccessConstIterator& src)
      {
	// self assignement does not have to be checked.
	a = src.a;
	p = src.p;
	...
	return string("ObjectScalarRandomAccessConstIterator<")+Name<A>::getName()+string(",")+Name<B>::getName()+string(",")+Name<OpMult>::getName()+string(">");        
      ...
      TFEL_MATH_INLINE ObjectScalarRandomAccessConstIterator(const ConstIteratorType p_,const B b_)
	: b(b_), p(p_)
      {}

      TFEL_MATH_INLINE ObjectScalarRandomAccessConstIterator(const ObjectScalarRandomAccessConstIterator& src)
	: b(src.b), p(src.p)
      {}
...
#endif /* _LIB_TFEL_SCALAROBJECTRANDOMACCESSCONSTITERATORSPECIALISATION_H */
