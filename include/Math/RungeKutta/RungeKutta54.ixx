...
#ifndef _LIB_TFEL_RUNGEKUTTA54_IXX_
#define _LIB_TFEL_RUNGEKUTTA54_IXX_ 
...
namespace tfel
{
  namespace math
  {
    ...
    void
    RungeKutta54<N,C,S>::setInitialValue(const typename RungeKutta54<N,C,S>::VariableType& y_)
    {
      this->y = y_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta54<N,C,S>::setInitialTime(const S ti_)
    {
      this->ti = ti_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta54<N,C,S>::setFinalTime(const S tf_)
    {
      this->tf = tf_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta54<N,C,S>::setInitialTimeIncrement(const S dt_)
    {
      this->dt = dt_;
    ...
    template<unsigned short N,typename C,typename S>
    void
    RungeKutta54<N,C,S>::setCriterium(const S e_)
    {
      this->epsilon = e_;
    } // end of RungeKutta54<N,C,S>::setInitialTimeIncrement
    ...
    RungeKutta54<N,C,S>::getValue(void) const
    {
      return this->y;
    ...
    template<unsigned short N,typename C,typename S>
    const S&
    RungeKutta54<N,C,S>::getTimeIncrement(void) const
    {
      return this->dt;
	...
	y_  = this->y+cste1932_2197*k1-cste7200_2197*k2+cste7296_2197*k3;
	k4  = this->dt*(static_cast<const Child*>(this)->computeF(t_,y_));
	t_  = t+this->dt;
	y_  = this->y+cste439_216*k1-8*k2+ cste3680_513*k3-cste845_4104*k4;
	k5  = this->dt*(static_cast<const Child*>(this)->computeF(t_,y_));
	t_  = t+0.5*(this->dt);
	y_  = this->y-cste8_27*k1+2*k2-cste3544_2565*k3+cste1859_4104*k4-cste11_40*k5;
	k6  = this->dt*(static_cast<const Child*>(this)->computeF(t_,y_));
	// error
	ve = cste1_360*k1-cste128_4275*k3-cste2197_75240*k4+cste1_50*k5+cste2_55*k6;
	// error norm
	e  = tfel::fsalgo::accumulate<N>::exe(ve.begin(),Scalar(0),AbsoluteSommation());
	assert(e>=0.);
	...
	if(e<this->epsilon){
	  this->y += cste16_135*k1+cste6656_12825*k3+cste28561_56430*k4-cste9_50*k5+cste2_55*k6;
	  t += this->dt;
	}
	// time multiplier
...
#endif /* _LIB_TFEL_RUNGEKUTTA54_IXX */
