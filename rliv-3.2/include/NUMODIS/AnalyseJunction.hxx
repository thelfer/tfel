...
namespace numodis
{
  ...
  namespace Dupuy2017
  {
    TFELNUMODIS_VISIBILITY_EXPORT void
    precomputeJunctionParameters(const Crystallo* pcrystallo,
    ...
    computeHeuristicHardeningCoefficient(const Crystallo* pcrystallo,
					 double nu,
    ...
    TFELNUMODIS_VISIBILITY_EXPORT double
    computeHeuristicNonColinearHardeningCoefficient(double nu,
						    double sij);
