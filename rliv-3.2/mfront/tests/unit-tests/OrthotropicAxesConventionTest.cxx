  ...
  : public tfel::tests::TestCase
{
  ...
  {
    this->check("@ModellingHypothesis Axisymmetrical;"
		"@OrthotropicBehaviour<Plate>;");
    this->check("@ModellingHypothesis AxisymmetricalGeneralisedPlaneStress;"
		"@OrthotropicBehaviour<Plate>;");
    this->check("@ModellingHypothesis AxisymmetricalGeneralisedPlaneStrain;"
		"@OrthotropicBehaviour<Plate>;");
    this->check("@OrthotropicBehaviour<Plate>;"
		"@ModellingHypothesis AxisymmetricalGeneralisedPlaneStrain;");
    this->check("@ModellingHypotheses {Axisymmetrical,PlaneStrain};"
		"@OrthotropicBehaviour<Plate>;");
    return this->result;
  } // end of execute()
 private:
