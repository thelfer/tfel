/*! 
 * \file  mfront/src/LSDYNAStressFreeExpansionHandler.cxx
 * \brief
...
namespace lsdyna
{
  ...
  static void
  LSDYNAStandardSmallStrainStressFreeExpansionHandlerImpl(real * const e,
							  real * const de,
							  const real *const s0,
							  const real *const s1,
							  const LSDYNAInt d)
  ...
  void LSDYNAStandardSmallStrainStressFreeExpansionHandler(float * const e,
							   float * const de,
  ...
  void LSDYNAStandardSmallStrainStressFreeExpansionHandler(double * const e,
							   double * const de,
  ...
  template<typename real>
  static void
  LSDYNALogarithmicStrainStressFreeExpansionHandlerImpl(real * const e,
							real * const de,
							const real *const s0,
							const real *const s1,
							const LSDYNAInt d)
