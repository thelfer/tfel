...
namespace cyrano {
  ...
  void CyranoStandardSmallStrainStressFreeExpansionHandler(CyranoReal *const em,
  ...
  void CyranoLogarithmicStrainStressFreeExpansionHandler(CyranoReal *const em,
                                                         CyranoReal *const dem,
                                                         const CyranoReal *const e,
                                                         const CyranoReal *const de,
                                                         const CyranoReal *const s0,
