...
namespace lsdyna
{
  ...
  template<>
  struct MFRONT_LSDYNA_VISIBILITY_EXPORT LSDYNAOrthotropicElasticPropertiesOffset<2u>
  {
    static constexpr unsigned short value = 7u;
  }; // end of struct LSDYNAOrthotropicElasticPropertiesOffset<2u>

  template<>
  struct MFRONT_LSDYNA_VISIBILITY_EXPORT LSDYNAOrthotropicElasticPropertiesOffset<3u>
  {
