...
namespace lsdyna
{
  ...
  private:
	...
	using  TangentOperatorType     = typename LSDYNATangentOperatorType<LSDYNATraits<Behaviour>::btype,real,N>::type;
	using  TangentOperatorViewType = typename LSDYNATangentOperatorType<LSDYNATraits<Behaviour>::btype,real,N>::view_type;
  ...
  private:
	...
	using  TangentOperatorType
	  = typename LSDYNATangentOperatorType<LSDYNATraits<Behaviour>::btype,real,2u>::type;
