...
#ifndef LIB_MFRONT_CASTEM_CASTEMISOTROPICBEHAVIOURHANDLER_HXX
#define LIB_MFRONT_CASTEM_CASTEMISOTROPICBEHAVIOURHANDLER_HXX 
...
namespace castem
{
  ...
  template<tfel::material::ModellingHypothesis::Hypothesis H,
	   template<tfel::material::ModellingHypothesis::Hypothesis,typename,bool> class Behaviour>
  struct TFEL_VISIBILITY_LOCAL CastemIsotropicBehaviourHandler<COHESIVEZONEMODEL,H,Behaviour>
    : public CastemIsotropicBehaviourHandlerBase<COHESIVEZONEMODEL,H,Behaviour>
  {
    TFEL_CASTEM_INLINE static
      void exe(const CastemReal *const DTIME ,
...
#endif /* LIB_MFRONT_CASTEM_CASTEMISOTROPICBEHAVIOURHANDLER_HXX */
