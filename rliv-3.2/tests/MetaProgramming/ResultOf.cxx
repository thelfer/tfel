  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    using handler2 = BinaryOperationHandler<my_vector,handler1,OpDiadicProduct>;
    TFEL_TESTS_ASSERT((std::is_same<double,
		       ResultOf<F,double>::type>::value));
    TFEL_TESTS_ASSERT((std::is_same<int,
		       ResultOf<F,double,double>::type>::value));
    TFEL_TESTS_ASSERT((std::is_same<double&,
		       ResultOf<my_vector,unsigned short>::type>::value));
    TFEL_TESTS_ASSERT((std::is_same<const double&,
		       ResultOf<const my_vector,unsigned short>::type>::value));
    TFEL_TESTS_ASSERT((std::is_same<double,
		       ResultOf<handler1,unsigned short>::type>::value));
    TFEL_TESTS_ASSERT((std::is_same<double,
		       ResultOf<handler2,unsigned short,unsigned short>::type>::value));
    return this->result;
  } // end of execute
};
