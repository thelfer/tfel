...
~~~~
~/codes/llvm/22.1.3/install/bin/run-clang-tidy -checks='cppcoreguidelines-*',-cppcoreguidelines-macro-usage,-cppcoreguidelines-avoid-magic-numbers,-cppcoreguidelines-pro-bounds-avoid-unchecked-container-access,-cppcoreguidelines-pro-bounds-pointer-arithmetic &> out
~~~~