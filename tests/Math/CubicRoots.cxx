...
double cubic(const double a3,const double a2,const double a1,const double a0, const double x)
{
  return a3*x*x*x+a2*x*x+a1*x+a0;
}

void generate_coef(double& a3,double& a2,double& a1,double& a0, const double x1, const double x2, const double x3)
{
  a3 =  2.; 
  a2 = -2.*(x1+x2+x3);
...
void solve(const double a3,const double a2,const double a1,const double a0)
{
  ...
  assert(CubicRoots::exe(x,y,z,a3,a2,a1,a0));
