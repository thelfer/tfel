  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    using handler  = Expr<vector,ScalarObjectOperation<int&&,const vector&,OpMult>>;
    ...
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr)::lhs_storage_type,const int>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr)::rhs_type,const vector&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr)::rhs_storage_type,const vector&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr)::result_type,vector>::value));
    ...
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::lhs_type,const vector&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::lhs_storage_type,const vector&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::rhs_type,int&&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::rhs_storage_type,const int>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::result_type,vector>::value));
