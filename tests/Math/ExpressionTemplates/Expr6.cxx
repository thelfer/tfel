  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    using handler  = Expr<tvector,ScalarObjectOperation<int&&,const tvector&,OpMult>>;
    using res2     = BinaryOperationResult<const tvector&,int&&,OpMult>;
    using handler2 = Expr<tvector,ObjectScalarOperation<const tvector&,int&&,OpMult>>;
    ...
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::lhs_type,const tvector&>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::lhs_storage_type,const tvector&>::value));
    ...
    TFEL_TESTS_STATIC_ASSERT((is_same<decltype(expr2)::result_type,tvector>::value));
