  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    TFEL_TESTS_STATIC_ASSERT((isBinaryOperationResultTypeValid<vector,vector,OpPlus>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<res,vector>::value));
    TFEL_TESTS_STATIC_ASSERT((is_same<handler,
			      Expr<vector,BinaryOperation<vector,vector,OpPlus> > >::value));
    using res2     = BinaryOperationResult<vector,res,OpPlus>;
    TFEL_TESTS_STATIC_ASSERT((isBinaryOperationResultTypeValid<vector,res,OpPlus>::value));
