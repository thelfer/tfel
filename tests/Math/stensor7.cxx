  ...
  : public tfel::tests::TestCase
{
  ...
  execute() override
  {
    ...
    stensor<3u,double> sl2 = stensor<3u,double>::buildLogarithmFromEigenValuesAndVectors(vp,m);
    ...
    stensor<3u,double> sp2 = stensor<3u,double>::buildPositivePartFromEigenValuesAndVectors(vp,m);
    stensor<3u,double> sn1 = negative_part(s);
    stensor<3u,double> sn2 = stensor<3u,double>::buildNegativePartFromEigenValuesAndVectors(vp,m);
