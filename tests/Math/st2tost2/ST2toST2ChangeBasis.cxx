  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
	...
	{1.,2.,3.,0.98});
    this->test<3>(from_euler(0.23*M_PI,0.32*M_PI,0.13*M_PI),
      {0.23,0.32,0.13,0.76,0.54,0.17,
       0.94,0.65,0.87,0.19,0.56,0.78,
       0.45,0.71,0.18,0.82,0.31,0.67,
       0.54,0.17,0.81,0.28,0.81,0.28,
       0.49,0.56,0.78,0.91,0.65,0.87,
       0.32,0.23,0.31,0.67,0.45,0.71},
...
private:
  ...
  void test(const tfel::math::tmatrix<3u,3u,double>& r){
    ...
    TFEL_CONSTEXPR const double e = 100*std::numeric_limits<double>::epsilon();
  ...
  void test(const tfel::math::tmatrix<3u,3u,double>& r,
    ...
    TFEL_CONSTEXPR const double eps = 100*std::numeric_limits<double>::epsilon();
...
TFEL_TESTS_GENERATE_PROXY(ST2toST2ChangeBasisTest,
			  "ST2toST2ChangeBasisTest");
