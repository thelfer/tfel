  ...
  : public tfel::tests::TestCase
{
  ComputeDeviatorDeterminantSecondDerivativeTest()
    : tfel::tests::TestCase("TFEL/Math","ComputeDeviatorDeterminantSecondDerivative")
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    for(const auto v: {Id,v0,v1,v2,v3,v4,v5}){
      test<1u>(v);
      test<2u>(v);
      test<3u>(v);
    }
 ...
 private:
  ...
  void test2(const double* values){
    ...
    const auto dJ2 = computeDeviatorDeterminantSecondDerivative(s);
