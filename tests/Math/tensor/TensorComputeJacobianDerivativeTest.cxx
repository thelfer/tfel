...
static tfel::math::tensor<N,real>
getNumericalApproximation(const F& f,
			  const tfel::math::tensor<N,real>& C,
			  const real e){
  ...
  : public tfel::tests::TestCase
{
  ...
  tfel::tests::TestResult execute() override
  {
    ...
    const double v1[9] = {8.2e-2,-4.5e-2,7.2e-2,2.3e-2*sqrt2,0,0.,7.2e-2,0e-2,2.3e-2*sqrt2};
    const double v2[9] = {-8.2e-2,4.5e-2,7.2e-2,0e-2,2.3e-2*sqrt2,0.};
    const double v3[9] = {8.2e-2,4.5e-2,-7.2e-2,0e-2,0.e-2,2.3e-2*sqrt2,4.5e-2,-7.2e-2,0e-2};
    const double v4[9] = {8.2e-2,4.5e-2,-7.2e-2,3.14e-2*sqrt2,-6.42e-2*sqrt2,2.3e-2*sqrt2,4.5e-2,-7.2e-2,0e-2};
...
private:
  ...
  void check(const tfel::math::tensor<N,double>& s){
    auto J = [](const tfel::math::tensor<N,double>& v){
      return det(v);
    };
