/*! 
 * \file tests/Math/ConvertionBetweenCorotationnalCauchyStressAndSecondPioloKirchhoffStressTest.cxx
 * \brief
...
struct ConvertionBetweenCorotationnalCauchyStressAndSecondPioloKirchhoffStressTest final
  : public tfel::tests::TestCase
{
 ...
 private:
  ...
  void test1(){
    ...
    const auto s1 = convertSecondPiolaKirchhoffStressToCorotationnalCauchyStress(S,U);
  ...
  void test2(){
    ...
    stensor<N,double> U(u_values);
    stensor<N,double> s(s_values);
    const auto S1 = convertCorotationnalCauchyStressToSecondPiolaKirchhoffStress(s,U);
...
TFEL_TESTS_GENERATE_PROXY(ConvertionBetweenCorotationnalCauchyStressAndSecondPioloKirchhoffStressTest,
			  "ConvertionBetweenCorotationnalCauchyStressAndSecondPioloKirchhoffStressTest");
