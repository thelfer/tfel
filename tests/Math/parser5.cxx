...
main(void)
{
  ...
  SmartPtr<Evaluator> f(new Evaluator(var,"sin(a*x)",manager));
  SmartPtr<ExternalFunction> h = f->createFunctionByChangingParametersIntoVariables(nvar);
