...
#ifndef _LIB_TFEL_RUNGE_KUTTA4_HEADER_HXX_
#define _LIB_TFEL_RUNGE_KUTTA4_HEADER_HXX_ 
...
#include"Math/RungeKutta4.hxx"

template<typename T>
class VanDerPol
  : public tfel::math::RungeKutta4<2,T,VanDerPol<T> >
{
  T mu;
...
#endif /* _LIB_TFEL_RUNGE_KUTTA4_HEADER_HXX */
