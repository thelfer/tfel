  ...
  : public tfel::tests::TestCase
{
  ...
  execute()
  {
    ...
    const double values1[] = {0.08302032231654488,0.5181596568814956,0.006263984638196551,
    ...
    const double values2[] = {0.34377959815555115,0.35405603868715907,0.34803761968529245,
    ...
    const double values3[] = {0.15461974105342813,0.13924644516783613,0.43117665944930983,
			      0.07202701278173496,0.8054329144110002,0.36336467442067855,
			      0.1715059351414837,0.9239779569444945,0.8447301031948172};
    const double values4[] = {0.9729554328337576,0.5188383738972479,0.589053493642629,
...
private:
  unsigned short
  getSize(const tfel::math::stensor<N,double>&)
  {
    return tfel::math::StensorDimeToSize<N>::value;
  }
  unsigned short
  getSize(const tfel::math::tensor<N,double>&)
  {
    return tfel::math::TensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfRows(const tfel::math::st2tost2<N,double>&)
  {
    return tfel::math::StensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfRows(const tfel::math::st2tot2<N,double>&)
  {
    return tfel::math::TensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfRows(const tfel::math::t2tost2<N,double>&)
  {
    return tfel::math::StensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfRows(const tfel::math::t2tot2<N,double>&)
  {
    return tfel::math::TensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfColumns(const tfel::math::st2tost2<N,double>&)
  {
    return tfel::math::StensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfColumns(const tfel::math::st2tot2<N,double>&)
  {
    return tfel::math::StensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfColumns(const tfel::math::t2tost2<N,double>&)
  {
    return tfel::math::TensorDimeToSize<N>::value;
  }
  unsigned short
  getNumberOfColumns(const tfel::math::t2tot2<N,double>&)
  {
    return tfel::math::TensorDimeToSize<N>::value;
  }
  ...
  template<typename VectorType,
	   typename MatrixType>
  void
  checkVectorMatrixProduct(const VectorType& v,
			   const MatrixType& m)
  {
    using namespace std;
    using namespace tfel::math;
  ...
  void
  checkDiadicProduct(const TensorType&  t1,
		     const TensorType2& t2)
  {
    using namespace std;
    using namespace tfel::math;
    using std::vector;
    typedef typename ResultType<TensorType,TensorType2,OpDiadicProduct>::type Result;
