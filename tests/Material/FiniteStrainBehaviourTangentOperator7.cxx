  ...
  : public tfel::tests::TestCase
{
 ...
 private:
  ...
  void check(){
    ...
    // spatial moduli
    const auto computeCs = [&l0,&m0](const tensor& F)
      -> st2tost2
    {
      const auto J = tfel::math::det(F);
    ...
    const auto computeCSE = [&l0,&m0](const tensor& F)
      -> st2tost2
    {
    ...
    for(const tensor& F : {tensor::Id(),tensor{1.03,0.98,1.09,0.03,-0.012,0.04,-0.028,-0.015,0.005}}){
      ...
      const auto Cs3 = tfel::material::convert<TangentOperator::SPATIAL_MODULI,
