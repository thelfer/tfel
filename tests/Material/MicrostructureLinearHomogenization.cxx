...
struct MicrostructureLinearHomogenizationTest final : public tfel::tests::TestCase {
 ...
 private:
  ...
  static constexpr auto eps = std::numeric_limits<real>::epsilon();
    ...
    GrainPhase<3u,stress> grain1(real(0.33),C_0,ellipsoid1, n_a, n_b);
    GrainPhase<3u, stress> grain2(real(0.33),C_i, ellipsoid1, n_a_, n_b_);
    GrainPhase<3u, stress> grain3(real(0.34),C_i, ellipsoid1, n_a, n_c);

    Polycrystal<3u, stress> crystal;
