 ...
 private:
  ...
  void test_particulate() {
    ...
    HomogenizationScheme<3u, stress> h_s_MT1 =
        computeMoriTanaka<3u, stress>(micro1, polarizations);
    auto Chom_MT_1 = h_s_MT1.homogenized_stiffness;
    HomogenizationScheme<3u, stress> h_s_MT2 =
        computeMoriTanaka<3u, stress>(micro2, polarizations);
    ...
    bool isotropic = true;
    auto h_s_SC1 = computeSelfConsistent<3u, stress>(micro1, polarizations_, 12,
                                                     isotropic);
    auto Chom_SC_1 = h_s_SC1.homogenized_stiffness;
    auto h_s_SC2 = computeSelfConsistent<3u, stress>(micro1, polarizations_, 12,
                                                     not(isotropic), 10);
    ...
    auto h_s_SC3 = computeSelfConsistent<3u, stress>(micro2, polarizations_, 12,
                                                     isotropic);
