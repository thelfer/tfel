---
title: Using the TFELSystem library to retrieve metadata about material properties and behaviours generated by MFront
...
The `TFELSystem` library provide several functionalities to retrieve
metada about material properties and behaviours generated by `MFront`.
This functionalities are also available in `python` thanks to the
`tfel.system` module.

Such functionalities are helpful for creating tools interacting with
...
Those functionalities are already used by several solvers to easily
...
# Overview of the  functionalities provided by the`TFEL/System` library
