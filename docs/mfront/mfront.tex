...
\resumecea{
  ...
  \begin{itemize}
    ...
    les différentes applications de l'utilisateur \cea{}. Nous
    reviendrons sur ce point lorsque nous discuterons des
    limitations actuelles de la base de données \sirius{}.
  \end{itemize}
}
