...
\begin{itemize}
  ...
  spécifiés, la librairie s'appellera {\tt libMaterialLaw.so}.
\end{itemize}
...
variable d'environnement \index{general}{CASTEM\_OUT\_OF\_BOUND\_POLICY}
\texttt{CASTEM\_\-OUT\_\-OF\_\-BOUND\_\-POLICY}. Trois politiques sont
sont possibles~:
\begin{itemize}
...
Si la variable \texttt{CASTEM\_\-OUT\_\-OF\_\-BOUND\_\-POLICY} n'est pas
définie, les dépassements sont ignorés.
...
Le traitement d'une violation des bornes de validité expérimentale
dépendant de la politique définie par l'utilisateur à l'aide de la
variable d'environnement \index{general}{PYTHON\_OUT\_OF\_BOUND\_POLICY}
\texttt{PYTHON\_\-OUT\_\-OF\_\-BOUND\_\-POLICY}. Trois politiques sont
sont possibles~:
\begin{itemize}
  \item \texttt{STRICT}, qui traite un dépassement comme une erreur,
  avec un traitement similaire à ce qui est fait pour les bornes
...
Si la variable \texttt{PYTHON\_\-OUT\_\-OF\_\-BOUND\_\-POLICY} n'est pas
définie, les dépassements sont ignorés.
