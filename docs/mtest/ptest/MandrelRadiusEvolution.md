The `@MandrelRadiusEvolution` keyword allows the user to impose the
evolution of the outer radius of a mandrel located inside the pipe.

This boundary condition has no effect until contact between the mandrel
and the pipe is established.
