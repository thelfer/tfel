/*! 
 * \file  LevenbergMarquardtExternalFunctionWrapper.cxx
 * \brief
...
namespace tfel
{
  ...
  namespace math
  {
    ...
    LevenbergMarquardtExternalFunctionWrapper::LevenbergMarquardtExternalFunctionWrapper(tfel::utilities::SmartPtr<tfel::math::parser::ExternalFunction> ev_,
    ...
    void
    LevenbergMarquardtExternalFunctionWrapper::operator()(double& r,
