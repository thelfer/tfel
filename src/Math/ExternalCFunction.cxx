    ...
    namespace parser {
      ...
      void ExternalCFunctionException::throwInvalidVariableIndex(
        ...
        msg << "ExternalCFunctionBase::setVariableValue : "
            << "invalid index " << pos << " (function has only " << N
            << " variables).";
        throw(std::runtime_error(msg.str()));
      }  // end of ExternalCFunctionException::throwInvalidVariableIndex

      std::shared_ptr<ExternalFunction> ExternalCFunctionBase<0u>::
      ...
      void ExternalCFunctionBase<0u>::setVariableValue(
        ...
        std::ostringstream msg;
        msg << "ExternalCFunctionBase::setVariableValue : "
            << "invalid index " << pos << " (function has no variable).";
        throw(std::runtime_error(msg.str()));
      ...
      std::shared_ptr<ExternalFunction> ExternalCFunctionBase<0>::differentiate(
        ...
        throw(
            std::runtime_error("ExternalCFunctionBase<0>::differentiate : "
