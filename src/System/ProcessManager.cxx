...
namespace tfel {
  ...
  namespace system {
    ...
    ProcessManager::ProcessManager() : shallStopOnSignals(false) {
      ...
      MemberSignalHandler<ProcessManager>::Fct f =
          &ProcessManager::sigChildHandler;
    ...
    void ProcessManager::stopOnSignals(const bool b) {
      ...
      if (!this->shallStopOnSignals) {
        ...
        MemberSignalHandler<ProcessManager>::Fct f =
            &ProcessManager::terminateHandler;
        this->sHandlerSIGBUS =
    ...
    ProcessManager::ProcessId ProcessManager::createProcess(
      ...
      try {
        pid =
            this->createProcess(cmd, fdIn, fdOut, this->inputs, this->outputs);
      } catch (...) {
