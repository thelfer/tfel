...
namespace numodis
{
  ...
  */
  ...
  double TripleNode::computeFx(double phi0,
			       ...
			       double beta1) const
  {
    return _lt0.Fx(_alpha0,phi0+beta0)+_lt1.Fx(_alpha1,phi1+beta1)-_lt2.Fx(_alpha2,0.0);
  }
  ...
  */
   ...
   */
  //===================================================================
  double TripleNode::computeEquilibriumBeta0(double phi,double tol,int Nmax) const
  {
