...
void declareMadnexSupport(){
  ...
  boost::python::class_<madnex::MFrontMetaData>("MFrontMetaData", boost::python::init<>())
    ...
    ;
  boost::python::class_<madnex::MFrontImplementation>("MFrontImplementation", boost::python::init<>())
    ...
    .def_readwrite("lower_bounds", &madnex::MFrontImplementation::lower_bounds)
    .def_readwrite("upper_bounds", &madnex::MFrontImplementation::upper_bounds)
    ;
