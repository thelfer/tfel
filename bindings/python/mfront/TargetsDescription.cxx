...
static std::vector<std::string> TargetsDescription_getHeaders(const mfront::TargetsDescription& t)
{
  return t.headers;
}
...
void declareTargetsDescription(){
  ...
  using Op3 = LibraryDescription& (TargetsDescription::*)(const std::string&, 
							  const std::string&);
  using Access = LibraryDescription& (TargetsDescription::*)(const std::string&);
