...
static tfel::math::stensor<N,double>
stensor_idiv(tfel::math::stensor<N,double>& v,
	     const scalar s)
{
  v /= s;
  return v;
...
template<unsigned short N>
static tfel::math::stensor<N,double>
stensor_add(const tfel::math::stensor<N,double>& v1,
...
template<unsigned short N>
static tfel::math::stensor<N,double>
stensor_sub(const tfel::math::stensor<N,double>& v1,
	    const tfel::math::stensor<N,double>& v2)
{
  return v1-v2;
}
...
template<unsigned short N,typename scalar>
static tfel::math::stensor<N,double>
stensor_mul(const tfel::math::stensor<N,double>& v1,
	    const scalar s)
{
  return s*v1;
}
...
static tfel::math::stensor<1u,double>
makeStensor1D(const std::tuple<double,double,double>& s)
{
  return {std::get<0>(s),std::get<1>(s),std::get<2>(s)};
}

static tfel::math::stensor<2u,double>
makeStensor2D(const std::tuple<double,double,double>& s)
{
  return {std::get<0>(s),std::get<1>(s),std::get<2>(s),0.};
}

static tfel::math::stensor<3u,double>
makeStensor3D(const std::tuple<double,double,double>& s)
{
