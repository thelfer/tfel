...
makeBarlatLinearTransformation(const double c12,const double c21, const double c13,
			       const double c31,const double c23, const double c32,
			       const double c44,const double c55, const double c66){
  return tfel::material::makeBarlatLinearTransformation<N>(c12,c21,c13,c31,c23,
							   c32,c44,c55,c66);
}

template<unsigned short N>
static double
computeBarlatStress(const tfel::math::stensor<N,double>& s,
