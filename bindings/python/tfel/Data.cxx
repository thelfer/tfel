...
static void
convert_python_object_to_data(tfel::utilities::Data& d,
...
static std::shared_ptr<tfel::utilities::Data>
convert_python_object_to_data_ptr(const boost::python::object& o)
{
...
void declareData()
{
  ...
  class_<std::map<std::string,Data>>("DataMap")
    .def(map_indexing_suite<std::map<std::string,Data> >());
