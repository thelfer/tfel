...
static double&
st2tost2_getitem(tfel::math::st2tost2<N,double>& v,
...
template<unsigned short N>
static void
st2tost2_setitem(tfel::math::st2tost2<N,double>& v,
		const unsigned short i,
		 const unsigned short j,
		 const double vi)
{
...
template<unsigned short N>
static std::string
st2tost2_str(const tfel::math::st2tost2<N,double>& v)
{
...
static void declarest2tost2(const char * const n)
{
  ...
  class_<st2tost2<N,double> >(n,init<>())
    ...
    .def("__setitem__",&st2tost2_setitem<N>,
