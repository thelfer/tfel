...
"Electron mass (kg)")
.def_readonly("me",PhysicalConstants::ElectronMass,
"Electron mass (kg)")
.def_readonly("ElectronVolt",PhysicalConstants::ElectronVolt,
"Electron volt (J)")
.def_readonly("eV",PhysicalConstants::ElectronVolt,
"Electron volt (J)")
...
"Faraday constant (C.mol-1)")
.def_readonly("FineStructureConstant",PhysicalConstants::FineStructureConstant,
"Fine-structure constant")
...
"Molar gas constant (J.mol-1.K-1)")
.def_readonly("StefanBoltzmannConstant",PhysicalConstants::StefanBoltzmannConstant,
"Stefan-Boltzmann constant (W.m-2.K-4)")
