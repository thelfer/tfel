...
void declareGlossary() {
  ...
  class_<Glossary, noncopyable>("Glossary", no_init)
      ...
      .def_readonly(
          "AxialDeformationGradient", &Glossary::AxialDeformationGradient,
          "la composante axiale du gradient de la transformation (cette "
          "grandeur n'a de sens que pour les calculs en contraintes planes)")
      ...
      .def_readonly("Broken", &Glossary::Broken, "material failure indicator")
      ...
      .def_readonly("StrainMeasure", &Glossary::StrainMeasure, "strain measure")
