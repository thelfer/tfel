...
requires(tfel::math::checkUnitCompatibility<tfel::math::unit::Stress,
  ...
  computeVoigtStiffness(
   ...
   return tfel::material::homogenization::elasticity::computeVoigtStiffness<3,2,StressType>(f_i,C_i);
 }
...
requires(tfel::math::checkUnitCompatibility<tfel::math::unit::Stress,
  ...
  computeReussStiffness(
      const std::array<tfel::types::real<StressType>, 2>& f_i,
      const std::array<tfel::math::st2tost2<3, StressType>, 2>& C_i){
  return tfel::material::homogenization::elasticity::computeReussStiffness<3,2,StressType>(f_i,C_i);
  }
...
requires(tfel::math::checkUnitCompatibility<tfel::math::unit::Stress,
  ...
  computeIsotropicHashinShtrikmanBounds(const std::array<tfel::types::real<StressType>, 2>& f_i,
                                        const std::array<StressType, 2>& K_i,
                                        const std::array<StressType, 2>& G_i){
  return tfel::material::homogenization::elasticity::computeIsotropicHashinShtrikmanBounds<3,2,StressType>(f_i,K_i,G_i);
  }
...
void declareLinearHomogenizationBounds(pybind11::module_& m) {
  m.def("computeVoigtStiffness",
        &computeVoigtStiffness<double>);
  m.def("computeReussStiffness",
        &computeReussStiffness<double>);
