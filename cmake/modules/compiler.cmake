...
add_definitions("-DOPTIMISATION_FLAGS=\\\"\"${VISIBILITY_FLAGS} ${OPTIMISATION_FLAGS}\"\\\"")
add_definitions("-DOPTIMISATION_FLAGS2=\\\"\"${OPTIMISATION_FLAGS2}\"\\\"")
add_definitions("-DCOMPILER_WARNINGS=\\\"\"${COMPILER_WARNINGS}\"\\\"")

if(CMAKE_BUILD_TYPE STREQUAL "Debug")
  set(CMAKE_CXX_FLAGS_RELEASE   "${VISIBILITY_FLAGS}   ${CMAKE_CXX_FLAGS_DEBUG}")
  set(CMAKE_CXX_FLAGS_RELEASE   "${COMPILER_WARNINGS}  ${CMAKE_CXX_FLAGS_DEBUG}")
elseif(CMAKE_BUILD_TYPE STREQUAL "Coverage")
  set(CMAKE_CXX_FLAGS_COVERAGE  "${VISIBILITY_FLAGS}   ${CMAKE_CXX_FLAGS_COVERAGE}")
  set(CMAKE_CXX_FLAGS_COVERAGE  "${COMPILER_WARNINGS}  ${CMAKE_CXX_FLAGS_COVERAGE}")
elseif(CMAKE_BUILD_TYPE STREQUAL "Profiling")
  set(CMAKE_CXX_FLAGS_PROFILING "${VISIBILITY_FLAGS}   ${CMAKE_CXX_FLAGS_PROFILING}")
  set(CMAKE_CXX_FLAGS_PROFILING "${OPTIMISATION_FLAGS} ${CMAKE_CXX_FLAGS_PROFILING}")
  set(CMAKE_CXX_FLAGS_PROFILING "${COMPILER_WARNINGS}  ${CMAKE_CXX_FLAGS_PROFILING}")
elseif(CMAKE_BUILD_TYPE STREQUAL "Release")
  set(CMAKE_CXX_FLAGS_RELEASE   "${VISIBILITY_FLAGS}   ${CMAKE_CXX_FLAGS_RELEASE}")
  ...
  set(CMAKE_CXX_FLAGS           "${VISIBILITY_FLAGS}   ${CMAKE_CXX_FLAGS}")
